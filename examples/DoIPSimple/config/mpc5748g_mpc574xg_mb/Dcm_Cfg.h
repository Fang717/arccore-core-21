...
#define RTE_MODE_DcmDiagnosticSessionControl_DcmConf_DcmDspSessionRow_Programming_Session 2
#endif

#define DCM_PDU_ID_DCM_RXFUNC 0
#define DCM_PDU_ID_DCM_RX 1
#define DCM_PDU_ID_DCM_TX 0
/* Periodic tx pdus */
#define DCM_FIRST_PERIODIC_TX_PDU 1
#define DCM_NOF_PERIODIC_TX_PDU 0
...
#define DCM_MANUFACTURER_NOTIFICATION		STD_ON
...
#define DCM_DSL_BUFFER_LIST_LENGTH			1
#define DCM_DSL_RX_PDU_ID_LIST_LENGTH		2
#define DCM_DSL_TX_PDU_ID_LIST_LENGTH		1

#define DCM_MAIN_FUNCTION_PERIOD_TIME_MS 	5

#define DCM_LIMITNUMBER_PERIODDATA			10
#define DCM_MAX_DDDSOURCE_NUMBER			10
#define DCM_MAX_DDD_NUMBER					0

#define DCM_ROE_BUFFER_SIZE					0
#define DCM_ROE_INTERNAL_DIDS				STD_OFF


#define DCM_NOF_IOCONTROL_DIDS				0
#define DCM_MAX_IOCONTROL_DID_SIGNALS		0

#define DCM_PERIODICTRANSMIT_SLOW			6000
#define DCM_PERIODICTRANSMIT_MEDIUM			2000
#define DCM_PERIODICTRANSMIT_FAST			20

#define DCM_SECURITY_EOL_INDEX 				1

#define DCM_USE_JUMP_TO_BOOT				STD_ON

#define DCM_PERIODIC_DID_SYNCH_SAMPLING		STD_OFF

#define DCM_USE_NVM_DID						STD_OFF

#define DCM_COMM_CHANNEL_EthChnl_INDEX 0u
...
extern Std_ReturnType Rte_Switch_DcmCommunicationControl_EthChnl_DcmCommunicationControl_EthChnl(uint8 mode);
#endif

extern Std_ReturnType DID_0xE103_ConditionCheck(Dcm_OpStatusType OpStatus, Dcm_NegativeResponseCodeType *errorCode);
extern Std_ReturnType DID_0xE103_Read(uint8 *data);
