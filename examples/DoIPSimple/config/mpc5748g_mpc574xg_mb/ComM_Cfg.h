...
#define COMM_NETWORK_HANDLE_EthChnl 0u
#define ComMConf_ComMChannel_EthChnl 0u

#define INVALID_NETWORK_HANDLE 0xFFu
#define INVALID_SIGNAL_HANDLE 0xFFFFu
#define COMM_USER_HANDLE_EthChnlUser ((ComM_UserHandleType)0)
#define ComMConf_ComMUser_EthChnlUser 0u

void ComM_MainFunction_EthChnl(void);
