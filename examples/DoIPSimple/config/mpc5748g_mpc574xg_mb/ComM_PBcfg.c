...
static SECTION_POSTBUILD_DATA const ComM_ChannelType ComM_Channels[COMM_CHANNEL_COUNT] = {
   {
      ...
      .ComMChannelId = ComMConf_ComMChannel_EthChnl,
...
static SECTION_POSTBUILD_DATA const ComM_ChannelType* const ComM_EthChnlUser_Channels[] = {
	&ComM_Channels[0] 
};
...
static SECTION_POSTBUILD_DATA const ComM_UserType ComM_Users[COMM_USER_COUNT] = {
   {
        /* @req ComM995 */
        .ChannelList      = ComM_EthChnlUser_Channels,
        .ChannelCount     = 1,
        .PncChnlList      = NULL, 
        .PncChnlCount     = 0,
        #if defined(USE_RTE)
        .ComMRteSwitchUM  = Rte_Switch_UM_EthChnlUser_currentMode
        #endif
    }
};
