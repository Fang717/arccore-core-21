...
#define PDUR_DOIP_SUPPORT 					STD_ON
...
#define PduRConf_Pdu_Dcm_Tx 0u 
#define PduRConf_Pdu_DoIP_PduR_FuncRx 1u 
#define PduRConf_Pdu_DoIP_PduR_PhyRx 2u 
...
#define PDUR_PDU_ID_DCM_TX					0UL
#define PDUR_REVERSE_PDU_ID_DOIP_PDUR_PHYTX			0UL

#define PDUR_PDU_ID_DOIP_PDUR_FUNCRX					1UL
#define PDUR_REVERSE_PDU_ID_DCM_RXFUNC			1UL

#define PDUR_PDU_ID_DOIP_PDUR_PHYRX					2UL
#define PDUR_REVERSE_PDU_ID_DCM_RX			2UL
...
#include "DoIP.h"
#define PduR_ComTransmit DoIP_Transmit
#else
...
#include "DoIP.h"
#define PduR_DcmTransmit DoIP_Transmit
#else
...
#include "DoIP.h"
#define PduR_LdComTransmit DoIP_Transmit
#else
