...
#define PortConf_PortPin_CAN0RX ((Port_PinType)174)
#define PortConf_PortPin_CAN0TX ((Port_PinType)175)
#define PortConf_PortPin_CAN1RX ((Port_PinType)20)
#define PortConf_PortPin_CAN1TX ((Port_PinType)21)
#define PortConf_PortPin_CAN3RX ((Port_PinType)32)
#define PortConf_PortPin_CAN3TX ((Port_PinType)33)
#define PortConf_PortPin_FLX0CLK ((Port_PinType)156)
#define PortConf_PortPin_FLX0RXDA ((Port_PinType)160)
#define PortConf_PortPin_FLX0RXDB ((Port_PinType)155)
#define PortConf_PortPin_FLX0STPWT ((Port_PinType)158)
#define PortConf_PortPin_FLX0TXDA ((Port_PinType)161)
#define PortConf_PortPin_FLX0TXDB ((Port_PinType)154)
#define PortConf_PortPin_FLX0TXENA ((Port_PinType)157)
#define PortConf_PortPin_FLX0TXENB ((Port_PinType)159)
#define PortConf_PortPin_P8_0 ((Port_PinType)80)
#define PortConf_PortPin_P8_1 ((Port_PinType)81)
#define PortConf_PortPin_P8_2 ((Port_PinType)38)
#define PortConf_PortPin_P8_3 ((Port_PinType)82)
#define PortConf_PortPin_P8_4 ((Port_PinType)83)
#define PortConf_PortPin_P8_5 ((Port_PinType)84)
