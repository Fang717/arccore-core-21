...
const Dio_ChannelType DioChannelConfigData[] = { 
	DioConf_DioChannel_DioChannel1,
	DioConf_DioChannel_DioChannel2,
	DioConf_DioChannel_DioChannel3,
	DioConf_DioChannel_DioChannel4,
	DIO_END_OF_LIST
};
...
const Dio_ChannelGroupType DioGroupConfigData[] = {
	{
	  .port = DioConf_DioPort_DioPort_1,
	  .mask = 0xf0,
