...
#define PortConf_PortPin_CNTXA ((Port_PinType)0)
#define PortConf_PortPin_CNRXA ((Port_PinType)1)
#define PortConf_PortPin_CNTXC ((Port_PinType)2)
#define PortConf_PortPin_CNRXC ((Port_PinType)3)
#define PortConf_PortPin_GPIO125 ((Port_PinType)4)
#define PortConf_PortPin_GPIO127 ((Port_PinType)5)

#define PORT_NOF_PINS	6
