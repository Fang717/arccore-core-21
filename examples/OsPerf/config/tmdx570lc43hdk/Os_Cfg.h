...
// Alarm Id's
#define ALARM_ID_OsAlarm_10ms	((AlarmType)0)
#define ALARM_ID_Alarm_BswService	((AlarmType)1)
...
// Event masks
#define EVENT_MASK_OsEvent_10ms	 (EventMaskType)((EventMaskType)1u<<0)

// Isr Id's


// Resource Id's
#define RES_ID_OsResource	((ResourceType)0)
...
// Resource masks
#define RES_MASK_OsResource	(1u << 0u)
...
#define TASK_ID_SchM_BswService	((TaskType)1)
#define TASK_ID_SchM_Startup	((TaskType)2)
#define TASK_ID_TaskLoad	((TaskType)3)
...
#define OS_OSIDLE_STACK_SIZE        2048u 
...
#define ARC_SAFETY_PLATFORM			STD_OFF	
