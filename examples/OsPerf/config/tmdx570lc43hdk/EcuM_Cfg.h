...
#if !(((ECUM_SW_MAJOR_VERSION == 3) && (ECUM_SW_MINOR_VERSION == 0)) )
#error EcuM: Configuration file expected EcuMFixed module version to be 3.0.X*
#endif
...
#define EcuMConf_EcuMFixedUserConfig_User_1	0u
#define ECUM_USER_User_1	EcuMConf_EcuMFixedUserConfig_User_1
