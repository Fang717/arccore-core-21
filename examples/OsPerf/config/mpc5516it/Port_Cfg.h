...
#define PortConf_PortPin_CNTX_A ((Port_PinType)0)
#define PortConf_PortPin_CNRX_A ((Port_PinType)1)
#define PortConf_PortPin_BOOTCFG ((Port_PinType)2)
#define PortConf_PortPin_PD4 ((Port_PinType)3)
#define PortConf_PortPin_PD5 ((Port_PinType)4)
#define PortConf_PortPin_TXD_B ((Port_PinType)5)
#define PortConf_PortPin_RXD_B ((Port_PinType)6)
#define PortConf_PortPin_PCS_B0 ((Port_PinType)7)
#define PortConf_PortPin_SCK_B ((Port_PinType)8)
#define PortConf_PortPin_SOUT_B ((Port_PinType)9)
#define PortConf_PortPin_SIN_B ((Port_PinType)10)
#define PortConf_PortPin_PCS_A2 ((Port_PinType)11)
#define PortConf_PortPin_PCS_A1 ((Port_PinType)12)
#define PortConf_PortPin_SCK_A ((Port_PinType)13)
#define PortConf_PortPin_SOUT_A ((Port_PinType)14)
#define PortConf_PortPin_SIN_A ((Port_PinType)15)
#define PortConf_PortPin_PF0 ((Port_PinType)16)
#define PortConf_PortPin_TXD_D ((Port_PinType)17)
#define PortConf_PortPin_RXD_D ((Port_PinType)18)
#define PortConf_PortPin_PF15 ((Port_PinType)19)
#define PortConf_PortPin_PG1 ((Port_PinType)20)
#define PortConf_PortPin_PG5 ((Port_PinType)21)
#define PortConf_PortPin_PG6 ((Port_PinType)22)
