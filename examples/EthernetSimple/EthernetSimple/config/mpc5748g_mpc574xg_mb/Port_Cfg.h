...
#define PortConf_PortPin_GPIO0 ((Port_PinType)0)
#define PortConf_PortPin_GPIO1 ((Port_PinType)1)
#define PortConf_PortPin_ENET0_RX_CLK ((Port_PinType)2)
#define PortConf_PortPin_ENET0_RXD_2 ((Port_PinType)3)
#define PortConf_PortPin_ENET0_RXD_1 ((Port_PinType)4)
#define PortConf_PortPin_ENET0_RXD_0 ((Port_PinType)5)
#define PortConf_PortPin_ENET0_COL ((Port_PinType)6)
#define PortConf_PortPin_ENET0_RX_ER ((Port_PinType)7)
#define PortConf_PortPin_CAN0TX ((Port_PinType)8)
#define PortConf_PortPin_CAN0RX ((Port_PinType)9)
#define PortConf_PortPin_CAN1_RXD ((Port_PinType)10)
#define PortConf_PortPin_CAN1_TXD ((Port_PinType)11)
#define PortConf_PortPin_ENET0_CRS ((Port_PinType)12)
#define PortConf_PortPin_ENET0_RXD_3 ((Port_PinType)13)
#define PortConf_PortPin_ENET0_MDIO ((Port_PinType)14)
#define PortConf_PortPin_ENET0_MDIO_OUT ((Port_PinType)15)
#define PortConf_PortPin_ENET0_RX_DV ((Port_PinType)16)
#define PortConf_PortPin_ENET0_MDC ((Port_PinType)17)
#define PortConf_PortPin_ENET0_TX_CLK ((Port_PinType)18)
#define PortConf_PortPin_LED1 ((Port_PinType)19)
#define PortConf_PortPin_LED2 ((Port_PinType)20)
#define PortConf_PortPin_ENET0_TXD_2 ((Port_PinType)21)
#define PortConf_PortPin_ENET0_TXD_3 ((Port_PinType)22)
#define PortConf_PortPin_ENET0_TXD_1 ((Port_PinType)23)
#define PortConf_PortPin_ENET0_TXD_0 ((Port_PinType)24)
#define PortConf_PortPin_ENET0_TX_EN ((Port_PinType)25)

#define PORT_NOF_PINS	26
