...
#define PDUR_CDDPDUR_SUPPORT				STD_ON
...
#define PduRConf_Pdu_Dlt_Rx 0u 
#define PduRConf_Pdu_Dlt_Tx 1u 
#define PduRConf_Pdu_PDU_UDP6661_RX 2u 
#define PduRConf_Pdu_Test_Rx 3u 
#define PduRConf_Pdu_Test_Tx 4u 
...
#define PDUR_PDU_ID_DLT_RX					0UL
#define PDUR_REVERSE_PDU_ID_DLT_RX			0UL

#define PDUR_PDU_ID_DLT_TX					1UL
#define PDUR_REVERSE_PDU_ID_DLT_TX			1UL

#define PDUR_PDU_ID_PDU_UDP6661_RX					2UL
#define PDUR_REVERSE_PDU_ID_PDU_UDP6661_RX			2UL

#define PDUR_PDU_ID_TEST_RX					3UL
#define PDUR_REVERSE_PDU_ID_TEST_RX			3UL

#define PDUR_PDU_ID_TEST_TX					4UL
#define PDUR_REVERSE_PDU_ID_TEST_TX			4UL
...
#include "Dcm.h"
#define PduR_DoIPTpProvideRxBuffer Dcm_ProvideRxBuffer
#define PduR_DoIPTpRxIndication Dcm_RxIndication
#define PduR_DoIPTpProvideTxBuffer Dcm_ProvideTxBuffer
#define PduR_DoIPTpTxConfirmation Dcm_TxConfirmation
#else
#define PduR_DoIPProvideRxBuffer(...)
#define PduR_DoIPRxIndication(...)
#define PduR_DoIPProvideTxBuffer(...)
#define PduR_DoIPTxConfirmation(...)
#endif
