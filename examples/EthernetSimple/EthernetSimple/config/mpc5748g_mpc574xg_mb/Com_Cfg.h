...
#define COM_MAX_BUFFER_SIZE						100
...
#define COM_MAX_N_SUPPORTED_IPDU_COUNTERS			10
#define COM_MAX_N_SUPPORTED_GWSOURCE_DESCRIPTIONS 	0
...
#define ComConf_ComSignal_ComSignal_RxUDP          0
#define ComConf_ComSignal_ComSignal_TxUDP          1
