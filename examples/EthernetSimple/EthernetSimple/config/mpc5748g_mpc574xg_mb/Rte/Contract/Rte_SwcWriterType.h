...
typedef struct {
    ...
    Rte_DE_sint32 * const SwcWriterRunnable_SenderPort_data2;
...
static inline void Rte_IWrite_SwcWriterRunnable_SenderPort_data2(/*IN*/sint32 value) {
    self->SwcWriterRunnable_SenderPort_data2->value = value;
}
