...
#if defined(USE_BSWM) || defined(USE_PDUR) || defined(USE_COM) || defined(USE_CANIF) || defined(USE_CANTP) || defined (USE_CANNM) || defined (USE_COMM) || defined (USE_CAN)
extern const PostbuildConfigType Postbuild_Config;
#endif

#if defined (USE_CANTRCV)
extern const CanTrcv_ConfigType CanTrcv_Config;
#endif
...
const EcuM_SleepModeType EcuM_SleepModeConfig[] = {
	{  // EcuMSleepMode
	   ...
	   .EcuMWakeupSourceMask = EcuMConf_EcuMWakeupSource_EcuMWakeupSource,
  	   .EcuMSleepModeMcuMode = McuConf_McuModeSettingConf_SLEEP,   /* @req SWS_EcuM_02958 */
    }
...
const EcuM_ComMConfigType EcuM_ComMConfig[] = {
   {  
      .EcuMComMNetworkHandle =  COMM_NETWORK_HANDLE_ComMChannel,
      .EcuMComBusType = COMM_BUS_TYPE_ETH 
   }
};
#endif
