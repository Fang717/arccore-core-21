...
// Event masks
#define EVENT_MASK_START_TCPIP	 (EventMaskType)((EventMaskType)1u<<0)
#define EVENT_MASK_LWIP_MAIN	 (EventMaskType)((EventMaskType)1u<<1)
#define EVENT_MASK_OsRteEvent1	 (EventMaskType)((EventMaskType)1u<<2)
#define EVENT_MASK_OsRteEvent2	 (EventMaskType)((EventMaskType)1u<<3)
#define EVENT_MASK_ModeSwitchOsEvent	 (EventMaskType)((EventMaskType)1u<<4)
#define EVENT_MASK_OsBwmMainEvent	 (EventMaskType)((EventMaskType)1u<<5)
