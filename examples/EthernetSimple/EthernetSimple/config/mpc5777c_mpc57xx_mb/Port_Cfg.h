...
#define PortConf_PortPin_FEC_FEC_MDIO_OUT ((Port_PinType)1)
#define PortConf_PortPin_FEC_FEC_MDIO ((Port_PinType)2)
#define PortConf_PortPin_FEC_FEC_MDC ((Port_PinType)3)
#define PortConf_PortPin_LED1 ((Port_PinType)4)
#define PortConf_PortPin_LED2 ((Port_PinType)5)
#define PortConf_PortPin_FEC_FEC_TXD0 ((Port_PinType)6)
#define PortConf_PortPin_FEC_FEC_RX_DV ((Port_PinType)7)
#define PortConf_PortPin_FEC_FEC_RXD0 ((Port_PinType)8)
#define PortConf_PortPin_FEC_FEC_TXD1 ((Port_PinType)9)
#define PortConf_PortPin_FEC_FEC_TXEN ((Port_PinType)10)
#define PortConf_PortPin_FEC_FEC_RXD1 ((Port_PinType)11)
#define PortConf_PortPin_SIU_A_GPIO_446 ((Port_PinType)12)
#define PortConf_PortPin_SIU_A_GPIO_447 ((Port_PinType)13)
#define PortConf_PortPin_FEC_FEC_TXCLK_REFCLK ((Port_PinType)14)

#define PORT_NOF_PINS	15
