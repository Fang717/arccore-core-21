...
void OsRteTask(void) { /** @req SWS_Rte_02251 */
    ...
    do {
        SYS_CALL_WaitEvent(EVENT_MASK_ModeSwitchOsEvent | EVENT_MASK_OsRteEvent1 | EVENT_MASK_OsRteEvent2); /*lint !e534 RTE Requirement */
        ...
        if ((Event & EVENT_MASK_OsRteEvent2) != 0) {
            SYS_CALL_ClearEvent (EVENT_MASK_OsRteEvent2);/*lint !e534 RTE Requirement */
