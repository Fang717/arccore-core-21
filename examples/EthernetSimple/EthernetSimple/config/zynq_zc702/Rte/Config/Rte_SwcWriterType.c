...
#define SwcWriterType_START_SEC_VAR_CLEARED_UNSPECIFIED
#include <SwcWriterType_MemMap.h> /*lint !e415 Autosar specified way to group code into memory sections, Req SWS_MemMap_00003 */
Rte_DE_sint32 ImplDE_SwcWriter_SwcWriterRunnable_SenderPort_data2; /*lint -e621 MISRA:OTHER:Ignore misidentified symbol clash [MISRA 2012 Rule 5.5, required]*/
#define SwcWriterType_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include <SwcWriterType_MemMap.h> /*lint !e415 Autosar specified way to group code into memory sections, Req SWS_MemMap_00003 */
...
const Rte_CDS_SwcWriterType SwcWriterType_SwcWriter = {
    ...
    .SwcWriterRunnable_SenderPort_data2 = &ImplDE_SwcWriter_SwcWriterRunnable_SenderPort_data2
};
...
void Rte_SwcWriter_SwcWriterRunnable(void) {
    ...
    Rte_Write_SwcWriterType_SwcWriter_SenderPort_data2(ImplDE_SwcWriter_SwcWriterRunnable_SenderPort_data2.value); /*lint !e534 AUTOSAR API */
