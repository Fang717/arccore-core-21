...
#define PDUR_MAX_ROUTE_COUNT				10
...
#define PDUR_PDU_ID_LAMPS_RX					0UL
#define PDUR_REVERSE_PDU_ID_LAMPS_RX			0UL

#define PDUR_PDU_ID_TCM_RX					1UL
#define PDUR_REVERSE_PDU_ID_TCM_RX			1UL
...
#include "LinIf.h"
#define PduR_DcmTransmit LinIf_Transmit
#else
...
#include "LinIf.h"
#define PduR_LdComTransmit LinIf_Transmit
#else
