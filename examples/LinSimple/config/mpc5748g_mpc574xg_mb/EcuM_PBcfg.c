...
#if defined(USE_BSWM) || defined(USE_PDUR) || defined(USE_COM) || defined(USE_CANIF) || defined(USE_CANTP) || defined (USE_CANNM) || defined (USE_COMM)
...
const EcuM_ConfigType EcuMConfig = {
    ...
    .EcuMDefaultShutdownTarget = ECUM_STATE_SLEEP,
    ...
    defined(USE_CANTP) || defined(USE_CANNM) || defined(USE_COMM) || defined (USE_CANTRCV)
