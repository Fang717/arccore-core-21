...
// Alarm Id's
#define ALARM_ID_OsAlarm	((AlarmType)0)
...
// Event masks
#define EVENT_MASK_OsEvent	 (EventMaskType)((EventMaskType)1u<<0)
...
#define TASK_ID_Init	((TaskType)1)
#define TASK_ID_OsTask	((TaskType)2)
