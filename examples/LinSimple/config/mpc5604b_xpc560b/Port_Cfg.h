...
#define PortConf_PortPin_LIN0TX ((Port_PinType)0)
#define PortConf_PortPin_LIN0RX ((Port_PinType)1)
#define PortConf_PortPin_LIN1TX ((Port_PinType)2)
#define PortConf_PortPin_LIN1RX ((Port_PinType)3)
#define PortConf_PortPin_GPIO68 ((Port_PinType)4)

#define PORT_NOF_PINS	5
