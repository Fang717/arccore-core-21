...
SECTION_POSTBUILD_DATA const PduRDestPdu_type PduRDestination_PATH_RX_01_RX_01 = {
		.DestModule 	= ARC_PDUR_COM,
		.DestPduId		= ComConf_ComIPdu_LAMPS_RX,
		.NofGroupRefs = 0,
		.RoutingPathGroupRefs = NULL,
		.DataProvision	= PDUR_DIRECT,
		.TxBufferId		=  PDUR_NO_BUFFER /* No buffer */ 
}; 
	
	
SECTION_POSTBUILD_DATA const PduRDestPdu_type PduRDestination_PATH_RX_02_RX_02 = {
		.DestModule 	= ARC_PDUR_COM,
		.DestPduId		= ComConf_ComIPdu_TCM_RX,
		.NofGroupRefs = 0,
		.RoutingPathGroupRefs = NULL,
		.DataProvision	= PDUR_DIRECT,
		.TxBufferId		=  PDUR_NO_BUFFER /* No buffer */ 
...
SECTION_POSTBUILD_DATA const PduRDestPdu_type PduRDestination_PATH_TX_01_TX_01 = {
...
SECTION_POSTBUILD_DATA const PduRDestPdu_type * const PduRDestinations_PATH_RX_01[] = {
	&PduRDestination_PATH_RX_01_RX_01,
	NULL
};

SECTION_POSTBUILD_DATA const PduRDestPdu_type * const PduRDestinations_PATH_RX_02[] = {
	&PduRDestination_PATH_RX_02_RX_02,
	NULL
};

SECTION_POSTBUILD_DATA const PduRDestPdu_type * const PduRDestinations_PATH_TX_01[] = {
	&PduRDestination_PATH_TX_01_TX_01,
	NULL
};

// Routing paths

SECTION_POSTBUILD_DATA const PduRRoutingPath_type PduRRoutingPath_PATH_RX_01 = { 
	.SrcModule = ARC_PDUR_LINIF,
	.SrcPduId = LINIF_PDU_ID_LAMPS_RX,
	.PduRDestPdus = PduRDestinations_PATH_RX_01,
...
SECTION_POSTBUILD_DATA const PduRRoutingPath_type PduRRoutingPath_PATH_RX_02 = { 
	.SrcModule = ARC_PDUR_LINIF,
	.SrcPduId = LINIF_PDU_ID_TCM_RX,
	.PduRDestPdus = PduRDestinations_PATH_RX_02,
...
SECTION_POSTBUILD_DATA const PduRRoutingPath_type PduRRoutingPath_PATH_TX_01 = { 
	.SrcModule = ARC_PDUR_COM,
	.SrcPduId = ComConf_ComIPdu_ENG_TX,
	.PduRDestPdus = PduRDestinations_PATH_TX_01,
...
SECTION_POSTBUILD_DATA const PduRRoutingPath_type * const PduRRoutingPaths[] = { 
	&PduRRoutingPath_PATH_RX_01,
	&PduRRoutingPath_PATH_RX_02,
	&PduRRoutingPath_PATH_TX_01,
	NULL
};
