...
static const ArcPort_PadConfigType PortPadConfigData[] = {
	{18, STD_OFF, STD_OFF, (PIN_FUNCTION_REG(18, PORT_PIN_MODE_LIN, 1) | PORT_IBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE  | PORT_OUTPUT )}, /* PCR	18	: PORT_PIN_MODE_LIN */
	...
	{38, STD_OFF, STD_OFF, (PIN_FUNCTION_REG(38, PORT_PIN_MODE_LIN, 1) | PORT_IBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE  | PORT_OUTPUT )}, /* PCR	38	: PORT_PIN_MODE_LIN */
