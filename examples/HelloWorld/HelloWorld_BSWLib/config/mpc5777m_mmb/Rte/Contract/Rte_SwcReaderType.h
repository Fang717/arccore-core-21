...
extern Std_ReturnType Rte_Call_SwcReaderType_SwcReader_WdgM_AliveSup_CheckpointReached(/*IN*/WdgM_CheckpointIdType CheckpointID);
...
static inline Std_ReturnType Rte_Call_WdgM_AliveSup_CheckpointReached(/*IN*/WdgM_CheckpointIdType CheckpointID) {
    return Rte_Call_SwcReaderType_SwcReader_WdgM_AliveSup_CheckpointReached(CheckpointID);
}
