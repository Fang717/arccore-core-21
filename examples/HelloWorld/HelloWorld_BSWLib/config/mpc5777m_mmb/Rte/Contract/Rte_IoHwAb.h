 ...
 * @req SWS_Rte_02751
 */
#if defined(RTE_RUNNABLEAPI_AnalogRead) || \
defined(RTE_RUNNABLEAPI_DigitalWrite) || \
defined(RTE_RUNNABLEAPI_PwmSetDuty)
...
Std_ReturnType IoHwAb_Analog_Read(/*IN*/IoHwAb_SignalType_ portDefArg1, /*OUT*/AnalogValue * Value, /*OUT*/SignalQuality * Quality);
...
/** --- PwmSetDuty */
#if defined(RTE_RUNNABLEAPI_PwmSetDuty)

Std_ReturnType IoHwAb_Pwm_Set_Duty(/*IN*/IoHwAb_SignalType_ portDefArg1, /*IN*/DutyCycle DutyValue, /*OUT*/SignalQuality * Quality);
