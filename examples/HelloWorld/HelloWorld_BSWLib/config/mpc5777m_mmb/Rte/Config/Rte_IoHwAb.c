...
/** ------ ioHwAb -----------------------------------------------------------------------
 */
Std_ReturnType Rte_ioHwAb_AnalogRead(/*IN*/IoHwAb_SignalType_ portDefArg1, /*OUT*/AnalogValue * Value, /*OUT*/SignalQuality * Quality); /*lint -e621 MISRA:OTHER:Ignore misidentified symbol clash [MISRA 2012 Rule 5.5, required] */
...
Std_ReturnType Rte_ioHwAb_PwmSetDuty(/*IN*/IoHwAb_SignalType_ portDefArg1, /*IN*/DutyCycle DutyValue, /*OUT*/SignalQuality * Quality); /*lint -e621 MISRA:OTHER:Ignore misidentified symbol clash [MISRA 2012 Rule 5.5, required] */
...
#include <IoHwAb_MemMap.h> /*lint !e415 Autosar specified way to group code into memory sections, Req SWS_MemMap_00003 */
Std_ReturnType Rte_ioHwAb_AnalogRead(/*IN*/IoHwAb_SignalType_ portDefArg1, /*OUT*/AnalogValue * Value, /*OUT*/SignalQuality * Quality) {
...
#define IoHwAb_START_SEC_CODE
#include <IoHwAb_MemMap.h> /*lint !e415 Autosar specified way to group code into memory sections, Req SWS_MemMap_00003 */
Std_ReturnType Rte_ioHwAb_PwmSetDuty(/*IN*/IoHwAb_SignalType_ portDefArg1, /*IN*/DutyCycle DutyValue, /*OUT*/SignalQuality * Quality) {
    Std_ReturnType retVal;
