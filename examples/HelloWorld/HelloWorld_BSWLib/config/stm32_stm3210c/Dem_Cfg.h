...
#define DEM_MAX_NR_OF_DIDS_IN_FREEZEFRAME_DATA 	1u	/* Maximum number of dids referred by one freeze frame */
...
#define DEM_MAX_SIZE_FF_DATA					3u /* Max number of bytes in one freeze frame */
