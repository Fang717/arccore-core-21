...
#define PortConf_PortPin_SIN_0 ((Port_PinType)0)
#define PortConf_PortPin_SOUT_0 ((Port_PinType)1)
#define PortConf_PortPin_SCK_0 ((Port_PinType)2)
#define PortConf_PortPin_CAN0TX ((Port_PinType)3)
#define PortConf_PortPin_CAN0RX ((Port_PinType)4)
#define PortConf_PortPin_ANS0 ((Port_PinType)5)
#define PortConf_PortPin_CS1_0 ((Port_PinType)6)
#define PortConf_PortPin_CAN1TX ((Port_PinType)7)
#define PortConf_PortPin_CAN1RX ((Port_PinType)8)
#define PortConf_PortPin_GPIO64 ((Port_PinType)9)
#define PortConf_PortPin_GPIO65 ((Port_PinType)10)
#define PortConf_PortPin_GPIO68 ((Port_PinType)11)
#define PortConf_PortPin_GPIO69 ((Port_PinType)12)
#define PortConf_PortPin_E0UC22 ((Port_PinType)13)
#define PortConf_PortPin_SIN1 ((Port_PinType)14)
#define PortConf_PortPin_SOUT1 ((Port_PinType)15)
#define PortConf_PortPin_SCK_1 ((Port_PinType)16)
#define PortConf_PortPin_CS0_1 ((Port_PinType)17)

#define PORT_NOF_PINS	18
