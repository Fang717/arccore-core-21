...
#define CANIF_PDU_ID_TESTER01        1
#define CANIF_PDU_ID_DIAGFUNCTIONALRX        2
#define CANIF_PDU_ID_DIAGPHYSICALRX        3
#define CANIF_PDU_ID_SWCMEM_RX_CANIF        4

#define CANIF_PDU_ID_ECU01        1
#define CANIF_PDU_ID_DIAGPHYSICALTX        2
#define CANIF_PDU_ID_DIAGUUDT        3
