...
const Mcu_ClockSettingConfigType Mcu_ClockSettingConfigData[] = {
   {
      .McuClockReferencePointFrequency = 33333333UL,
		...
		/* CAN */
		.CAN_CLK_CTRL 	= 	((uint32)14<<DIV0_SH) + ((uint32)3<<DIV1_SH) +
							((uint32)1<<ACT0_SH) + ((uint32)1<<ACT1_SH), 
		.CAN_MIOCLK_CTRL = 	(0), 
		...
		.GEM0_CLK_CTRL = 	((uint32)0<<DIV1_SH) +
							((uint32)0<<DIV0_SH) +
							(0),							 	
		.GEM0_RCLK_CTRL = 	((uint32)UNSET<<SRCSEL_SH) +	
		                                       (0), 						 	
		...
		.LQSPI_CLK_CTRL = 	((uint32)5<<DIV0_SH) +
							(1),
