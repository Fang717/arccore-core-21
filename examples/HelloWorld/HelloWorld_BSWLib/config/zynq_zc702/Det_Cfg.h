...
/* @req ARC_SWS_DET_00003 DET is compiler and hardware independent */
/* @req SWS_BSW_00031 Pre-compile time configuration parameters should be defines */
/* @req SWS_BSW_00029 standard on or off */
/** @req ECUC_Det_00002 */
#define DET_ENABLE_CALLBACKS STD_OFF // Enable to use callback on errors
/** @req ECUC_Det_00006 */
#define DET_FORWARD_TO_DLT   STD_ON // Enable to use callout to Dlt 
...
/** @req ECUC_Det_00003 */
/* @req SWS_BSW_00236 Version Info*/
