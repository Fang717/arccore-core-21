...
typedef struct {
    struct {
        struct {
            ...
            uint8 previousMode;
            boolean transitionCompleted;
        } localMode_Supervised100msTask_currentMode;
        struct {
...
#define RTE_TRANSITION_WdgM_wdgm_localMode_Supervised100msTask_currentMode 255
...
#define RTE_MODE_WdgM_wdgm_localMode_Supervised100msTask_currentMode_SUPERVISION_DEACTIVATED 0
#define RTE_MODE_WdgM_wdgm_localMode_Supervised100msTask_currentMode_SUPERVISION_EXPIRED 2
#define RTE_MODE_WdgM_wdgm_localMode_Supervised100msTask_currentMode_SUPERVISION_FAILED 1
#define RTE_MODE_WdgM_wdgm_localMode_Supervised100msTask_currentMode_SUPERVISION_OK 4
#define RTE_MODE_WdgM_wdgm_localMode_Supervised100msTask_currentMode_SUPERVISION_STOPPED 3
...
Std_ReturnType Rte_Read_Dcm_dcm_DataServices_SRRead3_Data_Data(/*OUT*/SRRead3_Data_DataType * data);
...
/** ------ Control_FiMFID1 */
Std_ReturnType Rte_Call_FiM_fim_Control_FiMFID1_SetFunctionAvailable(/*IN*/boolean Availability);

/** ------ Func_FiMFID1 */
Std_ReturnType Rte_Call_FiM_fim_Func_FiMFID1_GetFunctionPermission(/*OUT*/boolean * Permission);
...
/** ------ FiM_FID1_Inhibition */
Std_ReturnType Rte_Call_SwcReaderType_SwcReader_FiM_FID1_Inhibition_GetFunctionPermission(/*OUT*/boolean * Permission);
...
// Empty
/** ------ WdgM_LocalSup */
Std_ReturnType Rte_Call_SwcReaderType_SwcReader_WdgM_LocalSup_CheckpointReached(/*IN*/WdgM_CheckpointIdType CheckpointID);
...
Std_ReturnType Rte_Switch_WdgM_wdgm_localMode_Supervised100msTask_currentMode(uint8 mode);
