...
#define PWM_CH_PRESALER_CK0        0
#define PWM_CH_PRESALER_CK1        1
#define PWM_CH_PRESALER_CK2        2
#define PWM_CH_PRESALER_CK3        3
...
/* Standard defines */
#define PWM_ARC_HW_UNIT_HIGH                 4u
#define PWM_ARC_HW_UNIT_CNT                     (PWM_ARC_HW_UNIT_HIGH + 1)
#define PWM_ARC_LOG_UNIT_CNT                1u            
...
#define  PwmConf_PwmChannel_Channel_LED_3 (Pwm_ChannelType)4
#define PWM_NUMBER_OF_CHANNELS 1 

#define PWM_ARC_PERIOD_API        STD_ON
...
#define PWM_CHANNEL_PRESCALER_0 0UL
#define PWM_CHANNEL_PRESCALER_1 1UL
#define PWM_CHANNEL_PRESCALER_2 2UL
#define PWM_CHANNEL_PRESCALER_3 3UL

typedef uint32 Pwm_ChannelPrescalerType;
...
typedef struct {
    ...
    Pwm_NotificationHandlerType notification;
