...
/* PLLs */
#define IO_PLL_FREQUENCY 			999999999		
#define ARM_PLL_FREQUENCY  			1333333333
...
/* CAN */
#define MCU_ARC_CLOCK_CAN_0_FREQUENCY		(IO_PLL_FREQUENCY/ (14 * 3 ))	 
																
#define MCU_ARC_CLOCK_CAN_1_FREQUENCY		MCU_ARC_CLOCK_CAN_0_FREQUENCY

/* GEM */
#define MCU_ARC_CLOCK_GEM_0_FREQUENCY		(IO_PLL_FREQUENCY/ (0 * 0 ))	
...
/* LSPI */
#define MCU_ARC_CLOCK_LQSPI_FREQUENCY		(IO_PLL_FREQUENCY/ 5 )
...
/* SPI */
#define MCU_ARC_CLOCK_SPI_0_FREQUENCY		(IO_PLL_FREQUENCY/ 6 ) 
