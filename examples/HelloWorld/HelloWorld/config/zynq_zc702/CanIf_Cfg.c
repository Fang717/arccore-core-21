...
// User defined Tx confirmations
extern void Arc_T1_Tx_Cbk(PduIdType pduId);

// User defined Rx notifications
extern void Arc_T1_Rx_Cbk(PduIdType RxPduId, PduInfoType* PduInfoPtr);
