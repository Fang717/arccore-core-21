...
extern Std_ReturnType Rte_fim_GetFunctionPermission(/*IN*/FiM_FunctionIdType portDefArg1, /*OUT*/boolean * Permission);
extern Std_ReturnType Rte_fim_SetFunctionAvailable(/*IN*/FiM_FunctionIdType portDefArg1, /*IN*/boolean Availability);
...
extern Std_ReturnType Rte_wdgm_GetFirstExpiredSEID(/*OUT*/WdgM_SupervisedEntityIdType * SEID);
extern Std_ReturnType Rte_wdgm_GetGlobalStatus(/*OUT*/WdgM_GlobalStatusType * Status);
extern Std_ReturnType Rte_wdgm_GetLocalStatus(/*IN*/WdgM_SupervisedEntityIdType portDefArg1, /*OUT*/WdgM_LocalStatusType * Status);
extern Std_ReturnType Rte_wdgm_GetMode(/*OUT*/WdgM_ModeType * Mode);
extern void Rte_wdgm_PerformReset(void);
extern Std_ReturnType Rte_wdgm_SetMode(/*IN*/WdgM_ModeType Mode);
