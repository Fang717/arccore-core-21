...
extern Std_ReturnType Rte_Read_Dcm_dcm_DataServices_SRRead3_Data_Data(/*OUT*/SRRead3_Data_DataType * data);
...
static inline Std_ReturnType Rte_Read_DataServices_SRRead3_Data_Data(/*OUT*/SRRead3_Data_DataType * data) {
    return Rte_Read_Dcm_dcm_DataServices_SRRead3_Data_Data(data);
}
