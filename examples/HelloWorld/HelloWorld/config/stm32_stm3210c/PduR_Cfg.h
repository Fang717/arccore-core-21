...
#define PDUR_MAX_ROUTE_COUNT				50
...
#define PduRConf_Pdu_DiagPhysicalTx 0u 
#define PduRConf_Pdu_DiagUUDT 1u 
...
#define PDUR_PDU_ID_DIAGPHYSICALTX					0UL
#define PDUR_REVERSE_PDU_ID_DIAGPHYSICALTX			0UL

#define PDUR_PDU_ID_DIAGUUDT					1UL
#define PDUR_REVERSE_PDU_ID_DIAGUUDT			1UL
