...
#define DCM_NOF_IOCONTROL_DIDS				3
...
// sender/receiver data access functions defined by RTE
// extern Std_ReturnType Rte_Read_DataServices_SRRead1_Data_Data(uint16 Data);
// extern Std_ReturnType Rte_Read_DataServices_SRRead2_Data_Data(uint16 Data);
// extern Std_ReturnType Rte_Read_DataServices_SRRead3_Data_Data(boolean Data);
// extern Std_ReturnType Rte_Write_DataServices_SRWrite1_Data_Write_Data(uint16 *Data);
// extern Std_ReturnType Rte_Write_DataServices_SRWrite2_Data_Write_Data(uint16 *Data);
...
/* IO Control and read functions for IoHwAb signal AnalogSignal */
extern Std_ReturnType IoHwAb_Dcm_AnalogSignal(uint8 action, uint8* value);
extern Std_ReturnType IoHwAb_Dcm_Read_AnalogSignal(uint8 *data);
