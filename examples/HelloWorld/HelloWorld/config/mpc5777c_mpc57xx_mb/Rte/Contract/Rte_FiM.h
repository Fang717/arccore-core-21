 ...
 * @req SWS_Rte_02751
 */
#if defined(RTE_RUNNABLEAPI_GetFunctionPermission) || \
defined(RTE_RUNNABLEAPI_SetFunctionAvailable)
...
typedef Rte_CDS_FiM const * const Rte_Instance;

/** --- Singleton instance handle -----------------------------------------------------------------
 *  @req SWS_Rte_03793
 */
extern const Rte_Instance Rte_Inst_FiM;
#define self (Rte_Inst_FiM)
...
Std_ReturnType FiM_GetFunctionPermission(/*IN*/FiM_FunctionIdType portDefArg1, /*OUT*/boolean * Permission);

#endif

/** --- SetFunctionAvailable */
#if defined(RTE_RUNNABLEAPI_SetFunctionAvailable)

Std_ReturnType FiM_SetFunctionAvailable(/*IN*/FiM_FunctionIdType portDefArg1, /*IN*/boolean Availability);
