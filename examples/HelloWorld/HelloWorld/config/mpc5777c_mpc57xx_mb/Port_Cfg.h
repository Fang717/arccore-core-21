...
#define PortConf_PortPin_FlexCAN_A_CNTXA ((Port_PinType)0)
#define PortConf_PortPin_FlexCAN_A_CNRXA ((Port_PinType)1)
#define PortConf_PortPin_FEC_FEC_MDIO ((Port_PinType)2)
#define PortConf_PortPin_FEC_FEC_MDIO_OUT ((Port_PinType)3)
#define PortConf_PortPin_DSPI_B_SCKB ((Port_PinType)4)
#define PortConf_PortPin_DSPI_B_SINB ((Port_PinType)5)
#define PortConf_PortPin_DSPI_B_SOUTB ((Port_PinType)6)
#define PortConf_PortPin_DSPI_B_PCSB0 ((Port_PinType)7)
#define PortConf_PortPin_FEC_FEC_MDC ((Port_PinType)8)
#define PortConf_PortPin_eMIOS_0_EMIOS0_channel2 ((Port_PinType)9)
#define PortConf_PortPin_SIU_A_GPIO_180_PWM ((Port_PinType)10)
#define PortConf_PortPin_eMIOS_0_EMIOS2_channel4 ((Port_PinType)11)
#define PortConf_PortPin_eMIOS_0_EMIOS22_channel1 ((Port_PinType)12)
#define PortConf_PortPin_eMIOS_0_EMIOS23_channel ((Port_PinType)13)
#define PortConf_PortPin_FEC_FEC_TXD0 ((Port_PinType)14)
#define PortConf_PortPin_FEC_FEC_RX_DV ((Port_PinType)15)
#define PortConf_PortPin_FEC_FEC_RXD0 ((Port_PinType)16)
#define PortConf_PortPin_FEC_FEC_TXD1 ((Port_PinType)17)
#define PortConf_PortPin_FEC_FEC_TXEN ((Port_PinType)18)
#define PortConf_PortPin_FEC_FEC_RXD1 ((Port_PinType)19)
#define PortConf_PortPin_SIU_A_GPIO_446 ((Port_PinType)20)
#define PortConf_PortPin_SIU_A_GPIO_447 ((Port_PinType)21)
#define PortConf_PortPin_FEC_FEC_TXCLK_REFCLK ((Port_PinType)22)

#define PORT_NOF_PINS	23
