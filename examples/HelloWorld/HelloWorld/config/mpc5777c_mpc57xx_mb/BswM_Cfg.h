...
#define BSWM_PDUGROUPSWITCH_ACTIONS     (3u)
#define BSWM_DEADLINEMONITORING_ACTIONS (0u)
#define BSWM_PDUROUTERCONTROL_ACTIONS   (0u)

#define BSWM_IPDUALLENABLED_ACTION_IDX (0u)
#define BSWM_REQUESTFULLCOM_ACTION_IDX (1u)
#define BSWM_IPDULISTENONLY_ACTION_IDX (2u)
#define BSWM_IPDUALLDISABLED_ACTION_IDX (3u)
#define BSWM_WDGMENABLEACTION_ACTION_IDX (4u)
#define BSWM_WDGMDISABLEACTION_ACTION_IDX (5u)
#define BSWM_NUMBER_OF_ATOMIC_ACTIONS (6u)

#define BSWM_COMMFULLCOMMUNCATIONLEXPRESSION_EXP_IDX (0u)
#define BSWM_STARTCOMMUNICATIONEXPRESSION_EXP_IDX (1u)
#define BSWM_COMMSILENTCOMMUNCATIONLEXPRESSION_EXP_IDX (2u)
#define BSWM_COMMNOCOMMUNCATIONLEXPRESSION_EXP_IDX (3u)
#define BSWM_WDGMMODEEXPRESSION_EXP_IDX (4u)
#define BSWM_NUMBER_OF_LOGICAL_EXPRESSIONS (5u)
...
#define BSWM_WDGMMODE_REQ_IDX (2u)
#define BSWM_NUMBER_OF_REQUESTS (3u)

#define BSWM_NUMBER_OF_RULES_MAX (5u)
