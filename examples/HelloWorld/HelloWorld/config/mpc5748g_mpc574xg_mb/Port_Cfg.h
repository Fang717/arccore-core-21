...
#if !(((PORT_SW_MAJOR_VERSION == 7) && (PORT_SW_MINOR_VERSION == 0)) )
#error Port: Configuration file expected BSW module version to be 7.0.*
#endif
...
#if defined(CFG_MPC560X) || defined(CFG_MPC5645S) || defined(CFG_MPC5643L) || defined(CFG_SPC56XL70) || defined(CFG_MPC5777C)
	uint16 config;
#else
	uint32 config;
#endif 
...
#define PortConf_PortPin_ENET0_MII_0_RX_CLK ((Port_PinType)0)
#define PortConf_PortPin_ENET0_MII_0_RXD_2 ((Port_PinType)1)
#define PortConf_PortPin_ENET0_MII_RMII_0_RXD_1 ((Port_PinType)2)
#define PortConf_PortPin_ENET0_MII_RMII_0_RXD_0 ((Port_PinType)3)
#define PortConf_PortPin_ENET0_MII_0_COL ((Port_PinType)4)
#define PortConf_PortPin_ENET0_MII_RMII_0_RX_ER ((Port_PinType)5)
#define PortConf_PortPin_DSPI_0_dSIN_0 ((Port_PinType)6)
#define PortConf_PortPin_DSPI_0_dSOUT_0 ((Port_PinType)7)
#define PortConf_PortPin_DSPI_0_dSCLK_0 ((Port_PinType)8)
#define PortConf_PortPin_DSPI_0_dCS0_0 ((Port_PinType)9)
#define PortConf_PortPin_CAN0TX ((Port_PinType)10)
#define PortConf_PortPin_CAN0RX ((Port_PinType)11)
#define PortConf_PortPin_ADC_0_ADC0_S_2 ((Port_PinType)12)
#define PortConf_PortPin_ENET0_ENET0_TMR0 ((Port_PinType)13)
#define PortConf_PortPin_ENET0_MII_0_CRS ((Port_PinType)14)
#define PortConf_PortPin_ENET0_MII_0_RXD_3 ((Port_PinType)15)
#define PortConf_PortPin_SPI_0_SCLK_0 ((Port_PinType)16)
#define PortConf_PortPin_ENET0_MII_RMII_0_MDIO ((Port_PinType)17)
#define PortConf_PortPin_ENET0_MII_RMII_0_RX_DV ((Port_PinType)18)
#define PortConf_PortPin_ENET0_MII_RMII_0_MDC ((Port_PinType)19)
#define PortConf_PortPin_ENET0_MII_RMII_0_TX_CLK ((Port_PinType)20)
#define PortConf_PortPin_LED1_DS2 ((Port_PinType)21)
#define PortConf_PortPin_LED2_DS3 ((Port_PinType)22)
#define PortConf_PortPin_EMIOS1_E1UC_13_H ((Port_PinType)23)
#define PortConf_PortPin_EMIOS1_E1UC_14_H ((Port_PinType)24)
#define PortConf_PortPin_ENET0_MII_0_TXD_2 ((Port_PinType)25)
#define PortConf_PortPin_ENET0_MII_0_TXD_3 ((Port_PinType)26)
#define PortConf_PortPin_ENET0_MII_RMII_0_TXD_1 ((Port_PinType)27)
#define PortConf_PortPin_ENET0_MII_RMII_0_TXD_0 ((Port_PinType)28)
#define PortConf_PortPin_ENET0_MII_RMII_0_TX_EN ((Port_PinType)29)
#define PortConf_PortPin_ENET0_MII_0_TX_ER ((Port_PinType)30)
#define PortConf_PortPin_ENET0_ENET0_TMR1 ((Port_PinType)31)
#define PortConf_PortPin_SPI_0_SIN_0 ((Port_PinType)32)
#define PortConf_PortPin_SPI_0_CS0_0 ((Port_PinType)33)
#define PortConf_PortPin_SIUL2_GPIO_144 ((Port_PinType)34)
#define PortConf_PortPin_SPI_0_SOUT_0 ((Port_PinType)35)
#define PortConf_PortPin_ENET0_ENET0_TMR2 ((Port_PinType)36)

#define PORT_NOF_PINS	37
#define PORT_NR_PINS    PORT_NOF_PINS
