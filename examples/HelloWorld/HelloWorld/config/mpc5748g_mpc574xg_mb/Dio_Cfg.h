...
// Channels
#define DioConf_DioChannel_LED1 98u
#define Dio_LED1 DioConf_DioChannel_LED1
#define DioConf_DioChannel_LED2 99u
#define Dio_LED2 DioConf_DioChannel_LED2
#define DioConf_DioChannel_SpiCs 144u
...
// Ports
#define DioConf_DioPort_PortG (DIO_PORT_G)
#define Dio_PortG DioConf_DioPort_PortG
#define DioConf_DioPort_PortJ (DIO_PORT_J)
#define Dio_PortJ DioConf_DioPort_PortJ
