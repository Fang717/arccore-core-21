...
#define PWM_PRESCALER_EMIOS_2				1
...
#define  PwmConf_PwmChannel_Channel_LED_3 (Pwm_ChannelType)43
#define  Pwm_Channel_LED_3 PwmConf_PwmChannel_Channel_LED_3
#define  PwmConf_PwmChannel_Channel_LED_4 (Pwm_ChannelType)44
