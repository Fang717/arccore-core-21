...
// Channels
#define DioConf_DioChannel_KEY1 64u
#define Dio_KEY1 DioConf_DioChannel_KEY1
#define DioConf_DioChannel_KEY2 65u
#define Dio_KEY2 DioConf_DioChannel_KEY2
#define DioConf_DioChannel_LED1 68u
#define Dio_LED1 DioConf_DioChannel_LED1
#define DioConf_DioChannel_LED2 69u
#define Dio_LED2 DioConf_DioChannel_LED2
#define DioConf_DioChannel_SpiCs 28u
...
// Ports
#define DioConf_DioPort_PB (DIO_PORT_B)
#define Dio_PB DioConf_DioPort_PB
