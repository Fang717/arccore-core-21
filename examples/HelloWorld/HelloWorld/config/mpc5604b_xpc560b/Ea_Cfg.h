...
#if !(((EA_AR_RELEASE_MAJOR_VERSION == 4) && (EA_AR_RELEASE_MINOR_VERSION == 0)) )
#error EA: Configuration file expected AUTOSAR version to be 4.0.*
#endif
...
typedef struct {
	...
	void (*EaNvmJobEndNotification)(void);/* @req EA099 */
