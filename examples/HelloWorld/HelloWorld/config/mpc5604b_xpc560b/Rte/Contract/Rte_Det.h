 ...
 * @req SWS_Rte_02751
 */
#if defined(RTE_RUNNABLEAPI_ReportError)
...
typedef Rte_CDS_Det const * const Rte_Instance;

/** --- Singleton instance handle -----------------------------------------------------------------
 *  @req SWS_Rte_03793
 */
extern const Rte_Instance Rte_Inst_Det;
#define self (Rte_Inst_Det)
...
Std_ReturnType Det_ReportError(/*IN*/uint16 portDefArg1, /*IN*/uint8 portDefArg2, /*IN*/uint8 ApiId, /*IN*/uint8 ErrorId);
