...
void OsRteTask(void) { /** @req SWS_Rte_02251 */
    ...
    do {
        SYS_CALL_WaitEvent(
                EVENT_MASK_ModeSwitchOsEvent | EVENT_MASK_WatchdogModeSwitchEvent | EVENT_MASK_OsEvent2 | EVENT_MASK_OsEvent1
                        | EVENT_MASK_ComMFullComOsEvent | EVENT_MASK_SwcMemCmdReceived); /*lint !e534 RTE Requirement */
