...
#define ARRAY_SIZE_Dem_MaxDataValueType (33u)
...
/* Redefinition type FiM_FunctionIdType */
...
/* Redefinition type SRRead3_Data_DataType */
typedef boolean SRRead3_Data_DataType;
