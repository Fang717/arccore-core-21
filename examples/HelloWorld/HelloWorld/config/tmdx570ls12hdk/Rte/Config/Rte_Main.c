...
Std_ReturnType Rte_Start(void) {
    ...
    WdgM_ModeMachines.wdgm.localMode_Supervised100msTask_currentMode.currentMode = 3;
    WdgM_ModeMachines.wdgm.localMode_Supervised100msTask_currentMode.nextMode = 255;
    WdgM_ModeMachines.wdgm.localMode_Supervised100msTask_currentMode.previousMode = 255;
