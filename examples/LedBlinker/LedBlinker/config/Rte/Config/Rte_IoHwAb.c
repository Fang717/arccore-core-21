...
/** ------ serviceIoHwAb -----------------------------------------------------------------------
 */
Std_ReturnType Rte_serviceIoHwAb_DigitalWrite(/*IN*/IoHwAb_SignalType_ portDefArg1, /*IN*/DigitalLevel Level); /*lint -e621 MISRA:OTHER:Ignore misidentified symbol clash [MISRA 2012 Rule 5.5, required] */
...
const Rte_CDS_IoHwAb IoHwAb_serviceIoHwAb = {
    ._dummy = 0
};
...
#define IoHwAb_START_SEC_CONST_UNSPECIFIED
#include <IoHwAb_MemMap.h> /*lint !e415 Autosar specified way to group code into memory sections, Req SWS_MemMap_00003 */
const Rte_Instance Rte_Inst_IoHwAb = &IoHwAb_serviceIoHwAb;
