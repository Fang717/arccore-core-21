...
// Application Id's
#define APPLICATION_ID_OsSLBApplication 0u


// Alarm Id's
#define ALARM_ID_OsRteAlarm1000ms	((AlarmType)0)
...
#define TASK_ID_OsRteTask	((TaskType)1)
...
#define OS_CORE_0_MAIN_APPLICATION	APPLICATION_ID_OsSLBApplication
