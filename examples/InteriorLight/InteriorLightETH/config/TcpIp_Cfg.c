...
TcpIp_StaticIpAddressConfigType TcpIp_StaticIpAddressConfig_TcpIpLocalAddr = {
    .ArcValid = TRUE,
    .StaticIpAddress = IP4_ADDR_CHR_TO_UINT32(192,168,0,10), /*lint !e9027 !e845 */
    .DefaultRouter = IP4_ADDR_CHR_TO_UINT32(192,168,0,1), /*lint !e9027 !e845 */
    .Netmask = 24,
};
...
TcpIp_StaticIpAddressConfigType TcpIp_StaticIpAddressConfig_TcpIpLocalAddrMultAuto = {
    .ArcValid = TRUE,
    .StaticIpAddress = IP4_ADDR_CHR_TO_UINT32(225,0,0,1), /*lint !e9027 !e845 */
    .DefaultRouter = 0,
    .Netmask = 24,
};
