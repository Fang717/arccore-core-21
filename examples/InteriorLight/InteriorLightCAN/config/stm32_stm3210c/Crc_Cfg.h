...
/* @req SWS_BSW_00031 The Precompile time configuration header shall contain definitions for all Precompile time configuration parameters defines */

/* @req SWS_BSW_00036 The BSW Module shall perform Inter Module Checks to avoid integration of incompatible files*/
/* @req SWS_BSW_00030 Provide Pre-compile time configuration header files */
