...
#define BSWM_PDUGROUPSWITCH_ACTIONS     (2u)
#define BSWM_DEADLINEMONITORING_ACTIONS (0u)
#define BSWM_PDUROUTERCONTROL_ACTIONS   (0u)

#define BSWM_IPDUALLDISABLED_ACTION_IDX (0u)
#define BSWM_REQUESTFULLCOM_ACTION_IDX (1u)
#define BSWM_IPDUALLENABLED_ACTION_IDX (2u)
#define BSWM_NUMBER_OF_ATOMIC_ACTIONS (3u)

#define BSWM_COMMFULLCOMMUNCATIONLEXPRESSION_EXP_IDX (0u)
#define BSWM_STARTCOMMUNICATIONEXPRESSION_EXP_IDX (1u)
#define BSWM_COMMNOCOMMUNCATIONLEXPRESSION_EXP_IDX (2u)
#define BSWM_NUMBER_OF_LOGICAL_EXPRESSIONS (3u)
...
#define BSWM_SWCSTARTCOMMUNICATION_REQ_IDX (0u)
#define BSWM_BSWCOMMINDICATION_REQ_IDX (1u)
#define BSWM_NUMBER_OF_REQUESTS (2u)

#define BSWM_NUMBER_OF_RULES_MAX (3u)
