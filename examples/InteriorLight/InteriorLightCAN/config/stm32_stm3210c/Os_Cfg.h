...
// Application Id's
#define APPLICATION_ID_OsApplicationInteriorLight 0u


// Alarm Id's
#define ALARM_ID_OsRteAlarm100ms	((AlarmType)0)
#define ALARM_ID_OsAlarmBswServices	((AlarmType)1)
...
// Event masks
#define EVENT_MASK_OsMainEvent	 (EventMaskType)((EventMaskType)1u<<0)
#define EVENT_MASK_OsInitEvent	 (EventMaskType)((EventMaskType)1u<<1)
...
#define TASK_ID_OsBswTask	((TaskType)1)
...
#define OS_CORE_0_MAIN_APPLICATION	APPLICATION_ID_OsApplicationInteriorLight
