...
#define PduRConf_Pdu_PduRx 0u 
#define PduRConf_Pdu_PduTx 1u 
...
#define PDUR_PDU_ID_PDURX					0UL
#define PDUR_REVERSE_PDU_ID_PDURX			0UL

#define PDUR_PDU_ID_PDUTX					1UL
#define PDUR_REVERSE_PDU_ID_PDUTX			1UL
