...
#define BSWM_DISABLEPDUGROUPSRULE_RULE_IDX (0u)
#define BSWM_ENABLEPDUGROUPSRULE_RULE_IDX (1u)
#define BSWM_STARTCOMMUNICATIONRULE_RULE_IDX (2u)
#define BSWM_NUMBER_OF_RULES (3u)
...
#define BSWM_DISABLEPDUSACTIONS_LIST_IDX (0u)
#define BSWM_STARTCOMMUNCATIONACTIONS_LIST_IDX (1u)
#define BSWM_ENABLEPDUSACTIONS_LIST_IDX (2u)
#define BSWM_NUMBER_OF_ACTIONLISTS (3u)
