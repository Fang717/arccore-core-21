...
lib-y += -lgcc -lc -lm 
ifeq ($(CFG_TMS570),y)
lib-$(CFG_ARM_CR4)   	+= $(ROOTDIR)/mcal/Fls/src/contrib/F021_API_CortexR4_BE_V3D16.lib
lib-$(CFG_ARM_CR5)   	+= $(ROOTDIR)/mcal/Fls/src/contrib/F021_L2FMC/F021_API_CortexR4_BE_L2FMC_V3D16.lib
endif
