 ...
 *
 * \defgroup IfxLld_I2c_Registers I2cRegisters
 * \ingroup IfxLld
 * 
 * \defgroup IfxLld_I2c_Registers_Bitfields Bitfields
 * \ingroup IfxLld_I2c_Registers
 * 
 * \defgroup IfxLld_I2c_Registers_union Register unions
 * \ingroup IfxLld_I2c_Registers
 * 
 * \defgroup IfxLld_I2c_Registers_struct Memory map
 * \ingroup IfxLld_I2c_Registers
 */
...
{
    Ifx_UReg_32Bit EN0:1;             /**< \brief [0:0] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN1:1;             /**< \brief [1:1] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN2:1;             /**< \brief [2:2] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN3:1;             /**< \brief [3:3] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN4:1;             /**< \brief [4:4] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN5:1;             /**< \brief [5:5] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN6:1;             /**< \brief [6:6] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN7:1;             /**< \brief [7:7] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN8:1;             /**< \brief [8:8] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN9:1;             /**< \brief [9:9] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN10:1;            /**< \brief [10:10] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN11:1;            /**< \brief [11:11] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN12:1;            /**< \brief [12:12] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN13:1;            /**< \brief [13:13] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN14:1;            /**< \brief [14:14] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN15:1;            /**< \brief [15:15] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN16:1;            /**< \brief [16:16] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN17:1;            /**< \brief [17:17] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN18:1;            /**< \brief [18:18] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN19:1;            /**< \brief [19:19] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN20:1;            /**< \brief [20:20] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN21:1;            /**< \brief [21:21] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN22:1;            /**< \brief [22:22] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN23:1;            /**< \brief [23:23] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN24:1;            /**< \brief [24:24] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN25:1;            /**< \brief [25:25] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN26:1;            /**< \brief [26:26] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN27:1;            /**< \brief [27:27] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN28:1;            /**< \brief [28:28] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN29:1;            /**< \brief [29:29] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN30:1;            /**< \brief [30:30] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
    Ifx_UReg_32Bit EN31:1;            /**< \brief [31:31] Access Enable for Master TAG ID ${j} - EN${j} (rw) */
} Ifx_I2C_ACCEN0_Bits;
...
typedef struct _Ifx_I2C_CLC1_Bits
{
    ...
    Ifx_UReg_32Bit ORMC:8;            /**< \brief [23:16] Clock Divider for Optional Run Mode (AHB peripherals) - ORMC (rwh) */
...
typedef struct _Ifx_I2C_FDIVHIGHCFG_Bits
{
    ...
    Ifx_UReg_32Bit DIS_SCL_SYN:1;     /**< \brief [31:31] Disable SCL Synchronization - DIS_SCL_SYN (rw) */
...
{
    Ifx_UReg_32Bit TXD:32;            /**< \brief [31:0] Transmission Data - TXD (rw) */
} Ifx_I2C_TXD_Bits;
...
typedef volatile struct _Ifx_I2C
{
       ...
       Ifx_UReg_8Bit                       reserved_94[4];         /**< \brief 94, \internal Reserved */
       Ifx_UReg_8Bit                       reserved_98[32616];     /**< \brief 98, \internal Reserved */
       ...
       Ifx_UReg_8Bit                       reserved_10020[224];    /**< \brief 10020, \internal Reserved */
} Ifx_I2C;
