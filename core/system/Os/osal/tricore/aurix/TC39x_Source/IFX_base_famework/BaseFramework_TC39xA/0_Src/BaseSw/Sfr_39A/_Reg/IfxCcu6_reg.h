 ...
 *
 * \defgroup IfxLld_Ccu6_Registers_Cfg Ccu6 address
 * \ingroup IfxLld_Ccu6_Registers
 * 
 * \defgroup IfxLld_Ccu6_Registers_Cfg_BaseAddress Base address
 * \ingroup IfxLld_Ccu6_Registers_Cfg
 *
 * \defgroup IfxLld_Ccu6_Registers_Cfg_Ccu60 2-CCU60
 * \ingroup IfxLld_Ccu6_Registers_Cfg
 *
 * \defgroup IfxLld_Ccu6_Registers_Cfg_Ccu61 2-CCU61
 * \ingroup IfxLld_Ccu6_Registers_Cfg
 *
 *
 */
...
/** \brief 30, Capture/Compare Register for Channel CC6${x} */
#define CCU60_CC6R0 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6R*)0xF0002A30u)
...
/** \brief 34, Capture/Compare Register for Channel CC6${x} */
#define CCU60_CC6R1 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6R*)0xF0002A34u)
...
/** \brief 38, Capture/Compare Register for Channel CC6${x} */
#define CCU60_CC6R2 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6R*)0xF0002A38u)
...
/** \brief 40, Capture/Compare Shadow Reg. for Channel CC6${x} */
#define CCU60_CC6SR0 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6SR*)0xF0002A40u)
...
/** \brief 44, Capture/Compare Shadow Reg. for Channel CC6${x} */
#define CCU60_CC6SR1 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6SR*)0xF0002A44u)
...
/** \brief 48, Capture/Compare Shadow Reg. for Channel CC6${x} */
#define CCU60_CC6SR2 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6SR*)0xF0002A48u)
...
/** \brief 30, Capture/Compare Register for Channel CC6${x} */
#define CCU61_CC6R0 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6R*)0xF0002B30u)
...
/** \brief 34, Capture/Compare Register for Channel CC6${x} */
#define CCU61_CC6R1 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6R*)0xF0002B34u)
...
/** \brief 38, Capture/Compare Register for Channel CC6${x} */
#define CCU61_CC6R2 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6R*)0xF0002B38u)
...
/** \brief 40, Capture/Compare Shadow Reg. for Channel CC6${x} */
#define CCU61_CC6SR0 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6SR*)0xF0002B40u)
...
/** \brief 44, Capture/Compare Shadow Reg. for Channel CC6${x} */
#define CCU61_CC6SR1 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6SR*)0xF0002B44u)
...
/** \brief 48, Capture/Compare Shadow Reg. for Channel CC6${x} */
#define CCU61_CC6SR2 /*lint --e(923)*/ (*(volatile Ifx_CCU6_CC6SR*)0xF0002B48u)
