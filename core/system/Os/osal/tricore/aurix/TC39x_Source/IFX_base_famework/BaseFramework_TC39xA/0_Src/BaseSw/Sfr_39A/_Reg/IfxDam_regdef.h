 ...
 *
 * \defgroup IfxLld_Dam Dam
 * \ingroup IfxLld
 * 
 * \defgroup IfxLld_Dam_Bitfields Bitfields
 * \ingroup IfxLld_Dam
 * 
 * \defgroup IfxLld_Dam_union Register unions
 * \ingroup IfxLld_Dam
 * 
 * \defgroup IfxLld_Dam_struct Memory map
 * \ingroup IfxLld_Dam
 */
...
/******************************************************************************/
/** \addtogroup IfxLld_Dam_Bitfields
 * \{  */
...
/** \brief ${Mod_Name}Memory Control Register */
...
typedef struct _Ifx_DAM_SCTRL_Bits
{
...
typedef union
{
    Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_DAM_SCTRL_Bits B;             /**< \brief Bitfield access */
} Ifx_DAM_SCTRL;

/** \}  */
/******************************************************************************/
/******************************************************************************/
/** \addtogroup IfxLld_Dam_RGN_struct
 * \{  */
/******************************************************************************/
/** \name Object L1
 * \{  */
...
{
       Ifx_DAM_RGN_LA                      LA;                     /**< \brief 0, ${LMU_instance_name}Region Lower Address Register*/
       Ifx_DAM_RGN_UA                      UA;                     /**< \brief 4, ${LMU_instance_name}Region Upper Address Register*/
       Ifx_DAM_RGN_ACCENA                  ACCENA;                 /**< \brief 8, ${LMU_instance_name}Region Access Enable Register 0*/
       Ifx_DAM_RGN_ACCENB                  ACCENB;                 /**< \brief C, ${LMU_instance_name}Region Access Enable Register 1*/
} Ifx_DAM_RGN;
/** \}  */
/******************************************************************************/
/** \}  */
...
/******************************************************************************/
/******************************************************************************/
/** \addtogroup IfxLld_Dam_RGNACCEN_struct
 * \{  */
/******************************************************************************/
/** \name Object L2
 * \{  */
...
typedef volatile struct _Ifx_DAM_RGNACCEN
{
       ...
       Ifx_DAM_RGNACCEN_RA                 RA;                     /**< \brief 8, ${LMU_instance_name}Region Access Enable Register 0*/
       Ifx_DAM_RGNACCEN_RB                 RB;                     /**< \brief C, ${LMU_instance_name}Region Access Enable Register 1*/
} Ifx_DAM_RGNACCEN;
/** \}  */
/******************************************************************************/
/** \}  */
...
{
       Ifx_DAM_CLC                         CLC;                    /**< \brief 0, ${LMU_instance_name}Clock Control Register*/
       Ifx_UReg_8Bit                       reserved_4[4];          /**< \brief 4, \internal Reserved */
       Ifx_DAM_MODID                       MODID;                  /**< \brief 8, ${LMU_instance_name}Module ID Register*/
       Ifx_UReg_8Bit                       reserved_C[4];          /**< \brief C, \internal Reserved */
       Ifx_DAM_ACCEN0                      ACCEN0;                 /**< \brief 10, ${LMU_instance_name}Access Enable Register 0*/
       Ifx_DAM_ACCEN1                      ACCEN1;                 /**< \brief 14, ${LMU_instance_name}Access Enable Register 1*/
       Ifx_UReg_8Bit                       reserved_18[8];         /**< \brief 18, \internal Reserved */
       Ifx_DAM_MEMCON                      MEMCON;                 /**< \brief 20, ${Mod_Name}Memory Control Register*/
       Ifx_DAM_SCTRL                       SCTRL;                  /**< \brief 24, ${LMU_instance_name}Safety Control Register*/
       Ifx_UReg_8Bit                       reserved_28[40];        /**< \brief 28, \internal Reserved */
       Ifx_DAM_RGN                         RGN[8];                 /**< \brief 50, ${LMU_instance_name}Region Access Enable Register 1*/
       Ifx_DAM_RGNACCEN                    RGNACCEN[8];            /**< \brief D0, */
       Ifx_UReg_8Bit                       reserved_158[32432];    /**< \brief 150, \internal Reserved */
} Ifx_DAM;
