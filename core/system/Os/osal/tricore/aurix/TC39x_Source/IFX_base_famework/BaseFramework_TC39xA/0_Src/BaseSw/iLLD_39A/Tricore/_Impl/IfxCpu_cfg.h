...
/** \brief all cores (coreIDs) mask
 */
#define IFXCPU_ALLCORE_DONE           (0x5F)
...
typedef enum
{
    ...
    IfxCpu_ResourceCpu_3 = 3,  /**< \brief CPU 3 */
    IfxCpu_ResourceCpu_4 = 4,  /**< \brief CPU 4 */
    IfxCpu_ResourceCpu_5 = 5,  /**< \brief CPU 5 */
