...
#define IFX_SCU_CCUCON0_FSI2DIV_OFF             (26)
...
#define IFX_SCU_CCUCON0_GTMDIV_LEN              (4)

/** \\brief  Mask for Ifx_SCU_CCUCON0_Bits.GTMDIV */
#define IFX_SCU_CCUCON0_GTMDIV_MSK              (0xf)

/** \\brief  Offset for Ifx_SCU_CCUCON0_Bits.GTMDIV */
#define IFX_SCU_CCUCON0_GTMDIV_OFF              (4)
...
#define IFX_SCU_CCUCON0_LPDIV_LEN               (3)

/** \\brief  Mask for Ifx_SCU_CCUCON0_Bits.LPDIV */
#define IFX_SCU_CCUCON0_LPDIV_MSK               (0x7)
...
#define IFX_SCU_CCUCON0_STMDIV_LEN              (4)

/** \\brief  Mask for Ifx_SCU_CCUCON0_Bits.STMDIV */
#define IFX_SCU_CCUCON0_STMDIV_MSK              (0xf)

/** \\brief  Offset for Ifx_SCU_CCUCON0_Bits.STMDIV */
#define IFX_SCU_CCUCON0_STMDIV_OFF              (0)
...
#define IFX_SCU_CHIPID_SEC_OFF                  (31)
...
#define IFX_SCU_CHIPID_VART_LEN                 (3)

/** \\brief  Mask for Ifx_SCU_CHIPID_Bits.VART */
#define IFX_SCU_CHIPID_VART_MSK                 (0x7)

/** \\brief  Offset for Ifx_SCU_CHIPID_Bits.VART */
#define IFX_SCU_CHIPID_VART_OFF                 (28)

/** \\brief  Length for Ifx_SCU_EICON0_Bits.ENDINIT */
#define IFX_SCU_EICON0_ENDINIT_LEN              (1)

/** \\brief  Mask for Ifx_SCU_EICON0_Bits.ENDINIT */
#define IFX_SCU_EICON0_ENDINIT_MSK              (0x1)

/** \\brief  Offset for Ifx_SCU_EICON0_Bits.ENDINIT */
#define IFX_SCU_EICON0_ENDINIT_OFF              (1)

/** \\brief  Length for Ifx_SCU_EICON0_Bits.EPW */
#define IFX_SCU_EICON0_EPW_LEN                  (14)

/** \\brief  Mask for Ifx_SCU_EICON0_Bits.EPW */
#define IFX_SCU_EICON0_EPW_MSK                  (0x3fff)

/** \\brief  Offset for Ifx_SCU_EICON0_Bits.EPW */
#define IFX_SCU_EICON0_EPW_OFF                  (2)

/** \\brief  Length for Ifx_SCU_EICON0_Bits.REL */
#define IFX_SCU_EICON0_REL_LEN                  (16)

/** \\brief  Mask for Ifx_SCU_EICON0_Bits.REL */
#define IFX_SCU_EICON0_REL_MSK                  (0xffff)

/** \\brief  Offset for Ifx_SCU_EICON0_Bits.REL */
#define IFX_SCU_EICON0_REL_OFF                  (16)

/** \\brief  Length for Ifx_SCU_EICON0_Bits.Reserved */
#define IFX_SCU_EICON0_RESERVED_LEN             (1)

/** \\brief  Mask for Ifx_SCU_EICON0_Bits.Reserved */
#define IFX_SCU_EICON0_RESERVED_MSK             (0x1)

/** \\brief  Offset for Ifx_SCU_EICON0_Bits.Reserved */
#define IFX_SCU_EICON0_RESERVED_OFF             (0)

/** \\brief  Length for Ifx_SCU_EICON1_Bits.DR */
#define IFX_SCU_EICON1_DR_LEN                   (1)

/** \\brief  Mask for Ifx_SCU_EICON1_Bits.DR */
#define IFX_SCU_EICON1_DR_MSK                   (0x1)

/** \\brief  Offset for Ifx_SCU_EICON1_Bits.DR */
#define IFX_SCU_EICON1_DR_OFF                   (3)

/** \\brief  Length for Ifx_SCU_EICON1_Bits.IR0 */
#define IFX_SCU_EICON1_IR0_LEN                  (1)

/** \\brief  Mask for Ifx_SCU_EICON1_Bits.IR0 */
#define IFX_SCU_EICON1_IR0_MSK                  (0x1)

/** \\brief  Offset for Ifx_SCU_EICON1_Bits.IR0 */
#define IFX_SCU_EICON1_IR0_OFF                  (2)

/** \\brief  Length for Ifx_SCU_EICON1_Bits.IR1 */
#define IFX_SCU_EICON1_IR1_LEN                  (1)

/** \\brief  Mask for Ifx_SCU_EICON1_Bits.IR1 */
#define IFX_SCU_EICON1_IR1_MSK                  (0x1)

/** \\brief  Offset for Ifx_SCU_EICON1_Bits.IR1 */
#define IFX_SCU_EICON1_IR1_OFF                  (5)
...
#define IFX_SCU_LBISTCTRL0_LBISTDONE_LEN        (1)

/** \\brief  Mask for Ifx_SCU_LBISTCTRL0_Bits.LBISTDONE */
#define IFX_SCU_LBISTCTRL0_LBISTDONE_MSK        (0x1)

/** \\brief  Offset for Ifx_SCU_LBISTCTRL0_Bits.LBISTDONE */
#define IFX_SCU_LBISTCTRL0_LBISTDONE_OFF        (28)
...
#define IFX_SCU_LBISTCTRL0_LBISTRES_LEN         (1)

/** \\brief  Mask for Ifx_SCU_LBISTCTRL0_Bits.LBISTRES */
#define IFX_SCU_LBISTCTRL0_LBISTRES_MSK         (0x1)

/** \\brief  Offset for Ifx_SCU_LBISTCTRL0_Bits.LBISTRES */
#define IFX_SCU_LBISTCTRL0_LBISTRES_OFF         (1)

/** \\brief  Length for Ifx_SCU_LBISTCTRL0_Bits.PATTERNS */
#define IFX_SCU_LBISTCTRL0_PATTERNS_LEN         (18)

/** \\brief  Mask for Ifx_SCU_LBISTCTRL0_Bits.PATTERNS */
#define IFX_SCU_LBISTCTRL0_PATTERNS_MSK         (0x3ffff)
...
#define IFX_SCU_LBISTCTRL1_SEED_LEN             (19)

/** \\brief  Mask for Ifx_SCU_LBISTCTRL1_Bits.SEED */
#define IFX_SCU_LBISTCTRL1_SEED_MSK             (0x7ffff)
...
/** \\brief  Length for Ifx_SCU_MODTRIMCON1_Bits.DELTA_RND_GAIN */
#define IFX_SCU_MODTRIMCON1_DELTA_RND_GAIN_LEN  (8)

/** \\brief  Mask for Ifx_SCU_MODTRIMCON1_Bits.DELTA_RND_GAIN */
#define IFX_SCU_MODTRIMCON1_DELTA_RND_GAIN_MSK  (0xff)

/** \\brief  Offset for Ifx_SCU_MODTRIMCON1_Bits.DELTA_RND_GAIN */
#define IFX_SCU_MODTRIMCON1_DELTA_RND_GAIN_OFF  (8)

/** \\brief  Length for Ifx_SCU_MODTRIMCON1_Bits.PEREMCDELAY */
#define IFX_SCU_MODTRIMCON1_PEREMCDELAY_LEN     (2)

/** \\brief  Mask for Ifx_SCU_MODTRIMCON1_Bits.PEREMCDELAY */
#define IFX_SCU_MODTRIMCON1_PEREMCDELAY_MSK     (0x3)

/** \\brief  Offset for Ifx_SCU_MODTRIMCON1_Bits.PEREMCDELAY */
#define IFX_SCU_MODTRIMCON1_PEREMCDELAY_OFF     (26)

/** \\brief  Length for Ifx_SCU_MODTRIMCON1_Bits.SYSEMCDELAY */
#define IFX_SCU_MODTRIMCON1_SYSEMCDELAY_LEN     (2)

/** \\brief  Mask for Ifx_SCU_MODTRIMCON1_Bits.SYSEMCDELAY */
#define IFX_SCU_MODTRIMCON1_SYSEMCDELAY_MSK     (0x3)

/** \\brief  Offset for Ifx_SCU_MODTRIMCON1_Bits.SYSEMCDELAY */
#define IFX_SCU_MODTRIMCON1_SYSEMCDELAY_OFF     (24)

/** \\brief  Length for Ifx_SCU_MODTRIMCON1_Bits.XCORR_AVG_SEL */
#define IFX_SCU_MODTRIMCON1_XCORR_AVG_SEL_LEN   (2)

/** \\brief  Mask for Ifx_SCU_MODTRIMCON1_Bits.XCORR_AVG_SEL */
#define IFX_SCU_MODTRIMCON1_XCORR_AVG_SEL_MSK   (0x3)

/** \\brief  Offset for Ifx_SCU_MODTRIMCON1_Bits.XCORR_AVG_SEL */
#define IFX_SCU_MODTRIMCON1_XCORR_AVG_SEL_OFF   (16)

/** \\brief  Length for Ifx_SCU_MODTRIMCON1_Bits.XCORR_SEL_DELAY */
#define IFX_SCU_MODTRIMCON1_XCORR_SEL_DELAY_LEN (2)

/** \\brief  Mask for Ifx_SCU_MODTRIMCON1_Bits.XCORR_SEL_DELAY */
#define IFX_SCU_MODTRIMCON1_XCORR_SEL_DELAY_MSK (0x3)

/** \\brief  Offset for Ifx_SCU_MODTRIMCON1_Bits.XCORR_SEL_DELAY */
#define IFX_SCU_MODTRIMCON1_XCORR_SEL_DELAY_OFF (18)

/** \\brief  Length for Ifx_SCU_MODTRIMCON1_Bits.XCORR_TOL */
#define IFX_SCU_MODTRIMCON1_XCORR_TOL_LEN       (8)

/** \\brief  Mask for Ifx_SCU_MODTRIMCON1_Bits.XCORR_TOL */
#define IFX_SCU_MODTRIMCON1_XCORR_TOL_MSK       (0xff)

/** \\brief  Offset for Ifx_SCU_MODTRIMCON1_Bits.XCORR_TOL */
#define IFX_SCU_MODTRIMCON1_XCORR_TOL_OFF       (0)
...
#define IFX_SCU_PERPLLCON0_DIVBY_LEN            (1)

/** \\brief  Mask for Ifx_SCU_PERPLLCON0_Bits.DIVBY */
#define IFX_SCU_PERPLLCON0_DIVBY_MSK            (0x1)

/** \\brief  Offset for Ifx_SCU_PERPLLCON0_Bits.DIVBY */
#define IFX_SCU_PERPLLCON0_DIVBY_OFF            (0)

/** \\brief  Length for Ifx_SCU_PERPLLCON0_Bits.NDIV */
#define IFX_SCU_PERPLLCON0_NDIV_LEN             (7)

/** \\brief  Mask for Ifx_SCU_PERPLLCON0_Bits.NDIV */
#define IFX_SCU_PERPLLCON0_NDIV_MSK             (0x7f)

/** \\brief  Offset for Ifx_SCU_PERPLLCON0_Bits.NDIV */
#define IFX_SCU_PERPLLCON0_NDIV_OFF             (9)

/** \\brief  Length for Ifx_SCU_PERPLLCON0_Bits.PDIV */
#define IFX_SCU_PERPLLCON0_PDIV_LEN             (3)

/** \\brief  Mask for Ifx_SCU_PERPLLCON0_Bits.PDIV */
#define IFX_SCU_PERPLLCON0_PDIV_MSK             (0x7)

/** \\brief  Offset for Ifx_SCU_PERPLLCON0_Bits.PDIV */
#define IFX_SCU_PERPLLCON0_PDIV_OFF             (24)

/** \\brief  Length for Ifx_SCU_PERPLLCON0_Bits.PLLPWD */
#define IFX_SCU_PERPLLCON0_PLLPWD_LEN           (1)

/** \\brief  Mask for Ifx_SCU_PERPLLCON0_Bits.PLLPWD */
#define IFX_SCU_PERPLLCON0_PLLPWD_MSK           (0x1)

/** \\brief  Offset for Ifx_SCU_PERPLLCON0_Bits.PLLPWD */
#define IFX_SCU_PERPLLCON0_PLLPWD_OFF           (16)

/** \\brief  Length for Ifx_SCU_PERPLLCON0_Bits.RESLD */
#define IFX_SCU_PERPLLCON0_RESLD_LEN            (1)

/** \\brief  Mask for Ifx_SCU_PERPLLCON0_Bits.RESLD */
#define IFX_SCU_PERPLLCON0_RESLD_MSK            (0x1)

/** \\brief  Offset for Ifx_SCU_PERPLLCON0_Bits.RESLD */
#define IFX_SCU_PERPLLCON0_RESLD_OFF            (18)

/** \\brief  Length for Ifx_SCU_PERPLLCON1_Bits.K2DIV */
#define IFX_SCU_PERPLLCON1_K2DIV_LEN            (3)

/** \\brief  Mask for Ifx_SCU_PERPLLCON1_Bits.K2DIV */
#define IFX_SCU_PERPLLCON1_K2DIV_MSK            (0x7)

/** \\brief  Offset for Ifx_SCU_PERPLLCON1_Bits.K2DIV */
#define IFX_SCU_PERPLLCON1_K2DIV_OFF            (0)

/** \\brief  Length for Ifx_SCU_PERPLLCON1_Bits.K3DIV */
#define IFX_SCU_PERPLLCON1_K3DIV_LEN            (3)

/** \\brief  Mask for Ifx_SCU_PERPLLCON1_Bits.K3DIV */
#define IFX_SCU_PERPLLCON1_K3DIV_MSK            (0x7)

/** \\brief  Offset for Ifx_SCU_PERPLLCON1_Bits.K3DIV */
#define IFX_SCU_PERPLLCON1_K3DIV_OFF            (8)

/** \\brief  Length for Ifx_SCU_PERPLLSTAT_Bits.BY */
#define IFX_SCU_PERPLLSTAT_BY_LEN               (1)

/** \\brief  Mask for Ifx_SCU_PERPLLSTAT_Bits.BY */
#define IFX_SCU_PERPLLSTAT_BY_MSK               (0x1)

/** \\brief  Offset for Ifx_SCU_PERPLLSTAT_Bits.BY */
#define IFX_SCU_PERPLLSTAT_BY_OFF               (6)

/** \\brief  Length for Ifx_SCU_PERPLLSTAT_Bits.K2RDY */
#define IFX_SCU_PERPLLSTAT_K2RDY_LEN            (1)

/** \\brief  Mask for Ifx_SCU_PERPLLSTAT_Bits.K2RDY */
#define IFX_SCU_PERPLLSTAT_K2RDY_MSK            (0x1)

/** \\brief  Offset for Ifx_SCU_PERPLLSTAT_Bits.K2RDY */
#define IFX_SCU_PERPLLSTAT_K2RDY_OFF            (5)

/** \\brief  Length for Ifx_SCU_PERPLLSTAT_Bits.K3RDY */
#define IFX_SCU_PERPLLSTAT_K3RDY_LEN            (1)

/** \\brief  Mask for Ifx_SCU_PERPLLSTAT_Bits.K3RDY */
#define IFX_SCU_PERPLLSTAT_K3RDY_MSK            (0x1)

/** \\brief  Offset for Ifx_SCU_PERPLLSTAT_Bits.K3RDY */
#define IFX_SCU_PERPLLSTAT_K3RDY_OFF            (4)

/** \\brief  Length for Ifx_SCU_PERPLLSTAT_Bits.LOCK */
#define IFX_SCU_PERPLLSTAT_LOCK_LEN             (1)

/** \\brief  Mask for Ifx_SCU_PERPLLSTAT_Bits.LOCK */
#define IFX_SCU_PERPLLSTAT_LOCK_MSK             (0x1)

/** \\brief  Offset for Ifx_SCU_PERPLLSTAT_Bits.LOCK */
#define IFX_SCU_PERPLLSTAT_LOCK_OFF             (2)

/** \\brief  Length for Ifx_SCU_PERPLLSTAT_Bits.PWDSTAT */
#define IFX_SCU_PERPLLSTAT_PWDSTAT_LEN          (1)

/** \\brief  Mask for Ifx_SCU_PERPLLSTAT_Bits.PWDSTAT */
#define IFX_SCU_PERPLLSTAT_PWDSTAT_MSK          (0x1)

/** \\brief  Offset for Ifx_SCU_PERPLLSTAT_Bits.PWDSTAT */
#define IFX_SCU_PERPLLSTAT_PWDSTAT_OFF          (1)
...
#define IFX_SCU_RSTCON2_CSSX_LEN                (6)

/** \\brief  Mask for Ifx_SCU_RSTCON2_Bits.CSSx */
#define IFX_SCU_RSTCON2_CSSX_MSK                (0x3f)

/** \\brief  Offset for Ifx_SCU_RSTCON2_Bits.CSSx */
#define IFX_SCU_RSTCON2_CSSX_OFF                (7)

/** \\brief  Length for Ifx_SCU_RSTCON2_Bits.FLSS */
#define IFX_SCU_RSTCON2_FLSS_LEN                (1)

/** \\brief  Mask for Ifx_SCU_RSTCON2_Bits.FLSS */
#define IFX_SCU_RSTCON2_FLSS_MSK                (0x1)

/** \\brief  Offset for Ifx_SCU_RSTCON2_Bits.FLSS */
#define IFX_SCU_RSTCON2_FLSS_OFF                (6)

/** \\brief  Length for Ifx_SCU_RSTCON2_Bits.FRTO */
#define IFX_SCU_RSTCON2_FRTO_LEN                (1)

/** \\brief  Mask for Ifx_SCU_RSTCON2_Bits.FRTO */
#define IFX_SCU_RSTCON2_FRTO_MSK                (0x1)

/** \\brief  Offset for Ifx_SCU_RSTCON2_Bits.FRTO */
#define IFX_SCU_RSTCON2_FRTO_OFF                (0)

/** \\brief  Length for Ifx_SCU_RSTCON2_Bits.MCDSSS */
#define IFX_SCU_RSTCON2_MCDSSS_LEN              (1)

/** \\brief  Mask for Ifx_SCU_RSTCON2_Bits.MCDSSS */
#define IFX_SCU_RSTCON2_MCDSSS_MSK              (0x1)

/** \\brief  Offset for Ifx_SCU_RSTCON2_Bits.MCDSSS */
#define IFX_SCU_RSTCON2_MCDSSS_OFF              (15)

/** \\brief  Length for Ifx_SCU_RSTCON2_Bits.TOUT20 */
#define IFX_SCU_RSTCON2_TOUT20_LEN              (1)

/** \\brief  Mask for Ifx_SCU_RSTCON2_Bits.TOUT20 */
#define IFX_SCU_RSTCON2_TOUT20_MSK              (0x1)

/** \\brief  Offset for Ifx_SCU_RSTCON2_Bits.TOUT20 */
#define IFX_SCU_RSTCON2_TOUT20_OFF              (2)

/** \\brief  Length for Ifx_SCU_RSTCON2_Bits.TOUT40 */
#define IFX_SCU_RSTCON2_TOUT40_LEN              (1)

/** \\brief  Mask for Ifx_SCU_RSTCON2_Bits.TOUT40 */
#define IFX_SCU_RSTCON2_TOUT40_MSK              (0x1)

/** \\brief  Offset for Ifx_SCU_RSTCON2_Bits.TOUT40 */
#define IFX_SCU_RSTCON2_TOUT40_OFF              (3)

/** \\brief  Length for Ifx_SCU_RSTCON2_Bits.TOUT60 */
#define IFX_SCU_RSTCON2_TOUT60_LEN              (1)

/** \\brief  Mask for Ifx_SCU_RSTCON2_Bits.TOUT60 */
#define IFX_SCU_RSTCON2_TOUT60_MSK              (0x1)

/** \\brief  Offset for Ifx_SCU_RSTCON2_Bits.TOUT60 */
#define IFX_SCU_RSTCON2_TOUT60_OFF              (4)

/** \\brief  Length for Ifx_SCU_RSTCON2_Bits.TOUT80 */
#define IFX_SCU_RSTCON2_TOUT80_LEN              (1)

/** \\brief  Mask for Ifx_SCU_RSTCON2_Bits.TOUT80 */
#define IFX_SCU_RSTCON2_TOUT80_MSK              (0x1)

/** \\brief  Offset for Ifx_SCU_RSTCON2_Bits.TOUT80 */
#define IFX_SCU_RSTCON2_TOUT80_OFF              (5)
...
/** \\brief  Length for Ifx_SCU_RSTSTAT_Bits.RBBF0 */
#define IFX_SCU_RSTSTAT_RBBF0_LEN               (1)

/** \\brief  Mask for Ifx_SCU_RSTSTAT_Bits.RBBF0 */
#define IFX_SCU_RSTSTAT_RBBF0_MSK               (0x1)

/** \\brief  Offset for Ifx_SCU_RSTSTAT_Bits.RBBF0 */
#define IFX_SCU_RSTSTAT_RBBF0_OFF               (29)

/** \\brief  Length for Ifx_SCU_RSTSTAT_Bits.RBBF1 */
#define IFX_SCU_RSTSTAT_RBBF1_LEN               (1)

/** \\brief  Mask for Ifx_SCU_RSTSTAT_Bits.RBBF1 */
#define IFX_SCU_RSTSTAT_RBBF1_MSK               (0x1)

/** \\brief  Offset for Ifx_SCU_RSTSTAT_Bits.RBBF1 */
#define IFX_SCU_RSTSTAT_RBBF1_OFF               (30)
...
/** \\brief  Length for Ifx_SCU_RSTSTAT_Bits.TCU */
#define IFX_SCU_RSTSTAT_TCU_LEN                 (1)

/** \\brief  Mask for Ifx_SCU_RSTSTAT_Bits.TCU */
#define IFX_SCU_RSTSTAT_TCU_MSK                 (0x1)

/** \\brief  Offset for Ifx_SCU_RSTSTAT_Bits.TCU */
#define IFX_SCU_RSTSTAT_TCU_OFF                 (22)

/** \\brief  Length for Ifx_SCU_RSTSTAT_Bits.TP */
#define IFX_SCU_RSTSTAT_TP_LEN                  (1)

/** \\brief  Mask for Ifx_SCU_RSTSTAT_Bits.TP */
#define IFX_SCU_RSTSTAT_TP_MSK                  (0x1)

/** \\brief  Offset for Ifx_SCU_RSTSTAT_Bits.TP */
#define IFX_SCU_RSTSTAT_TP_OFF                  (21)

/** \\brief  Length for Ifx_SCU_SEICON0_Bits.ENDINIT */
#define IFX_SCU_SEICON0_ENDINIT_LEN             (1)

/** \\brief  Mask for Ifx_SCU_SEICON0_Bits.ENDINIT */
#define IFX_SCU_SEICON0_ENDINIT_MSK             (0x1)

/** \\brief  Offset for Ifx_SCU_SEICON0_Bits.ENDINIT */
#define IFX_SCU_SEICON0_ENDINIT_OFF             (1)

/** \\brief  Length for Ifx_SCU_SEICON0_Bits.EPW */
#define IFX_SCU_SEICON0_EPW_LEN                 (14)

/** \\brief  Mask for Ifx_SCU_SEICON0_Bits.EPW */
#define IFX_SCU_SEICON0_EPW_MSK                 (0x3fff)

/** \\brief  Offset for Ifx_SCU_SEICON0_Bits.EPW */
#define IFX_SCU_SEICON0_EPW_OFF                 (2)

/** \\brief  Length for Ifx_SCU_SEICON0_Bits.REL */
#define IFX_SCU_SEICON0_REL_LEN                 (16)

/** \\brief  Mask for Ifx_SCU_SEICON0_Bits.REL */
#define IFX_SCU_SEICON0_REL_MSK                 (0xffff)

/** \\brief  Offset for Ifx_SCU_SEICON0_Bits.REL */
#define IFX_SCU_SEICON0_REL_OFF                 (16)

/** \\brief  Length for Ifx_SCU_SEICON0_Bits.Reserved */
#define IFX_SCU_SEICON0_RESERVED_LEN            (1)

/** \\brief  Mask for Ifx_SCU_SEICON0_Bits.Reserved */
#define IFX_SCU_SEICON0_RESERVED_MSK            (0x1)

/** \\brief  Offset for Ifx_SCU_SEICON0_Bits.Reserved */
#define IFX_SCU_SEICON0_RESERVED_OFF            (0)

/** \\brief  Length for Ifx_SCU_SEICON1_Bits.DR */
#define IFX_SCU_SEICON1_DR_LEN                  (1)

/** \\brief  Mask for Ifx_SCU_SEICON1_Bits.DR */
#define IFX_SCU_SEICON1_DR_MSK                  (0x1)

/** \\brief  Offset for Ifx_SCU_SEICON1_Bits.DR */
#define IFX_SCU_SEICON1_DR_OFF                  (3)

/** \\brief  Length for Ifx_SCU_SEICON1_Bits.IR0 */
#define IFX_SCU_SEICON1_IR0_LEN                 (1)

/** \\brief  Mask for Ifx_SCU_SEICON1_Bits.IR0 */
#define IFX_SCU_SEICON1_IR0_MSK                 (0x1)

/** \\brief  Offset for Ifx_SCU_SEICON1_Bits.IR0 */
#define IFX_SCU_SEICON1_IR0_OFF                 (2)

/** \\brief  Length for Ifx_SCU_SEICON1_Bits.IR1 */
#define IFX_SCU_SEICON1_IR1_LEN                 (1)

/** \\brief  Mask for Ifx_SCU_SEICON1_Bits.IR1 */
#define IFX_SCU_SEICON1_IR1_MSK                 (0x1)

/** \\brief  Offset for Ifx_SCU_SEICON1_Bits.IR1 */
#define IFX_SCU_SEICON1_IR1_OFF                 (5)

/** \\brief  Length for Ifx_SCU_SEISR_Bits.AE */
#define IFX_SCU_SEISR_AE_LEN                    (1)

/** \\brief  Mask for Ifx_SCU_SEISR_Bits.AE */
#define IFX_SCU_SEISR_AE_MSK                    (0x1)

/** \\brief  Offset for Ifx_SCU_SEISR_Bits.AE */
#define IFX_SCU_SEISR_AE_OFF                    (0)

/** \\brief  Length for Ifx_SCU_SEISR_Bits.DS */
#define IFX_SCU_SEISR_DS_LEN                    (1)

/** \\brief  Mask for Ifx_SCU_SEISR_Bits.DS */
#define IFX_SCU_SEISR_DS_MSK                    (0x1)

/** \\brief  Offset for Ifx_SCU_SEISR_Bits.DS */
#define IFX_SCU_SEISR_DS_OFF                    (3)

/** \\brief  Length for Ifx_SCU_SEISR_Bits.IS0 */
#define IFX_SCU_SEISR_IS0_LEN                   (1)

/** \\brief  Mask for Ifx_SCU_SEISR_Bits.IS0 */
#define IFX_SCU_SEISR_IS0_MSK                   (0x1)

/** \\brief  Offset for Ifx_SCU_SEISR_Bits.IS0 */
#define IFX_SCU_SEISR_IS0_OFF                   (2)

/** \\brief  Length for Ifx_SCU_SEISR_Bits.IS1 */
#define IFX_SCU_SEISR_IS1_LEN                   (1)

/** \\brief  Mask for Ifx_SCU_SEISR_Bits.IS1 */
#define IFX_SCU_SEISR_IS1_MSK                   (0x1)

/** \\brief  Offset for Ifx_SCU_SEISR_Bits.IS1 */
#define IFX_SCU_SEISR_IS1_OFF                   (5)

/** \\brief  Length for Ifx_SCU_SEISR_Bits.OE */
#define IFX_SCU_SEISR_OE_LEN                    (1)

/** \\brief  Mask for Ifx_SCU_SEISR_Bits.OE */
#define IFX_SCU_SEISR_OE_MSK                    (0x1)

/** \\brief  Offset for Ifx_SCU_SEISR_Bits.OE */
#define IFX_SCU_SEISR_OE_OFF                    (1)

/** \\brief  Length for Ifx_SCU_SEISR_Bits.TIM */
#define IFX_SCU_SEISR_TIM_LEN                   (16)

/** \\brief  Mask for Ifx_SCU_SEISR_Bits.TIM */
#define IFX_SCU_SEISR_TIM_MSK                   (0xffff)

/** \\brief  Offset for Ifx_SCU_SEISR_Bits.TIM */
#define IFX_SCU_SEISR_TIM_OFF                   (16)

/** \\brief  Length for Ifx_SCU_SEISR_Bits.TO */
#define IFX_SCU_SEISR_TO_LEN                    (1)

/** \\brief  Mask for Ifx_SCU_SEISR_Bits.TO */
#define IFX_SCU_SEISR_TO_MSK                    (0x1)

/** \\brief  Offset for Ifx_SCU_SEISR_Bits.TO */
#define IFX_SCU_SEISR_TO_OFF                    (4)

/** \\brief  Length for Ifx_SCU_STSTAT_Bits.FARFUSE */
#define IFX_SCU_STSTAT_FARFUSE_LEN              (1)

/** \\brief  Mask for Ifx_SCU_STSTAT_Bits.FARFUSE */
#define IFX_SCU_STSTAT_FARFUSE_MSK              (0x1)

/** \\brief  Offset for Ifx_SCU_STSTAT_Bits.FARFUSE */
#define IFX_SCU_STSTAT_FARFUSE_OFF              (18)
...
/** \\brief  Length for Ifx_SCU_STSTAT_Bits.FSIOFF */
#define IFX_SCU_STSTAT_FSIOFF_LEN               (1)

/** \\brief  Mask for Ifx_SCU_STSTAT_Bits.FSIOFF */
#define IFX_SCU_STSTAT_FSIOFF_MSK               (0x1)

/** \\brief  Offset for Ifx_SCU_STSTAT_Bits.FSIOFF */
#define IFX_SCU_STSTAT_FSIOFF_OFF               (22)
...
/** \\brief  Length for Ifx_SCU_STSTAT_Bits.OTPOFF */
#define IFX_SCU_STSTAT_OTPOFF_LEN               (1)

/** \\brief  Mask for Ifx_SCU_STSTAT_Bits.OTPOFF */
#define IFX_SCU_STSTAT_OTPOFF_MSK               (0x1)

/** \\brief  Offset for Ifx_SCU_STSTAT_Bits.OTPOFF */
#define IFX_SCU_STSTAT_OTPOFF_OFF               (21)
...
/** \\brief  Length for Ifx_SCU_STSTAT_Bits.STPOVREQ */
#define IFX_SCU_STSTAT_STPOVREQ_LEN             (1)

/** \\brief  Mask for Ifx_SCU_STSTAT_Bits.STPOVREQ */
#define IFX_SCU_STSTAT_STPOVREQ_MSK             (0x1)

/** \\brief  Offset for Ifx_SCU_STSTAT_Bits.STPOVREQ */
#define IFX_SCU_STSTAT_STPOVREQ_OFF             (23)

/** \\brief  Length for Ifx_SCU_STSTAT_Bits.SUBFUSE */
#define IFX_SCU_STSTAT_SUBFUSE_LEN              (4)

/** \\brief  Mask for Ifx_SCU_STSTAT_Bits.SUBFUSE */
#define IFX_SCU_STSTAT_SUBFUSE_MSK              (0xf)

/** \\brief  Offset for Ifx_SCU_STSTAT_Bits.SUBFUSE */
#define IFX_SCU_STSTAT_SUBFUSE_OFF              (28)
...
/** \\brief  Length for Ifx_SCU_SWRSTCON_Bits.SWBOOT */
#define IFX_SCU_SWRSTCON_SWBOOT_LEN             (1)

/** \\brief  Mask for Ifx_SCU_SWRSTCON_Bits.SWBOOT */
#define IFX_SCU_SWRSTCON_SWBOOT_MSK             (0x1)

/** \\brief  Offset for Ifx_SCU_SWRSTCON_Bits.SWBOOT */
#define IFX_SCU_SWRSTCON_SWBOOT_OFF             (0)

/** \\brief  Length for Ifx_SCU_SWRSTCON_Bits.SWCFG */
#define IFX_SCU_SWRSTCON_SWCFG_LEN              (8)

/** \\brief  Mask for Ifx_SCU_SWRSTCON_Bits.SWCFG */
#define IFX_SCU_SWRSTCON_SWCFG_MSK              (0xff)

/** \\brief  Offset for Ifx_SCU_SWRSTCON_Bits.SWCFG */
#define IFX_SCU_SWRSTCON_SWCFG_OFF              (8)
...
#define IFX_SCU_SYSCON_DDC_LEN                  (1)

/** \\brief  Mask for Ifx_SCU_SYSCON_Bits.DDC */
#define IFX_SCU_SYSCON_DDC_MSK                  (0x1)

/** \\brief  Offset for Ifx_SCU_SYSCON_Bits.DDC */
#define IFX_SCU_SYSCON_DDC_OFF                  (8)
...
#define IFX_SCU_SYSPLLCON0_INSEL_LEN            (2)

/** \\brief  Mask for Ifx_SCU_SYSPLLCON0_Bits.INSEL */
#define IFX_SCU_SYSPLLCON0_INSEL_MSK            (0x3)

/** \\brief  Offset for Ifx_SCU_SYSPLLCON0_Bits.INSEL */
#define IFX_SCU_SYSPLLCON0_INSEL_OFF            (30)

/** \\brief  Length for Ifx_SCU_SYSPLLCON0_Bits.MODEN */
#define IFX_SCU_SYSPLLCON0_MODEN_LEN            (1)

/** \\brief  Mask for Ifx_SCU_SYSPLLCON0_Bits.MODEN */
#define IFX_SCU_SYSPLLCON0_MODEN_MSK            (0x1)

/** \\brief  Offset for Ifx_SCU_SYSPLLCON0_Bits.MODEN */
#define IFX_SCU_SYSPLLCON0_MODEN_OFF            (2)

/** \\brief  Length for Ifx_SCU_SYSPLLCON0_Bits.NDIV */
#define IFX_SCU_SYSPLLCON0_NDIV_LEN             (7)

/** \\brief  Mask for Ifx_SCU_SYSPLLCON0_Bits.NDIV */
#define IFX_SCU_SYSPLLCON0_NDIV_MSK             (0x7f)

/** \\brief  Offset for Ifx_SCU_SYSPLLCON0_Bits.NDIV */
#define IFX_SCU_SYSPLLCON0_NDIV_OFF             (9)

/** \\brief  Length for Ifx_SCU_SYSPLLCON0_Bits.PDIV */
#define IFX_SCU_SYSPLLCON0_PDIV_LEN             (3)

/** \\brief  Mask for Ifx_SCU_SYSPLLCON0_Bits.PDIV */
#define IFX_SCU_SYSPLLCON0_PDIV_MSK             (0x7)

/** \\brief  Offset for Ifx_SCU_SYSPLLCON0_Bits.PDIV */
#define IFX_SCU_SYSPLLCON0_PDIV_OFF             (24)

/** \\brief  Length for Ifx_SCU_SYSPLLCON0_Bits.PLLPWD */
#define IFX_SCU_SYSPLLCON0_PLLPWD_LEN           (1)

/** \\brief  Mask for Ifx_SCU_SYSPLLCON0_Bits.PLLPWD */
#define IFX_SCU_SYSPLLCON0_PLLPWD_MSK           (0x1)

/** \\brief  Offset for Ifx_SCU_SYSPLLCON0_Bits.PLLPWD */
#define IFX_SCU_SYSPLLCON0_PLLPWD_OFF           (16)

/** \\brief  Length for Ifx_SCU_SYSPLLCON0_Bits.RESLD */
#define IFX_SCU_SYSPLLCON0_RESLD_LEN            (1)

/** \\brief  Mask for Ifx_SCU_SYSPLLCON0_Bits.RESLD */
#define IFX_SCU_SYSPLLCON0_RESLD_MSK            (0x1)

/** \\brief  Offset for Ifx_SCU_SYSPLLCON0_Bits.RESLD */
#define IFX_SCU_SYSPLLCON0_RESLD_OFF            (18)

/** \\brief  Length for Ifx_SCU_SYSPLLCON1_Bits.K2DIV */
#define IFX_SCU_SYSPLLCON1_K2DIV_LEN            (3)

/** \\brief  Mask for Ifx_SCU_SYSPLLCON1_Bits.K2DIV */
#define IFX_SCU_SYSPLLCON1_K2DIV_MSK            (0x7)

/** \\brief  Offset for Ifx_SCU_SYSPLLCON1_Bits.K2DIV */
#define IFX_SCU_SYSPLLCON1_K2DIV_OFF            (0)

/** \\brief  Length for Ifx_SCU_SYSPLLCON2_Bits.MODCFG */
#define IFX_SCU_SYSPLLCON2_MODCFG_LEN           (16)

/** \\brief  Mask for Ifx_SCU_SYSPLLCON2_Bits.MODCFG */
#define IFX_SCU_SYSPLLCON2_MODCFG_MSK           (0xffff)

/** \\brief  Offset for Ifx_SCU_SYSPLLCON2_Bits.MODCFG */
#define IFX_SCU_SYSPLLCON2_MODCFG_OFF           (0)

/** \\brief  Length for Ifx_SCU_SYSPLLSTAT_Bits.BY */
#define IFX_SCU_SYSPLLSTAT_BY_LEN               (1)

/** \\brief  Mask for Ifx_SCU_SYSPLLSTAT_Bits.BY */
#define IFX_SCU_SYSPLLSTAT_BY_MSK               (0x1)

/** \\brief  Offset for Ifx_SCU_SYSPLLSTAT_Bits.BY */
#define IFX_SCU_SYSPLLSTAT_BY_OFF               (6)

/** \\brief  Length for Ifx_SCU_SYSPLLSTAT_Bits.K2RDY */
#define IFX_SCU_SYSPLLSTAT_K2RDY_LEN            (1)

/** \\brief  Mask for Ifx_SCU_SYSPLLSTAT_Bits.K2RDY */
#define IFX_SCU_SYSPLLSTAT_K2RDY_MSK            (0x1)

/** \\brief  Offset for Ifx_SCU_SYSPLLSTAT_Bits.K2RDY */
#define IFX_SCU_SYSPLLSTAT_K2RDY_OFF            (5)

/** \\brief  Length for Ifx_SCU_SYSPLLSTAT_Bits.LOCK */
#define IFX_SCU_SYSPLLSTAT_LOCK_LEN             (1)

/** \\brief  Mask for Ifx_SCU_SYSPLLSTAT_Bits.LOCK */
#define IFX_SCU_SYSPLLSTAT_LOCK_MSK             (0x1)

/** \\brief  Offset for Ifx_SCU_SYSPLLSTAT_Bits.LOCK */
#define IFX_SCU_SYSPLLSTAT_LOCK_OFF             (2)

/** \\brief  Length for Ifx_SCU_SYSPLLSTAT_Bits.MODRUN */
#define IFX_SCU_SYSPLLSTAT_MODRUN_LEN           (1)

/** \\brief  Mask for Ifx_SCU_SYSPLLSTAT_Bits.MODRUN */
#define IFX_SCU_SYSPLLSTAT_MODRUN_MSK           (0x1)

/** \\brief  Offset for Ifx_SCU_SYSPLLSTAT_Bits.MODRUN */
#define IFX_SCU_SYSPLLSTAT_MODRUN_OFF           (7)

/** \\brief  Length for Ifx_SCU_SYSPLLSTAT_Bits.PWDSTAT */
#define IFX_SCU_SYSPLLSTAT_PWDSTAT_LEN          (1)

/** \\brief  Mask for Ifx_SCU_SYSPLLSTAT_Bits.PWDSTAT */
#define IFX_SCU_SYSPLLSTAT_PWDSTAT_MSK          (0x1)

/** \\brief  Offset for Ifx_SCU_SYSPLLSTAT_Bits.PWDSTAT */
#define IFX_SCU_SYSPLLSTAT_PWDSTAT_OFF          (1)
...
#define IFX_SCU_TRAPSET_TRAP2_LEN               (1)

/** \\brief  Mask for Ifx_SCU_TRAPSET_Bits.TRAP2 */
#define IFX_SCU_TRAPSET_TRAP2_MSK               (0x1)

/** \\brief  Offset for Ifx_SCU_TRAPSET_Bits.TRAP2 */
#define IFX_SCU_TRAPSET_TRAP2_OFF               (2)
...
#define IFX_SCU_TRAPSTAT_TRAP2_LEN              (1)

/** \\brief  Mask for Ifx_SCU_TRAPSTAT_Bits.TRAP2 */
#define IFX_SCU_TRAPSTAT_TRAP2_MSK              (0x1)

/** \\brief  Offset for Ifx_SCU_TRAPSTAT_Bits.TRAP2 */
#define IFX_SCU_TRAPSTAT_TRAP2_OFF              (2)
