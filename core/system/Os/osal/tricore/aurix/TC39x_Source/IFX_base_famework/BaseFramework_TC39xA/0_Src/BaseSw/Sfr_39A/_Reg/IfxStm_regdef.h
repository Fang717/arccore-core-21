 ...
 *
 * \defgroup IfxLld_Stm_Registers StmRegisters
 * \ingroup IfxLld
 * 
 * \defgroup IfxLld_Stm_Registers_Bitfields Bitfields
 * \ingroup IfxLld_Stm_Registers
 * 
 * \defgroup IfxLld_Stm_Registers_union Register unions
 * \ingroup IfxLld_Stm_Registers
 * 
 * \defgroup IfxLld_Stm_Registers_struct Memory map
 * \ingroup IfxLld_Stm_Registers
 */
