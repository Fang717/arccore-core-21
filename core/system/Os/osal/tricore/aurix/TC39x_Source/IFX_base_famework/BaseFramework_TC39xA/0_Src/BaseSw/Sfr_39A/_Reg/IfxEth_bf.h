...
/** \brief  Length for Ifx_ETH_GPCTL_Bits.TCEN */
#define IFX_ETH_GPCTL_TCEN_LEN                                         (1)

/** \brief  Mask for Ifx_ETH_GPCTL_Bits.TCEN */
#define IFX_ETH_GPCTL_TCEN_MSK                                         (0x1)

/** \brief  Offset for Ifx_ETH_GPCTL_Bits.TCEN */
#define IFX_ETH_GPCTL_TCEN_OFF                                         (31)
