 ...
 *
 * \defgroup IfxLld_Pms_Std_Evr Evr Basic Functionality
...
typedef enum
{
    ...
    IfxPmsEvr_EnableInterrupt_ovnwlvr = 12,  /**< \brief OVNWLVR Interrupt enable */
    IfxPmsEvr_EnableInterrupt_uvnwlvr = 13,  /**< \brief UVNWLVR Interrupt enable */
    IfxPmsEvr_EnableInterrupt_ovpwcp  = 14,  /**< \brief OVPWCP Interrupt enable */
    IfxPmsEvr_EnableInterrupt_uvpwcp  = 15,  /**< \brief UVWCP Interrupt enable */
 ...
 * \return None
 */
IFX_EXTERN void IfxPmsEvr_setSecondaryOverVoltageThreshold(Ifx_PMS *pms, uint8 thresholdLevel, IfxPmsEvr_SupplyMode supply);
...
/** \brief Coarse Trim 100MHz clock
 * \param pms Pointer to PMS Module
 * \param trimValue OSC Coarse Trim Value
 * \return None
 */
IFX_INLINE void IfxPmsEvr_coarseTrimEvrClock(Ifx_PMS *pms, uint8 trimValue);
...
/** \brief Set SHPBG BandGap Signed Trim Value
 * \param pms Pointer to PMS Module
 * \param trimValue Signed trim Value
 * \return None
 */
IFX_INLINE void IfxPmsEvr_setBandgapSignedTrimValue(Ifx_PMS *pms, sint8 trimValue);

/** \brief Set SHPBG BandGap Trim Value
 * \param pms Pointer to PMS Module
 * \param trimValue SHPBG Bandgap Trim Value
 * \return None
 */
IFX_INLINE void IfxPmsEvr_setBandgapTrimValue(Ifx_PMS *pms, uint8 trimValue);
 ...
 * \return None
 */
IFX_INLINE void IfxPmsEvr_setResetTrimValue(Ifx_PMS *pms, uint8 resetTrimValue, IfxPmsEvr_SupplyMode supply);
 ...
 * \return None
 */
IFX_EXTERN void IfxPmsEvr_setSecondaryUnderVoltageThreshold(Ifx_PMS *pms, uint8 thresholdLevel, IfxPmsEvr_SupplyMode supply);
 ...
 */
IFX_INLINE float32 IfxPmsEvr_getAdcVddResult(Ifx_PMS *pms);

/**
 * \param pms Pointer to PMS Module space
 * \return ADC VDDP3 Voltage Conversion Result
 */
IFX_INLINE float32 IfxPmsEvr_getAdcVddp3Result(Ifx_PMS *pms);

/**
 * \param pms Pointer to PMS Module space
 * \return ADC VEXT Supply Conversion Result
 */
IFX_INLINE float32 IfxPmsEvr_getAdcVextResult(Ifx_PMS *pms);
...
IFX_EXTERN IFX_CONST void *const                          IfxPmsEvr_areInitValuesRightFunPtr;
...
IFX_EXTERN IFX_CONST void *const                          IfxPmsEvr_runInitSequenceFunPtr;
...
IFX_INLINE boolean IfxPmsEvr_areInitValuesRight(const IfxPmsEvr_checkRegConfig *const checkConfig)
{
    __moveToAddrParam0(checkConfig);
    extern const void *const IfxPmsEvr_areInitValuesRightFunPtr;
    __jumpToFunction(IfxPmsEvr_areInitValuesRightFunPtr); //This is non return call to the function
    return (boolean)__getDataParamRet();
}
...
IFX_INLINE void IfxPmsEvr_coarseTrimEvrClock(Ifx_PMS *pms, uint8 trimValue)
{
    ...
    pms->EVR.BGOCTRL.B.OSCCTRIM = trimValue;
...
IFX_INLINE void IfxPmsEvr_enableDcdcSynchronisation(Ifx_PMS *pms, boolean enabled)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->PMSW.CR5.B.DCDCSYNCO = enabled;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_enableInterrupts(Ifx_PMS *pms, IfxPmsEvr_EnableInterrupt interruptType)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.PMSIEN.U |= (1U << interruptType);
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_enableWakeupOnVextSupplyRampUp(Ifx_PMS *pms, boolean enabled)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->PMSW.CR0.B.PWRWKEN = enabled;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_evr33ResetTriggerSignalConfig(Ifx_PMS *pms, boolean enableReset)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.RSTCON.B.BPRST33OFF = 1;
    pms->EVR.RSTCON.B.RST33OFF   = enableReset;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_evrcResetTriggerSignalConfig(Ifx_PMS *pms, boolean enableReset)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.RSTCON.B.BPRSTCOFF = 1;
    pms->EVR.RSTCON.B.RSTCOFF   = enableReset;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_fineTrimEvrClock(Ifx_PMS *pms, uint8 trimValue)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.OSCCTRL.B.OSCFTRIM = trimValue;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE float32 IfxPmsEvr_getAdcVddResult(Ifx_PMS *pms)
{
    ...
    vddVoltage = ((IFXPMSEVR_ADC_VDD_LSB * ((float32)pms->EVR.ADCSTAT.B.ADCCV)) + 0.7125);
    return vddVoltage;
}
...
IFX_INLINE float32 IfxPmsEvr_getAdcVddp3Result(Ifx_PMS *pms)
{
    ...
    vddp3Voltage = ((IFXPMSEVR_ADC_VDDP3_LSB * ((float32)pms->EVR.ADCSTAT.B.ADC33V)) + 0.9375);
    return vddp3Voltage;
}
...
IFX_INLINE float32 IfxPmsEvr_getAdcVextResult(Ifx_PMS *pms)
{
    ...
    vextVoltage = ((IFXPMSEVR_ADC_VEXT_LSB * ((float32)pms->EVR.ADCSTAT.B.ADCSWDV)) + 1.050);
    return vextVoltage;
}
...
IFX_INLINE IfxPmsEvr_EvrcMode IfxPmsEvr_getEvrcMode(Ifx_PMS *pms)
{
    return (IfxPmsEvr_EvrcMode)pms->EVR.STAT.B.EVRCMOD;
}


IFX_INLINE boolean IfxPmsEvr_getEvrcVoltageRegulator(Ifx_PMS *pms)
{
    return (boolean)pms->EVR.STAT.B.SDVOK;
}


IFX_INLINE uint8 IfxPmsEvr_getPrimaryAdcEvr33Result(Ifx_PMS *pms)
{
    return pms->EVR.ADCSTAT.B.ADC33V;
}


IFX_INLINE uint8 IfxPmsEvr_getPrimaryAdcEvrcResult(Ifx_PMS *pms)
{
    return pms->EVR.ADCSTAT.B.ADCCV;
}


IFX_INLINE uint8 IfxPmsEvr_getPrimaryAdcSwdResult(Ifx_PMS *pms)
{
    return pms->EVR.ADCSTAT.B.ADCSWDV;
}


IFX_INLINE boolean IfxPmsEvr_runInitSequence(const IfxPmsEvr_initSequence *const sequence)
{
    __moveToAddrParam0(sequence);
    extern const void *const IfxPmsEvr_runInitSequenceFunPtr;
    __jumpToFunction(IfxPmsEvr_runInitSequenceFunPtr);
    return (boolean)__getDataParamRet();
}
...
IFX_INLINE void IfxPmsEvr_setBandgapSignedTrimValue(Ifx_PMS *pms, sint8 trimValue)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.BGOCTRL.B.VBGPTRIM = trimValue;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setBandgapTrimValue(Ifx_PMS *pms, uint8 trimValue)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.BGOCTRL.B.VBGTRIM = trimValue;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setEvr33PrimaryAdcTrimValue(Ifx_PMS *pms, IfxPmsEvr_PrimaryAdcTrimValue trimValue)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.TRIM.B.EVR33VOUTTRIM = trimValue;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setEvr33VoltageOutputlevel(Ifx_PMS *pms, uint8 outputLevel)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.TRIM.B.EVR33VOUTSEL = outputLevel;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setFrequencySpreadThreshold(Ifx_PMS *pms, uint16 thresholdLevel)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVRSDCTRL.CTRL0.B.SDFREQSPRD = thresholdLevel;
    pms->EVRSDCTRL.CTRL0.B.UP         = 1;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setNmosLevel(Ifx_PMS *pms, boolean nmosLevel)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVRSDCTRL.CTRL0.B.NGOFF = nmosLevel;
    pms->EVRSDCTRL.CTRL0.B.UP    = 1;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
{
    uint16              passwd = IfxScuWdt_getSafetyWatchdogPassword();
    Ifx_PMS_EVR_MONCTRL tempMONCTRL;
    IfxScuWdt_clearSafetyEndinit(passwd);
    tempMONCTRL.U = pms->EVR.MONCTRL.U;
    ...
    pms->EVR.MONCTRL.U = tempMONCTRL.U;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setPmosLevel(Ifx_PMS *pms, boolean pmosLevel)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVRSDCTRL.CTRL0.B.PGOFF = pmosLevel;
    pms->EVRSDCTRL.CTRL0.B.UP    = 1;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setRegulatorSwitchingFrequency(Ifx_PMS *pms, uint16 samplingFactor)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVRSDCTRL.CTRL0.B.SDFREQ = samplingFactor;
    pms->EVRSDCTRL.CTRL0.B.UP     = 1;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setResetTrimValue(Ifx_PMS *pms, uint8 resetTrimValue, IfxPmsEvr_SupplyMode supply)
{
    ...
    Ifx_PMS_EVR_RSTCON tempRSTCON;
    IfxScuWdt_clearSafetyEndinit(passwd);
    tempRSTCON.U = pms->EVR.RSTCON.U;

    switch (supply)
    {
    case IfxPmsEvr_SupplyMode_evrc:
        tempRSTCON.B.RSTCTRIM = resetTrimValue;
        break;
    case IfxPmsEvr_SupplyMode_evr33:
        tempRSTCON.B.RST33TRIM = resetTrimValue;
        break;
    case IfxPmsEvr_SupplyMode_swd:
        tempRSTCON.B.RSTSWDTRIM = resetTrimValue;
        break;
    default:
        break;
    }

    pms->EVR.RSTCON.U = tempRSTCON.U;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setSdRegulatorOutputLevel(Ifx_PMS *pms, uint8 outputLevel)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.TRIM.B.SDVOUTSEL = outputLevel;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setSdRegulatorPrimaryAdcTrimValue(Ifx_PMS *pms, IfxPmsEvr_PrimaryAdcTrimValue trimValue)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.TRIM.B.SDVOUTTRIM = trimValue;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setStandbyRamSupply(Ifx_PMS *pms, uint8 ramBlock)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->PMSW.CR0.B.STBYRAMSEL = ramBlock;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_setSwitchingFreqDivFactorForExternalsync(Ifx_PMS *pms, IfxPmsEvr_ExtSyncSwitchingFreqDivFactor divider)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVRSDCTRL.CTRL7.B.SYNCDIVFAC = divider;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_signedFineTrimEvrClock(Ifx_PMS *pms, sint8 trimValue)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.OSCCTRL.B.OSCFPTRIM = trimValue;
    IfxScuWdt_setSafetyEndinit(passwd);
}
...
IFX_INLINE void IfxPmsEvr_swdResetTriggerSignalConfig(Ifx_PMS *pms, boolean enableReset)
{
    ...
    IfxScuWdt_clearSafetyEndinit(passwd);
    pms->EVR.RSTCON.B.BPRSTSWDOFF = 1;
    pms->EVR.RSTCON.B.RSTSWDOFF   = enableReset;
    IfxScuWdt_setSafetyEndinit(passwd);
}
