 ...
 *
 * \defgroup IfxLld_Asclin_Registers_BitfieldsMask Bitfields mask and offset
...
#define IFX_ASCLIN_IOCR_LB_MSK (0x0u)
...
#define IFX_ASCLIN_IOCR_CTSEN_MSK (0x0u)
...
#define IFX_ASCLIN_IOCR_RXM_MSK (0x0u)
...
#define IFX_ASCLIN_IOCR_TXM_MSK (0x0u)
...
#define IFX_ASCLIN_ID_MODREV_MSK (0x0u)
