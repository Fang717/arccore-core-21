 ...
 *
 * \defgroup IfxLld_Smu_Registers_BitfieldsMask Bitfields mask and offset
...
/** \brief Length for Ifx_SMU_STS_Bits.GFSCU_EN */
#define IFX_SMU_STS_GFSCU_EN_LEN (1u)

/** \brief Mask for Ifx_SMU_STS_Bits.GFSCU_EN */
#define IFX_SMU_STS_GFSCU_EN_MSK (0x1u)

/** \brief Offset for Ifx_SMU_STS_Bits.GFSCU_EN */
#define IFX_SMU_STS_GFSCU_EN_OFF (30u)

/** \brief Length for Ifx_SMU_STS_Bits.GFSTS_EN */
#define IFX_SMU_STS_GFSTS_EN_LEN (1u)

/** \brief Mask for Ifx_SMU_STS_Bits.GFSTS_EN */
#define IFX_SMU_STS_GFSTS_EN_MSK (0x1u)

/** \brief Offset for Ifx_SMU_STS_Bits.GFSTS_EN */
#define IFX_SMU_STS_GFSTS_EN_OFF (31u)
...
#define IFX_SMU_PCTL_PCFG_LEN (18u)

/** \brief Mask for Ifx_SMU_PCTL_Bits.PCFG */
#define IFX_SMU_PCTL_PCFG_MSK (0x3ffffu)

/** \brief Offset for Ifx_SMU_PCTL_Bits.PCFG */
#define IFX_SMU_PCTL_PCFG_OFF (14u)
...
/** \brief Length for Ifx_SMU_RTAC_RTAC0_Bits.GID0 */
#define IFX_SMU_RTAC_RTAC0_GID0_LEN (4u)

/** \brief Mask for Ifx_SMU_RTAC_RTAC0_Bits.GID0 */
#define IFX_SMU_RTAC_RTAC0_GID0_MSK (0xfu)

/** \brief Offset for Ifx_SMU_RTAC_RTAC0_Bits.GID0 */
#define IFX_SMU_RTAC_RTAC0_GID0_OFF (0u)

/** \brief Length for Ifx_SMU_RTAC_RTAC0_Bits.ALID0 */
#define IFX_SMU_RTAC_RTAC0_ALID0_LEN (5u)

/** \brief Mask for Ifx_SMU_RTAC_RTAC0_Bits.ALID0 */
#define IFX_SMU_RTAC_RTAC0_ALID0_MSK (0x1fu)

/** \brief Offset for Ifx_SMU_RTAC_RTAC0_Bits.ALID0 */
#define IFX_SMU_RTAC_RTAC0_ALID0_OFF (4u)

/** \brief Length for Ifx_SMU_RTAC_RTAC0_Bits.GID1 */
#define IFX_SMU_RTAC_RTAC0_GID1_LEN (4u)

/** \brief Mask for Ifx_SMU_RTAC_RTAC0_Bits.GID1 */
#define IFX_SMU_RTAC_RTAC0_GID1_MSK (0xfu)

/** \brief Offset for Ifx_SMU_RTAC_RTAC0_Bits.GID1 */
#define IFX_SMU_RTAC_RTAC0_GID1_OFF (16u)

/** \brief Length for Ifx_SMU_RTAC_RTAC0_Bits.ALID1 */
#define IFX_SMU_RTAC_RTAC0_ALID1_LEN (5u)

/** \brief Mask for Ifx_SMU_RTAC_RTAC0_Bits.ALID1 */
#define IFX_SMU_RTAC_RTAC0_ALID1_MSK (0x1fu)

/** \brief Offset for Ifx_SMU_RTAC_RTAC0_Bits.ALID1 */
#define IFX_SMU_RTAC_RTAC0_ALID1_OFF (20u)

/** \brief Length for Ifx_SMU_RTAC_RTAC1_Bits.GID2 */
#define IFX_SMU_RTAC_RTAC1_GID2_LEN (4u)

/** \brief Mask for Ifx_SMU_RTAC_RTAC1_Bits.GID2 */
#define IFX_SMU_RTAC_RTAC1_GID2_MSK (0xfu)

/** \brief Offset for Ifx_SMU_RTAC_RTAC1_Bits.GID2 */
#define IFX_SMU_RTAC_RTAC1_GID2_OFF (0u)

/** \brief Length for Ifx_SMU_RTAC_RTAC1_Bits.ALID2 */
#define IFX_SMU_RTAC_RTAC1_ALID2_LEN (5u)

/** \brief Mask for Ifx_SMU_RTAC_RTAC1_Bits.ALID2 */
#define IFX_SMU_RTAC_RTAC1_ALID2_MSK (0x1fu)

/** \brief Offset for Ifx_SMU_RTAC_RTAC1_Bits.ALID2 */
#define IFX_SMU_RTAC_RTAC1_ALID2_OFF (4u)

/** \brief Length for Ifx_SMU_RTAC_RTAC1_Bits.GID3 */
#define IFX_SMU_RTAC_RTAC1_GID3_LEN (4u)

/** \brief Mask for Ifx_SMU_RTAC_RTAC1_Bits.GID3 */
#define IFX_SMU_RTAC_RTAC1_GID3_MSK (0xfu)

/** \brief Offset for Ifx_SMU_RTAC_RTAC1_Bits.GID3 */
#define IFX_SMU_RTAC_RTAC1_GID3_OFF (16u)

/** \brief Length for Ifx_SMU_RTAC_RTAC1_Bits.ALID3 */
#define IFX_SMU_RTAC_RTAC1_ALID3_LEN (5u)

/** \brief Mask for Ifx_SMU_RTAC_RTAC1_Bits.ALID3 */
#define IFX_SMU_RTAC_RTAC1_ALID3_MSK (0x1fu)

/** \brief Offset for Ifx_SMU_RTAC_RTAC1_Bits.ALID3 */
#define IFX_SMU_RTAC_RTAC1_ALID3_OFF (20u)
...
/** \brief Length for Ifx_SMU_AEX_Bits.RSTSTS */
#define IFX_SMU_AEX_RSTSTS_LEN (1u)

/** \brief Mask for Ifx_SMU_AEX_Bits.RSTSTS */
#define IFX_SMU_AEX_RSTSTS_MSK (0x1u)

/** \brief Offset for Ifx_SMU_AEX_Bits.RSTSTS */
#define IFX_SMU_AEX_RSTSTS_OFF (10u)
...
/** \brief Length for Ifx_SMU_AEX_Bits.RSTAEM */
#define IFX_SMU_AEX_RSTAEM_LEN (1u)

/** \brief Mask for Ifx_SMU_AEX_Bits.RSTAEM */
#define IFX_SMU_AEX_RSTAEM_MSK (0x1u)

/** \brief Offset for Ifx_SMU_AEX_Bits.RSTAEM */
#define IFX_SMU_AEX_RSTAEM_OFF (26u)
...
/** \brief Length for Ifx_SMU_AEXCLR_Bits.RSTCLR */
#define IFX_SMU_AEXCLR_RSTCLR_LEN (1u)

/** \brief Mask for Ifx_SMU_AEXCLR_Bits.RSTCLR */
#define IFX_SMU_AEXCLR_RSTCLR_MSK (0x1u)

/** \brief Offset for Ifx_SMU_AEXCLR_Bits.RSTCLR */
#define IFX_SMU_AEXCLR_RSTCLR_OFF (10u)
...
/** \brief Length for Ifx_SMU_AEXCLR_Bits.RSTAEMCLR */
#define IFX_SMU_AEXCLR_RSTAEMCLR_LEN (1u)

/** \brief Mask for Ifx_SMU_AEXCLR_Bits.RSTAEMCLR */
#define IFX_SMU_AEXCLR_RSTAEMCLR_MSK (0x1u)

/** \brief Offset for Ifx_SMU_AEXCLR_Bits.RSTAEMCLR */
#define IFX_SMU_AEXCLR_RSTAEMCLR_OFF (26u)
