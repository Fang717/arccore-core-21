 ...
 *
 * \defgroup IfxLld_Asclin_Registers AsclinRegisters
 * \ingroup IfxLld
 * 
 * \defgroup IfxLld_Asclin_Registers_Bitfields Bitfields
 * \ingroup IfxLld_Asclin_Registers
 * 
 * \defgroup IfxLld_Asclin_Registers_union Register unions
 * \ingroup IfxLld_Asclin_Registers
 * 
 * \defgroup IfxLld_Asclin_Registers_struct Memory map
 * \ingroup IfxLld_Asclin_Registers
 */
...
typedef struct _Ifx_ASCLIN_FLAGSENABLE_Bits
{
    ...
    Ifx_UReg_32Bit ABE:1;             /**< \brief [23:23] Flag Enable Bit - ABE (rw) */
...
/******************************************************************************/
/******************************************************************************/
/** \addtogroup IfxLld_Asclin_LIN_struct
 * \{  */
/******************************************************************************/
/** \name Object L1
 * \{  */
