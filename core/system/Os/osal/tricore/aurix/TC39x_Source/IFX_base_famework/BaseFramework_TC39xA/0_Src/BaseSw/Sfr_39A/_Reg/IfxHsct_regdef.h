 ...
 *
 * \defgroup IfxLld_Hsct_Registers HsctRegisters
 * \ingroup IfxLld
 * 
 * \defgroup IfxLld_Hsct_Registers_Bitfields Bitfields
 * \ingroup IfxLld_Hsct_Registers
 * 
 * \defgroup IfxLld_Hsct_Registers_union Register unions
 * \ingroup IfxLld_Hsct_Registers
 * 
 * \defgroup IfxLld_Hsct_Registers_struct Memory map
 * \ingroup IfxLld_Hsct_Registers
 */
...
/** \brief Test Monitor Register */
typedef struct _Ifx_HSCT_TESTMON_Bits
{
    Ifx_UReg_32Bit TRXCORS0:2;        /**< \brief [1:0] TEST Receive path correlator 0 status - TRXCORS0 (rh) */
    Ifx_UReg_32Bit TRXCORS1:2;        /**< \brief [3:2] TEST Receive path correlator 1status - TRXCORS1 (rh) */
    Ifx_UReg_32Bit TRXCORS2:2;        /**< \brief [5:4] TEST Receive path correlator 2 status - TRXCORS2 (rh) */
    Ifx_UReg_32Bit TRXCORS3:2;        /**< \brief [7:6] TEST Receive path correlator 3 status - TRXCORS3 (rh) */
    Ifx_UReg_32Bit TRXCORS4:2;        /**< \brief [9:8] TEST Receive path correlator 4 status - TRXCORS4 (rh) */
    Ifx_UReg_32Bit TRXSYNC:1;         /**< \brief [10:10] TEST RX Synchronization Pattern detected - TRXSYNC (rh) */
    Ifx_UReg_32Bit TTXFL:1;           /**< \brief [11:11] TEST TX Frame Last - TTXFL (rh) */
    Ifx_UReg_32Bit LDBGSP:3;          /**< \brief [14:12] HSCT PHY Debug - shows the selected phase for sampling the RX LVDS bit stream. - LDBGSP (rh) */
    Ifx_UReg_32Bit LDBGCOROT:1;       /**< \brief [15:15] HSCT PHY Debug - Correlator toggle bit on a data change. - LDBGCOROT (rh) */
    Ifx_UReg_32Bit LDBGSPT:1;         /**< \brief [16:16] HSCT PHY Debug - this bit is toggled, whenever the phase is selected by the correlator. - LDBGSPT (rh) */
    Ifx_UReg_32Bit LDBGRXSLS:1;       /**< \brief [17:17] LVDS PHY Debug - Indicates, if the LVDS receiver is in sleep- or in running state. - LDBGRXSLS (rh) */
    Ifx_UReg_32Bit LDBGCORO:5;        /**< \brief [22:18] HSCT PHY Test monitor signal shows eye opening of the correlator and matching phases. - LDBGCORO (rh) */
    Ifx_UReg_32Bit HSCTMON:9;         /**< \brief [31:23] HSCT monitor signals. (check signal description) - HSCTMON (rh) */
} Ifx_HSCT_TESTMON_Bits;
...
typedef union
{
    Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_HSCT_TESTMON_Bits B;          /**< \brief Bitfield access */
} Ifx_HSCT_TESTMON;
...
typedef volatile struct _Ifx_HSCT
{
       ...
       Ifx_HSCT_TESTMON                    TESTMON;                /**< \brief 64, Test Monitor Register*/
       Ifx_UReg_8Bit                       reserved_68[65408];     /**< \brief 68, \internal Reserved */
