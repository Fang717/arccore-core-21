 ...
 *
 * \defgroup IfxLld_Psi5s_Registers_Cfg Psi5s address
 * \ingroup IfxLld_Psi5s_Registers
 * 
 * \defgroup IfxLld_Psi5s_Registers_Cfg_BaseAddress Base address
 * \ingroup IfxLld_Psi5s_Registers_Cfg
 *
 * \defgroup IfxLld_Psi5s_Registers_Cfg_Psi5s 2-PSI5S
 * \ingroup IfxLld_Psi5s_Registers_Cfg
 *
 *
 */
