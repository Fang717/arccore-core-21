 ...
 *
 * \defgroup IfxLld_Gpt12_Registers Gpt12Registers
 * \ingroup IfxLld
 * 
 * \defgroup IfxLld_Gpt12_Registers_Bitfields Bitfields
 * \ingroup IfxLld_Gpt12_Registers
 * 
 * \defgroup IfxLld_Gpt12_Registers_union Register unions
 * \ingroup IfxLld_Gpt12_Registers
 * 
 * \defgroup IfxLld_Gpt12_Registers_struct Memory map
 * \ingroup IfxLld_Gpt12_Registers
 */
