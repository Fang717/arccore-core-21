...
{
    unsigned int PDL0:5;                    /**< \brief [4:0] Pa0load Data Length (rw) */
    unsigned int PDL1:5;                    /**< \brief [9:5] Pa1load Data Length (rw) */
    unsigned int PDL2:5;                    /**< \brief [14:10] Pa2load Data Length (rw) */
    unsigned int PDL3:5;                    /**< \brief [19:15] Pa3load Data Length (rw) */
    unsigned int PDL4:5;                    /**< \brief [24:20] Pa4load Data Length (rw) */
    unsigned int PDL5:5;                    /**< \brief [29:25] Pa5load Data Length (rw) */
...
typedef struct _Ifx_PSI5_CH_RCRB_Bits
{
    ...
    unsigned int CRC0:1;                    /**< \brief [1:1] CRC or Parit0 Selection (rw) */
    ...
    unsigned int CRC1:1;                    /**< \brief [5:5] CRC or Parit1 Selection (rw) */
    ...
    unsigned int CRC2:1;                    /**< \brief [9:9] CRC or Parit2 Selection (rw) */
    ...
    unsigned int CRC3:1;                    /**< \brief [13:13] CRC or Parit3 Selection (rw) */
    ...
    unsigned int CRC4:1;                    /**< \brief [17:17] CRC or Parit4 Selection (rw) */
    ...
    unsigned int CRC5:1;                    /**< \brief [21:21] CRC or Parit5 Selection (rw) */
...
{
    unsigned int BRS:1;                     /**< \brief [0:0] Bit Rate Select (rw) */
...
/** \brief  Start of Frame Time Stamp Capture Register */
...
/** \brief  Start of Pulse Time Stamp Capture Register */
...
typedef struct _Ifx_PSI5_GCR_Bits
{
    ...
    unsigned int ETC0:1;                    /**< \brief [8:8] Enable Channel Trigger Counter CTV0.CTC (rw) */
    unsigned int ETC1:1;                    /**< \brief [9:9] Enable Channel Trigger Counter CTV1.CTC (rw) */
    unsigned int ETC2:1;                    /**< \brief [10:10] Enable Channel Trigger Counter CTV2.CTC (rw) */
    unsigned int ETC3:1;                    /**< \brief [11:11] Enable Channel Trigger Counter CTV3.CTC (rw) */
    unsigned int ETC4:1;                    /**< \brief [12:12] Enable Channel Trigger Counter CTV4.CTC (rw) */
...
typedef struct _Ifx_PSI5_ID_Bits
{
    ...
    unsigned int MODNUM:16;                 /**< \brief [31:16] Module Number Value (r) */
} Ifx_PSI5_ID_Bits;
...
/** \brief  Interrupt Enable Register B0 */
...
/** \brief  Receive Data Memor0 High 0y */
...
/** \brief  Receive Data Memor0 Low 0y */
...
typedef volatile struct _Ifx_PSI5_CH
{
    ...
    Ifx_PSI5_CH_SPTSC SPTSC;                /**< \brief 48, Start of Pulse Time Stamp Capture Register  */
    Ifx_PSI5_CH_SFTSC SFTSC;                /**< \brief 4C, Start of Frame Time Stamp Capture Register  */
...
{
    Ifx_PSI5_RDM_L L;                       /**< \brief 0, Receive Data Memor0 Low 0y */
    Ifx_PSI5_RDM_H H;                       /**< \brief 4, Receive Data Memor0 High 0y */
} Ifx_PSI5_RDM;
/** \}  */
/******************************************************************************/
/** \}  */
...
typedef volatile struct _Ifx_PSI5
{
    ...
    Ifx_PSI5_TSR TSRA;                      /**< \brief 1C, Module Time Stamp Register A */
    Ifx_PSI5_TSR TSRB;                      /**< \brief 20, Time Stamp Register B */
    Ifx_PSI5_TSR TSRC;                      /**< \brief 24, Module Time Stamp Register C */
    unsigned char reserved_28[4];           /**< \brief 28, \internal Reserved */
    Ifx_PSI5_GCR GCR;                       /**< \brief 2C, Global Control Register */
    Ifx_PSI5_CH CH[4];                      /**< \brief 30, Protection range */
    unsigned char reserved_270[136];        /**< \brief 270, \internal Reserved */
    Ifx_PSI5_INTOV INTOV;                   /**< \brief 2F8, Interrupt Overview Register */
    Ifx_PSI5_INP INP[4];                    /**< \brief 2FC, Interrupt Node Pointer Register */
    unsigned char reserved_30C[4];          /**< \brief 30C, \internal Reserved */
    Ifx_PSI5_INTSTATA INTSTATA[4];          /**< \brief 310, Interrupt Status Register A */
    unsigned char reserved_320[4];          /**< \brief 320, \internal Reserved */
    Ifx_PSI5_INTSTATB INTSTATB[4];          /**< \brief 324, Interrupt Status Register B */
    unsigned char reserved_334[4];          /**< \brief 334, \internal Reserved */
    Ifx_PSI5_INTSETA INTSETA[4];            /**< \brief 338, Interrupt Set Register A */
    unsigned char reserved_348[4];          /**< \brief 348, \internal Reserved */
    Ifx_PSI5_INTSETB INTSETB[4];            /**< \brief 34C, Interrupt Set Register B */
    unsigned char reserved_35C[4];          /**< \brief 35C, \internal Reserved */
    Ifx_PSI5_INTCLRA INTCLRA[4];            /**< \brief 360, Interrupt Clear Register A */
    unsigned char reserved_370[4];          /**< \brief 370, \internal Reserved */
    Ifx_PSI5_INTCLRB INTCLRB[4];            /**< \brief 374, Interrupt Clear Register A */
    unsigned char reserved_384[4];          /**< \brief 384, \internal Reserved */
    Ifx_PSI5_INTENA INTENA[4];              /**< \brief 388, Interrupt Enable Register A */
    unsigned char reserved_398[4];          /**< \brief 398, \internal Reserved */
    Ifx_PSI5_INTENB INTENB[4];              /**< \brief 39C, Interrupt Enable Register B0 */
    unsigned char reserved_3AC[32];         /**< \brief 3AC, \internal Reserved */
    ...
    Ifx_PSI5_RFC RFC[4];                    /**< \brief 3E4, Receive FIFO Control Register */
    unsigned char reserved_3F4[4];          /**< \brief 3F4, \internal Reserved */
    Ifx_PSI5_RDF RDF[4];                    /**< \brief 3F8, Receive Data FIFO */
    unsigned char reserved_408[4];          /**< \brief 408, \internal Reserved */
    Ifx_PSI5_RSIOV RSIOV[4];                /**< \brief 40C, RSI Overview Register */
    unsigned char reserved_41C[4];          /**< \brief 41C, \internal Reserved */
    Ifx_PSI5_RMIOV RMIOV[4];                /**< \brief 420, RMI Overview Register */
    unsigned char reserved_430[4];          /**< \brief 430, \internal Reserved */
    Ifx_PSI5_NBIOV NBIOV[4];                /**< \brief 434, NBI Overview Register */
    unsigned char reserved_444[4];          /**< \brief 444, \internal Reserved */
    Ifx_PSI5_TEIOV TEIOV[4];                /**< \brief 448, TEI Overview Register */
    unsigned char reserved_458[4];          /**< \brief 458, \internal Reserved */
    Ifx_PSI5_CRCIOV CRCIOV[4];              /**< \brief 45C, CRCI Overview Register */
    unsigned char reserved_46C[4];          /**< \brief 46C, \internal Reserved */
    Ifx_PSI5_RDIOV RDIOV[4];                /**< \brief 470, RDI Overview Register */
    unsigned char reserved_480[4];          /**< \brief 480, \internal Reserved */
    Ifx_PSI5_NFIOV NFIOV[4];                /**< \brief 484, NFI Overview Register */
    unsigned char reserved_494[4];          /**< \brief 494, \internal Reserved */
    Ifx_PSI5_MEIOV MEIOV[4];                /**< \brief 498, MEI Overview Register */
    unsigned char reserved_4A8[4];          /**< \brief 4A8, \internal Reserved */
    Ifx_PSI5_RSISET RSISET[4];              /**< \brief 4AC, RSI Overview Set Register 0 */
    unsigned char reserved_4BC[4];          /**< \brief 4BC, \internal Reserved */
    Ifx_PSI5_RMISET RMISET[4];              /**< \brief 4C0, RMI Overview Set Register 0 */
    unsigned char reserved_4D0[4];          /**< \brief 4D0, \internal Reserved */
    Ifx_PSI5_NBISET NBISET[4];              /**< \brief 4D4, NBI Overview Set Register 0 */
    unsigned char reserved_4E4[4];          /**< \brief 4E4, \internal Reserved */
    Ifx_PSI5_TEISET TEISET[4];              /**< \brief 4E8, TEI Overview Set Register 0 */
    unsigned char reserved_4F8[4];          /**< \brief 4F8, \internal Reserved */
    Ifx_PSI5_CRCISET CRCISET[4];            /**< \brief 4FC, CRCI Overview Set Register 0 */
    unsigned char reserved_50C[4];          /**< \brief 50C, \internal Reserved */
    Ifx_PSI5_RDISET RDISET[4];              /**< \brief 510, RDI Overview Set Register 0 */
    unsigned char reserved_520[4];          /**< \brief 520, \internal Reserved */
    Ifx_PSI5_NFISET NFISET[4];              /**< \brief 524, NFI Overview Set Register 0 */
    unsigned char reserved_534[4];          /**< \brief 534, \internal Reserved */
    Ifx_PSI5_MEISET MEISET[4];              /**< \brief 538, MEI Overview Set Register 0 */
    unsigned char reserved_548[4];          /**< \brief 548, \internal Reserved */
    Ifx_PSI5_RSICLR RSICLR[4];              /**< \brief 54C, RSI Overview Clear Register 0 */
    unsigned char reserved_55C[4];          /**< \brief 55C, \internal Reserved */
    Ifx_PSI5_RMICLR RMICLR[4];              /**< \brief 560, RMI Overview Clear Register 0 */
    unsigned char reserved_570[4];          /**< \brief 570, \internal Reserved */
    Ifx_PSI5_NBICLR NBICLR[4];              /**< \brief 574, NBI Overview Clear Register 0 */
    unsigned char reserved_584[4];          /**< \brief 584, \internal Reserved */
    Ifx_PSI5_TEICLR TEICLR[4];              /**< \brief 588, TEI Overview Clear Register 0 */
    unsigned char reserved_598[4];          /**< \brief 598, \internal Reserved */
    Ifx_PSI5_CRCICLR CRCICLR[4];            /**< \brief 59C, CRCI Overview Clear Register 0 */
    unsigned char reserved_5AC[4];          /**< \brief 5AC, \internal Reserved */
    Ifx_PSI5_RDICLR RDICLR[4];              /**< \brief 5B0, RDI Overview Clear Register 0 */
    unsigned char reserved_5C0[4];          /**< \brief 5C0, \internal Reserved */
    Ifx_PSI5_NFICLR NFICLR[4];              /**< \brief 5C4, NFI Overview Clear Register 0 */
    unsigned char reserved_5D4[4];          /**< \brief 5D4, \internal Reserved */
    Ifx_PSI5_MEICLR MEICLR[4];              /**< \brief 5D8, MEI Overview Clear Register 0 */
    unsigned char reserved_5E8[24];         /**< \brief 5E8, \internal Reserved */
    Ifx_PSI5_RDM RDM[4][32];                /**< \brief 600, Receive data memory */
    unsigned char reserved_A00[256];        /**< \brief A00, \internal Reserved */
} Ifx_PSI5;
/** \}  */
/******************************************************************************/
/** \}  */
