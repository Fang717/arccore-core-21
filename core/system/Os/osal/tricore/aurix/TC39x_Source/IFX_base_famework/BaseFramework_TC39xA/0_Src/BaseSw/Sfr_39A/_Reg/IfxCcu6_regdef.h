 ...
 *
 * \defgroup IfxLld_Ccu6_Registers Ccu6Registers
 * \ingroup IfxLld
 * 
 * \defgroup IfxLld_Ccu6_Registers_Bitfields Bitfields
 * \ingroup IfxLld_Ccu6_Registers
 * 
 * \defgroup IfxLld_Ccu6_Registers_union Register unions
 * \ingroup IfxLld_Ccu6_Registers
 * 
 * \defgroup IfxLld_Ccu6_Registers_struct Memory map
 * \ingroup IfxLld_Ccu6_Registers
 */
...
{
    Ifx_UReg_32Bit MCC6S0:1;          /**< \brief [0:0] Capture/Compare Status Modification Bits MCC6${x}S (x = 0, 1, 2) - MCC6${x}S (w) */
    Ifx_UReg_32Bit MCC6S1:1;          /**< \brief [1:1] Capture/Compare Status Modification Bits MCC6${x}S (x = 0, 1, 2) - MCC6${x}S (w) */
    Ifx_UReg_32Bit MCC6S2:1;          /**< \brief [2:2] Capture/Compare Status Modification Bits MCC6${x}S (x = 0, 1, 2) - MCC6${x}S (w) */
    ...
    Ifx_UReg_32Bit MCC6R0:1;          /**< \brief [8:8] Capture/Compare Status Modification Bits MCC6${x}R (x = 0, 1, 2) - MCC6${x}R (w) */
    Ifx_UReg_32Bit MCC6R1:1;          /**< \brief [9:9] Capture/Compare Status Modification Bits MCC6${x}R (x = 0, 1, 2) - MCC6${x}R (w) */
    Ifx_UReg_32Bit MCC6R2:1;          /**< \brief [10:10] Capture/Compare Status Modification Bits MCC6${x}R (x = 0, 1, 2) - MCC6${x}R (w) */
...
{
    Ifx_UReg_32Bit CC6ST0:1;          /**< \brief [0:0] Capture/Compare State Bits for CC6${x} (x = 0, 1, 2) - CC6${x}ST (rh) */
    Ifx_UReg_32Bit CC6ST1:1;          /**< \brief [1:1] Capture/Compare State Bits for CC6${x} (x = 0, 1, 2) - CC6${x}ST (rh) */
    Ifx_UReg_32Bit CC6ST2:1;          /**< \brief [2:2] Capture/Compare State Bits for CC6${x} (x = 0, 1, 2) - CC6${x}ST (rh) */
    Ifx_UReg_32Bit CCPOS60:1;         /**< \brief [3:3] Sampled Hall Pattern Bits - CCPOS6${x} (rh) */
    Ifx_UReg_32Bit CCPOS61:1;         /**< \brief [4:4] Sampled Hall Pattern Bits - CCPOS6${x} (rh) */
    Ifx_UReg_32Bit CCPOS62:1;         /**< \brief [5:5] Sampled Hall Pattern Bits - CCPOS6${x} (rh) */
    Ifx_UReg_32Bit CC63ST:1;          /**< \brief [6:6] Capture/Compare State Bit for CC63 - CC63ST (rh) */
    Ifx_UReg_32Bit reserved_7:1;      /**< \brief [7:7] \internal Reserved */
    Ifx_UReg_32Bit CC6PS0:1;          /**< \brief [8:8] Passive State Select for Compare Outputs CC6${x} (x = 0, 1, 2) - CC6${x}PS (rwh) */
    Ifx_UReg_32Bit COUT6PS0:1;        /**< \brief [9:9] Passive State Select for Compare Outputs COUT6${x} (x = 0, 1, 2) - COUT6${x}PS (rwh) */
    Ifx_UReg_32Bit CC6PS1:1;          /**< \brief [10:10] Passive State Select for Compare Outputs CC6${x} (x = 0, 1, 2) - CC6${x}PS (rwh) */
    Ifx_UReg_32Bit COUT6PS1:1;        /**< \brief [11:11] Passive State Select for Compare Outputs COUT6${x} (x = 0, 1, 2) - COUT6${x}PS (rwh) */
    Ifx_UReg_32Bit CC6PS2:1;          /**< \brief [12:12] Passive State Select for Compare Outputs CC6${x} (x = 0, 1, 2) - CC6${x}PS (rwh) */
    Ifx_UReg_32Bit COUT6PS2:1;        /**< \brief [13:13] Passive State Select for Compare Outputs COUT6${x} (x = 0, 1, 2) - COUT6${x}PS (rwh) */
...
{
    Ifx_UReg_32Bit ENCC60R:1;         /**< \brief [0:0] Capture, Compare-Match Rising Edge Interrupt Enable for Channel CC6x - ENCC60R,ENCC61R,ENCC62R (rw) */
    Ifx_UReg_32Bit ENCC60F:1;         /**< \brief [1:1] Capture, Compare-Match Falling Edge Interrupt Enable for Channel CC6x - ENCC60F,ENCC61F,ENCC62F (rw) */
    Ifx_UReg_32Bit ENCC61R:1;         /**< \brief [2:2] Capture, Compare-Match Rising Edge Interrupt Enable for Channel CC6x - ENCC60R,ENCC61R,ENCC62R (rw) */
    Ifx_UReg_32Bit ENCC61F:1;         /**< \brief [3:3] Capture, Compare-Match Falling Edge Interrupt Enable for Channel CC6x - ENCC60F,ENCC61F,ENCC62F (rw) */
    Ifx_UReg_32Bit ENCC62R:1;         /**< \brief [4:4] Capture, Compare-Match Rising Edge Interrupt Enable for Channel CC6x - ENCC60R,ENCC61R,ENCC62R (rw) */
    Ifx_UReg_32Bit ENCC62F:1;         /**< \brief [5:5] Capture, Compare-Match Falling Edge Interrupt Enable for Channel CC6x - ENCC60F,ENCC61F,ENCC62F (rw) */
...
typedef struct _Ifx_CCU6_IMON_Bits
{
    ...
    Ifx_UReg_32Bit CCPOSI0:1;         /**< \brief [1:1] Event indication for input signal CCPOS${x} - CCPOS${x}I (rwh) */
    Ifx_UReg_32Bit CCPOSI1:1;         /**< \brief [2:2] Event indication for input signal CCPOS${x} - CCPOS${x}I (rwh) */
    Ifx_UReg_32Bit CCPOSI2:1;         /**< \brief [3:3] Event indication for input signal CCPOS${x} - CCPOS${x}I (rwh) */
    Ifx_UReg_32Bit CC6INI0:1;         /**< \brief [4:4] Event indication for input signal CC6${x}IN - CC6${x}INI (rwh) */
    Ifx_UReg_32Bit CC6INI1:1;         /**< \brief [5:5] Event indication for input signal CC6${x}IN - CC6${x}INI (rwh) */
    Ifx_UReg_32Bit CC6INI2:1;         /**< \brief [6:6] Event indication for input signal CC6${x}IN - CC6${x}INI (rwh) */
...
{
    Ifx_UReg_32Bit INPCC60:2;         /**< \brief [1:0] Interrupt Node Pointer for Channel CC6x Interrupts - INPCC60,INPCC61,INPCC62 (rw) */
    Ifx_UReg_32Bit INPCC61:2;         /**< \brief [3:2] Interrupt Node Pointer for Channel CC6x Interrupts - INPCC60,INPCC61,INPCC62 (rw) */
    Ifx_UReg_32Bit INPCC62:2;         /**< \brief [5:4] Interrupt Node Pointer for Channel CC6x Interrupts - INPCC60,INPCC61,INPCC62 (rw) */
...
{
    Ifx_UReg_32Bit ICC60R:1;          /**< \brief [0:0] Capture, Compare-Match Rising Edge Flag - ICC60R,ICC61R,ICC62R (rh) */
    Ifx_UReg_32Bit ICC60F:1;          /**< \brief [1:1] Capture, Compare-Match Falling Edge Flag - ICC60F,ICC61F,ICC62F (rh) */
    Ifx_UReg_32Bit ICC61R:1;          /**< \brief [2:2] Capture, Compare-Match Rising Edge Flag - ICC60R,ICC61R,ICC62R (rh) */
    Ifx_UReg_32Bit ICC61F:1;          /**< \brief [3:3] Capture, Compare-Match Falling Edge Flag - ICC60F,ICC61F,ICC62F (rh) */
    Ifx_UReg_32Bit ICC62R:1;          /**< \brief [4:4] Capture, Compare-Match Rising Edge Flag - ICC60R,ICC61R,ICC62R (rh) */
    Ifx_UReg_32Bit ICC62F:1;          /**< \brief [5:5] Capture, Compare-Match Falling Edge Flag - ICC60F,ICC61F,ICC62F (rh) */
...
{
    Ifx_UReg_32Bit RCC60R:1;          /**< \brief [0:0] Reset Capture, Compare-Match Rising Edge Flag - RCC60R,RCC61R,RCC62R (w) */
    Ifx_UReg_32Bit RCC60F:1;          /**< \brief [1:1] Reset Capture, Compare-Match Falling Edge Flag - RCC60F,RCC61F,RCC62F (w) */
    Ifx_UReg_32Bit RCC61R:1;          /**< \brief [2:2] Reset Capture, Compare-Match Rising Edge Flag - RCC60R,RCC61R,RCC62R (w) */
    Ifx_UReg_32Bit RCC61F:1;          /**< \brief [3:3] Reset Capture, Compare-Match Falling Edge Flag - RCC60F,RCC61F,RCC62F (w) */
    Ifx_UReg_32Bit RCC62R:1;          /**< \brief [4:4] Reset Capture, Compare-Match Rising Edge Flag - RCC60R,RCC61R,RCC62R (w) */
    Ifx_UReg_32Bit RCC62F:1;          /**< \brief [5:5] Reset Capture, Compare-Match Falling Edge Flag - RCC60F,RCC61F,RCC62F (w) */
...
{
    Ifx_UReg_32Bit SCC60R:1;          /**< \brief [0:0] Set Capture, Compare-Match Rising Edge Flag - SCC60R,SCC61R,SCC62R (w) */
    Ifx_UReg_32Bit SCC60F:1;          /**< \brief [1:1] Set Capture, Compare-Match Falling Edge Flag - SCC60F,SCC61F,SCC62F (w) */
    Ifx_UReg_32Bit SCC61R:1;          /**< \brief [2:2] Set Capture, Compare-Match Rising Edge Flag - SCC60R,SCC61R,SCC62R (w) */
    Ifx_UReg_32Bit SCC61F:1;          /**< \brief [3:3] Set Capture, Compare-Match Falling Edge Flag - SCC60F,SCC61F,SCC62F (w) */
    Ifx_UReg_32Bit SCC62R:1;          /**< \brief [4:4] Set Capture, Compare-Match Rising Edge Flag - SCC60R,SCC61R,SCC62R (w) */
    Ifx_UReg_32Bit SCC62F:1;          /**< \brief [5:5] Set Capture, Compare-Match Falling Edge Flag - SCC60F,SCC61F,SCC62F (w) */
...
{
    Ifx_UReg_32Bit SB0:1;             /**< \brief [0:0] Sensitivity Block x - SB0,SB1,SB2,SB3 (rw) */
    Ifx_UReg_32Bit SB1:1;             /**< \brief [1:1] Sensitivity Block x - SB0,SB1,SB2,SB3 (rw) */
    Ifx_UReg_32Bit SB2:1;             /**< \brief [2:2] Sensitivity Block x - SB0,SB1,SB2,SB3 (rw) */
    Ifx_UReg_32Bit SB3:1;             /**< \brief [3:3] Sensitivity Block x - SB0,SB1,SB2,SB3 (rw) */
...
typedef struct _Ifx_CCU6_LI_Bits
{
    ...
    Ifx_UReg_32Bit CCPOSEN0:1;        /**< \brief [1:1] Lost Indicator Enable for input signal CCPOS${x} - CCPOS${x}EN (rw) */
    Ifx_UReg_32Bit CCPOSEN1:1;        /**< \brief [2:2] Lost Indicator Enable for input signal CCPOS${x} - CCPOS${x}EN (rw) */
    Ifx_UReg_32Bit CCPOSEN2:1;        /**< \brief [3:3] Lost Indicator Enable for input signal CCPOS${x} - CCPOS${x}EN (rw) */
    Ifx_UReg_32Bit CC6INEN0:1;        /**< \brief [4:4] Lost Indicator Enable for input signal CC6${x}IN - CC6${x}INEN (rw) */
    Ifx_UReg_32Bit CC6INEN1:1;        /**< \brief [5:5] Lost Indicator Enable for input signal CC6${x}IN - CC6${x}INEN (rw) */
    Ifx_UReg_32Bit CC6INEN2:1;        /**< \brief [6:6] Lost Indicator Enable for input signal CC6${x}IN - CC6${x}INEN (rw) */
...
{
    Ifx_UReg_32Bit T12:1;             /**< \brief [0:0] T12 Available - T12 (rw) */
    Ifx_UReg_32Bit T13:1;             /**< \brief [1:1] T13 Available - T13 (rw) */
    Ifx_UReg_32Bit MCM:1;             /**< \brief [2:2] Multi-Channel Mode Available - MCM (rw) */
    Ifx_UReg_32Bit reserved_3:12;     /**< \brief [14:3] \internal Reserved */
    Ifx_UReg_32Bit WREN:1;            /**< \brief [15:15] Write Enable - WREN (rw) */
    Ifx_UReg_32Bit reserved_16:16;    /**< \brief [31:16] \internal Reserved */
} Ifx_CCU6_MCFG_Bits;
...
{
    Ifx_UReg_32Bit TRIG0SEL:3;        /**< \brief [2:0] Output Trigger Select for CCU6061 TRIG0 - TRIG0SEL (rw) */
    Ifx_UReg_32Bit TRIG1SEL:3;        /**< \brief [5:3] Output Trigger Select for CCU6061 TRIG1 - TRIG1SEL (rw) */
    Ifx_UReg_32Bit TRIG2SEL:3;        /**< \brief [8:6] Output Trigger Select for CCU6061 TRIG2 - TRIG2SEL (rw) */
...
{
    Ifx_UReg_32Bit ISCC60:2;          /**< \brief [1:0] Input Select for CC60 - ISCC60 (rw) */
    Ifx_UReg_32Bit ISCC61:2;          /**< \brief [3:2] Input Select for CC61 - ISCC61 (rw) */
    Ifx_UReg_32Bit ISCC62:2;          /**< \brief [5:4] Input Select for CC62 - ISCC62 (rw) */
    Ifx_UReg_32Bit ISTRP:2;           /**< \brief [7:6] Input Select for CTRAP - ISTRP (rw) */
    Ifx_UReg_32Bit ISPOS0:2;          /**< \brief [9:8] Input Select for CCPOS0 - ISPOS0 (rw) */
    Ifx_UReg_32Bit ISPOS1:2;          /**< \brief [11:10] Input Select for CCPOS1 - ISPOS1 (rw) */
    Ifx_UReg_32Bit ISPOS2:2;          /**< \brief [13:12] Input Select for CCPOS2 - ISPOS2 (rw) */
...
typedef struct _Ifx_CCU6_T12DTC_Bits
{
    ...
    Ifx_UReg_32Bit DTE0:1;            /**< \brief [8:8] Dead Time Enable Bits - DTE2,DTE1,DTE0 (rw) */
    Ifx_UReg_32Bit DTE1:1;            /**< \brief [9:9] Dead Time Enable Bits - DTE2,DTE1,DTE0 (rw) */
    Ifx_UReg_32Bit DTE2:1;            /**< \brief [10:10] Dead Time Enable Bits - DTE2,DTE1,DTE0 (rw) */
    Ifx_UReg_32Bit reserved_11:1;     /**< \brief [11:11] \internal Reserved */
    Ifx_UReg_32Bit DTR0:1;            /**< \brief [12:12] Dead Time Run Indication Bits - DTR2,DTR1,DTR0 (rh) */
    Ifx_UReg_32Bit DTR1:1;            /**< \brief [13:13] Dead Time Run Indication Bits - DTR2,DTR1,DTR0 (rh) */
    Ifx_UReg_32Bit DTR2:1;            /**< \brief [14:14] Dead Time Run Indication Bits - DTR2,DTR1,DTR0 (rh) */
    Ifx_UReg_32Bit reserved_15:17;    /**< \brief [31:15] \internal Reserved */
...
{
    Ifx_UReg_32Bit MSEL60:4;          /**< \brief [3:0] Capture/Compare Mode Selection - MSEL60,MSEL61,MSEL62 (rw) */
    Ifx_UReg_32Bit MSEL61:4;          /**< \brief [7:4] Capture/Compare Mode Selection - MSEL60,MSEL61,MSEL62 (rw) */
    Ifx_UReg_32Bit MSEL62:4;          /**< \brief [11:8] Capture/Compare Mode Selection - MSEL60,MSEL61,MSEL62 (rw) */
...
typedef struct _Ifx_CCU6_TRPCTR_Bits
{
    ...
    Ifx_UReg_32Bit TRPM1:1;           /**< \brief [1:1] Trap Mode Control Bit 0 - TRPM1 (rw) */
