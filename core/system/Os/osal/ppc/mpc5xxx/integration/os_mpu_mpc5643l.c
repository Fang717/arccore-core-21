...
void Os_MMInit( void ) {
    ...
    MPU.RGD[2].WORD1.R = 0x8ff00000 + _ESIZE_1M;/* end */
    ...
    MPU.RGD[3].WORD1.R = 0xc3f00000 + _ESIZE_1M;/* end */
    ...
    MPU.RGD[4].WORD1.R = 0xFFE00000 + _ESIZE_1M;/* end */
    ...
    MPU.RGD[5].WORD1.R = 0xFFF00000+ _ESIZE_1M; /* end */
