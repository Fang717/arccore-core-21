...
/** @req 4.1.2|4.3.0/SWS_Port_00229 - Port_PinType*/
/** @req SWS_Port_00145 - Port_SetPinMode Api */
/** @req SWS_Port_00051 - Det error check as mentioned in section 7.5 (Port Driver SWS document - ASR 4.3.0)*/
/** @req 4.1.2|4.3.0/SWS_Port_00219 - The type Port_PinType shall be uint8, uint16 or uint32 based on the specific MCU platform.*/
/** @req 4.1.2|4.3.0/SWS_Port_00228 - Port_ConfigType
 * Defined in Port_Cfg.h */
/** @req 4.1.2|4.3.0/SWS_Port_00220 - The type Port_PinDirectionType shall be of enumeration type having range as PORT_PIN_IN and PORT_PIN_OUT
 * PORT_PIN_IN Sets port pin as input.
 * PORT_PIN_OUT  Sets port pin as output.  */
/** @req 4.1.2|4.3.0/SWS_Port_00208 - The PORT Driver module’s implementer shall publish the symbolic names through the file Port.h.
 * Published via Port_Cfg.h */
/** @req 4.1.2|4.3.0/SWS_Port_00231 - Port_PinModeType */
/** @req 4.1.2|4.3.0/SWS_Port_00221 - The type Port_PinModeType shall be uint8, uint16 or uint32.*/
/** @req 4.1.2|4.3.0/SWS_Port_00046 - The type Port_PinDirectionType is a type for defining the direction of a Port Pin */
/** @req 4.1.2|4.3.0/SWS_Port_00230 - Port_PinDirectionType */
/** @req 4.1.2|4.3.0/SWS_Port_00130 - Port.h shall include Port_Cfg.h for the API pre-compiler switches and Std_Types.h */
