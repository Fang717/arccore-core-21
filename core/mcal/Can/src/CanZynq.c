...
Can_ReturnType Can_SetControllerMode( uint8 Controller, Can_StateTransitionType Transition )
{
    ...
    VALIDATE_RV( (CAN_T_START == Transition ) || \
                ...
                (CAN_T_WAKEUP == Transition ), CAN_SETCONTROLLERMODE_SERVICE_ID, CAN_E_TRANSITION, CAN_NOT_OK );
...
Can_ReturnType Can_Write( Can_HwHandleType Hth, const Can_PduType *PduInfo )
{
    ...
    VALIDATE_RV( (PduInfo->length <= 8), CAN_WRITE_SERVICE_ID, CAN_E_PARAM_DATA_LENGTH, CAN_NOT_OK );
