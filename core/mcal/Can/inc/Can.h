...
/** @req 4.1.2|4.3.0/SWS_Can_00388 The header file Can.h shall include the header file ComStack_Types.h.*/
...
#if !defined(CFG_DRIVERS_USE_CONFIG_ISRS) && !defined(CAN_ARC_ISR_APP)
#if ((OS_SC3 == STD_ON) || (OS_SC4 == STD_ON))
#error You must define CAN_ARC_ISR_APP
#else
#define CAN_ARC_ISR_APP             0
#endif
#endif

#endif

#include "Can_Cfg.h"			// has to be included after version check and all the type definitions
#include "Can_GeneralTypes.h"
/** @req 4.1.2|4.3.0/SWS_Can_00435 The Can.h file shall include Can_GeneralTypes.h.*/
 ...
 */
Std_ReturnType Can_ChangeBaudrate(uint8 Controller, const uint16 Baudrate);			// not in 4.3.0
 ...
 */
Std_ReturnType Can_CheckBaudrate(uint8 Controller, const uint16 Baudrate);			// not in 4.3.0
...
#else
/** @req 4.1.2|4.3.0/SWS_Can_00178 The Can module may implement the function Can_MainFunction_Write as empty define in case no polling at all is used.*/
...
#else
/** @req 4.1.2|4.3.0/SWS_Can_00180 The Can module may implement the function Can_MainFunction_Read as empty define in case no polling at all is used.*/
...
#else
/** @req 4.1.2|4.3.0/SWS_Can_00183 The Can module may implement the function Can_MainFunction_BusOff as empty define in case no polling at all is used.*/
