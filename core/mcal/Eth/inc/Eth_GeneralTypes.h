...
#if defined (CFG_ZYNQ) || defined(CFG_JAC6) || defined(CFG_MPC5748G) || defined(CFG_MPC5777C)|| defined(CFG_MPC5747C) || defined(CFG_MPC5746C)
    uint8           EthCtrlIdx;
    uint8           EthHwSpeed;
#if !defined (CFG_ZYNQ)
...
#endif
#if defined (CFG_ZYNQ) || defined(CFG_MPC5748G) || defined(CFG_MPC5777C)|| defined(CFG_MPC5747C) || defined(CFG_MPC5746C)
    boolean         EthHwCtrlDiscardRxFCS;
#endif
#endif
#if defined(USE_DEM) || defined(CFG_ETH_USE_DEM)
    Dem_EventIdType ETH_E_ACCESS;
#if defined(CFG_JAC6) || defined(CFG_MPC5748G) || defined(CFG_MPC5777C) || defined(CFG_MPC5747C) || defined(CFG_MPC5746C)
