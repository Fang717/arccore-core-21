...
/****************************************************************************/
    struct ECSM_tag {
        ...
        union {
            ...
            struct {
                vuint8_t:2;
                vuint8_t ER1BR:1;       /* <URM>ER1BR</URM> */
                vuint8_t EF1BR:1;       /* <URM>ER1BR</URM> */
                vuint8_t:2;
        ...
        union {
            ...
            struct {
                vuint8_t:2;
                vuint8_t R1BC:1;        /* <URM>R1BC</URM> */
                vuint8_t F1BC:1;        /* <URM>F1BC</URM> */
                vuint8_t:2;
        ...
        uint16_t ecsm_reserved48;       /* base + 0x48 */

        union {
            vuint16_t R;
            struct {
                vuint8_t:2;
                vuint8_t FRC1B:1;       /* <URM>FRC1B</URM> */ // This field is writable only in test mode in cut 1.0 devices.
                vuint8_t FR11B:1;       /* <URM>FR11B</URM> */ // This field is writable only in test mode in cut 1.0 devices.
                vuint8_t:2;
                vuint8_t FRCNCI:1;      /* <URM>FRCNCI</URM> */
                vuint8_t FR1NCI:1;      /* <URM>FR1NCI</URM> */
                vuint8_t ERRBIT:8;      /* <URM>ERRBIT</URM> */ // inverted

            } B;
        } EEGR;                  /* ECC Status Register */

        uint32_t ecsm_reserved4c;       /* base + 0x4C */
        ...
        uint16_t ecsm_reserved54;       /* base + 0x54 */
        ...
        uint8_t ecsm_reserved64;        /* base + 0x64 */
