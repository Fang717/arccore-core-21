...
/*lint -esym(522, Cache_Invalidate)  MISRA:FALSE_POSITIVE:assembler inside :[MISRA 2012 Rule 2.2, required] */
...
/*lint -esym(522, Cache_EnableU) MISRA:FALSE_POSITIVE:assembler inside :[MISRA 2012 Rule 2.2, required] */
