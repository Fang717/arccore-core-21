...
struct SIU_tag {
...
#else
    } MIDR; /* ArcCore modification for portability */
#endif
    ...
    vuint8_t GPDO_extraPadding[12]; /* ArcCore, fixed incorrect padding */
    ...
    vuint8_t GPDI_extraPadding[12]; /* ArcCore, fixed incorrect padding */
...
struct LINFLEX_tag {
    ...
    union { /* LINFLEX LIN Control 1 (Base+0x0000) */
        ...
        struct {
            ...
            vuint32_t SFTM:1;
#else
            vuint32_t SLFM:1; /* ArcCore modification for portability */
#endif
            vuint32_t LBKM:1;
            vuint32_t MME:1;
            vuint32_t SBDT:1;
...
#else /* ArcCore modification for portability */
    union { /* Mode Enable (Base+0x0008) */
        vuint32_t R;
        struct {
            vuint32_t :16;
...
#if 0
            vuint32_t :3;
#else       /* ArcCore modification, the reference manual does have these bits */
            vuint32_t ODIS:1;
            vuint32_t ODISSL:2;
#endif
            vuint32_t UCPRE:2;
...
#else
    } MCR; /* ArcCore modification for portability */
#endif
