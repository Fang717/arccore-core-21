...
/*lint -e18 -e923 -e9027 -e9032 -e9031 MISRA:HARDWARE_ACCESS:Something with timer frequency:[MISRA 2012 Rule 8.3, required] */
uint32 Timer_Freq;
...
/*lint -e957 MISRA:HARDWARE_ACCESS:Something with Timer:[MISRA 2004 Info, required] */
