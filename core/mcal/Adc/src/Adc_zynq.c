...
Std_ReturnType Adc_ReadGroup (Adc_GroupType group, Adc_ValueGroupType *dataBufferPtr)
{
  ...
  {
	/* IMPROVEMENT: Trigger error on NULL_PTR for dataBufferPtr, as tested by Adc_TestCoverage. */
    if (dataBufferPtr == NULL){
	  (void) Det_ReportError(ADC_MODULE_ID, 0, ADC_READGROUP_ID, ADC_E_PARAM_POINTER );
