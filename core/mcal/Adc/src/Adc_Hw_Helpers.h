...
/** @tagSettings DEFAULT_ARCHITECTURE=PPC|ZYNQ|MPC5607B|MPC5645S|MPC5748G|MPC5646B|MPC5744P|MPC5747C|STM32|JACINTO5|JACINTO6 */
/** @reqSettings DEFAULT_SPECIFICATION_REVISION=4.3.0|4.1.2 */

#ifndef ADC_HELPERS_H_
#define ADC_HELPERS_H_
