...
/** @tagSettings DEFAULT_ARCHITECTURE=ZYNQ|MPC5607B|MPC5645S|MPC5748G|MPC5646B|MPC5747C|STM32|JACINTO5|JACINTO6 */
...
#if ( ADC_DEV_ERROR_DETECT == STD_ON )
    /* @req 4.1.2|4.3.0/SWS_Adc_00301 */
    /* @req 4.1.2|4.3.0/SWS_Adc_00225 */
...
#if ( ADC_DEV_ERROR_DETECT == STD_ON )
    /* @req 4.1.2|4.3.0/SWS_Adc_00299 */
    /* @req 4.1.2|4.3.0/SWS_Adc_00130 */
...
#if ( ADC_DEV_ERROR_DETECT == STD_ON )
    /* @req 4.1.2|4.3.0/SWS_Adc_00300 */
    /* @req 4.1.2|4.3.0/SWS_Adc_00131 */
...
Std_ReturnType Adc_CheckReadGroup (Adc_StateType adcState, const Adc_ConfigType *ConfigPtr, Adc_GroupType group)
{
  ...
  /* @req 4.1.2|4.3.0/SWS_Adc_00296 */
  /* @req 4.1.2|4.3.0/SWS_Adc_00152 */
...
Std_ReturnType Adc_CheckStartGroupConversion (Adc_StateType adcState, const Adc_ConfigType *ConfigPtr, Adc_GroupType group)
{
...
#if ( ADC_DEV_ERROR_DETECT == STD_ON )
  /* @req 4.1.2|4.3.0/SWS_Adc_00294 */
  /* @req 4.1.2|4.3.0/SWS_Adc_00125 */
  ...
  {
    /* Group status not OK */
    /* @req  4.1.2|4.3.0/SWS_Adc_00346 */
    /* @req  4.1.2|4.3.0/SWS_Adc_00426 */
...
#if ( ADC_DEV_ERROR_DETECT == STD_ON )
  /* @req 4.1.2|4.3.0/SWS_Adc_00295 */
  /* @req 4.1.2|4.3.0/SWS_Adc_00126 */
...
#if ( ADC_DEV_ERROR_DETECT == STD_ON )
  /* @req 4.1.2|4.3.0/SWS_Adc_00423 */
  /* @req 4.1.2|4.3.0/SWS_Adc_00434 */
...
#if ( ADC_DEV_ERROR_DETECT == STD_ON )
  /* @req 4.1.2|4.3.0/SWS_Adc_00218 */
  /* @req 4.1.2|4.3.0/SWS_Adc_00302 */
...
Std_ReturnType Adc_CheckEnableHardwareTrigger (Adc_StateType adcState, const Adc_ConfigType *ConfigPtr, Adc_GroupType group){
...
#if ( ADC_DEV_ERROR_DETECT == STD_ON )
    /* @req:ZYNQ 4.1.2/SWS_Adc_00128 */
    /* @req:ZYNQ 4.1.2/SWS_Adc_00297 */
    ...
    else if(ValidateGroup(ConfigPtr, group, ADC_ENABLEHARDWARETRIGGER_ID) == E_NOT_OK)
    {
        ...
        /* @req:ZYNQ 4.1.2/SWS_Adc_00349 */
        /* @req:ZYNQ 4.1.2/SWS_Adc_00353 */
...
#if ( ADC_DEV_ERROR_DETECT == STD_ON )
    /* @req:ZYNQ 4.1.2/SWS_Adc_00129 */
    /* @req:ZYNQ 4.1.2/SWS_Adc_00298 */
