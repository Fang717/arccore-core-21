...
/** @tagSettings DEFAULT_ARCHITECTURE=PPC|MPC5607B|MPC5645S|MPC5646B */
...
/* @req  SWS_Pwm_40075 - Pwm_Lcfg.c shall include Pwm.h and Pwm_Memmap.h */
/* @req  SWS_Pwm_60075 Pwm_PBcfg.c shall include Pwm_MemMap.h and Pwm.h. */
...
/* @req  SWS_Pwm_00109 Pwm_EdgeNotificationType is type of edge notification of a PWM channel. */
/* @req  SWS_Pwm_00106 Pwm_ChannelType */
/* @req  SWS_Pwm_00110 Pwm_ChannelClassType defines the class of a PWM channel */
...
/* @req  SWS_Pwm_10075 Pwm.h shall include Pwm_Cfg.h */
/* @req  SWS_Pwm_00201 Development Error Types */
/* @req  SWS_Pwm_20080 configuration parameter PwmDeInitApi {PWM_DE_INIT_API}.*/
/* @req  SWS_Pwm_00108 Pwm_OutputStateType is a type for defining output state of a Pwm channel */


/* ----------------------------[private define]------------------------------*/


#if defined(CFG_MPC5604B) || defined(CFG_MPC5606B) || defined(CFG_MPC5607B) || defined(CFG_SPC560B54) || defined(CFG_MPC5668) || defined(CFG_MPC5746C) || defined(CFG_MPC5748G) || defined(CFG_MPC5747C) || defined(CFG_MPC5646B)
#   define PWM_RUNTIME_CHANNEL_COUNT    PWM_MAX_CHANNEL
#   define IS_VALID_CHANNEL(_x) ((_x) < PWM_MAX_CHANNEL)
#elif defined(CFG_MPC5777C)
#   define PWM_RUNTIME_CHANNEL_COUNT    PWM_MAX_CHANNEL
#   define IS_VALID_CHANNEL(_x) ((((_x) <=55 ) && ((_x) >= 48)) || (((_x) <= 39) && ((_x) >= 32)) || (((_x) <= 7) && ((_x) >= 0)) || (((_x) <= 23) && ((_x) >= 16)))
...
#if defined(CFG_MPC560X) || defined(CFG_MPC5645S) || defined (CFG_MPC5746C) || defined(CFG_MPC5646B) || defined(CFG_MPC5777C)
...
#if defined(CFG_MPC560X) || defined(CFG_MPC5645S) || defined (CFG_MPC5746C) || defined(CFG_MPC5748G) || defined(CFG_MPC5747C) || defined(CFG_MPC5646B) || defined(CFG_MPC5777C)
...
static void setDutyCycle(Pwm_ChannelType Channel, uint16 DutyCycle, Pwm_PeriodType Period) {
    ...
    if ((Period == 0) || (Period == 1)) {
        ...
        emiosHw->CH[unitCh].CADR.R = 0uL; /* 0% duty cycle */
...
static void configureChannel(const Pwm_ChannelConfigurationType* channelConfig) {
    ...
    emiosHw->CH[unitCh].CCR.B.DMA = 0u;          /* FLAG used for interrupts, not DMA */
    emiosHw->CH[unitCh].CCR.B.BSL = (vuint32_t) channelConfig->clksrc; /* Bus select */
#else
    emiosHw->CH[unitCh].CCR.B.DMA = 0;          /* FLAG used for interrupts, not DMA */
    emiosHw->CH[unitCh].CCR.B.BSL = (vuint32_t) channelConfig->clksrc; /* Bus select */
...
#if defined(CFG_MPC560X) || defined(CFG_MPC5645S) || defined(CFG_MPC5646B)
    emiosHw->CH[unitCh].CCR.B.UCPEN = 1u; /*Prescaler enable */
#else
    emiosHw->CH[unitCh].CCR.B.UCPREN = 1u; /*Prescaler enable */
#endif
    /* @req SWS_Pwm_10009  */
    /* @req SWS_Pwm_20009  */
    /* @req SWS_Pwm_30009  */
...
static void installChannelInterrupt(Pwm_ChannelType Channel)
{
    ...
    // Install ISR
#if defined(CFG_MPC560XB) || defined(CFG_MPC5604P) || defined(CFG_MPC5606S) || defined(CFG_MPC5746C) || defined(CFG_MPC5748G) || defined(CFG_MPC5747C) || defined(CFG_MPC5646B)
    switch(hwUnit) {
        case 0:
            switch(unitCh) {
                ...
                case 27:
                    ...
                    break;
#endif
#if defined (CFG_MPC5746C) || defined(CFG_MPC5748G) || defined(CFG_MPC5747C) || defined(CFG_MPC5646B)
                case 28:
                case 29:
    ...
    switch(hwUnit) {
        case 0:
            switch(unitCh) {
                case 0:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F0),PWM_ISR_PRIORITY, 0);
                    break;
                case 1:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F1),PWM_ISR_PRIORITY, 0);
                    break;
                case 2:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F2),PWM_ISR_PRIORITY, 0);
                    break;
                case 3:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F3),PWM_ISR_PRIORITY, 0);
                    break;
                case 4:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F4),PWM_ISR_PRIORITY, 0);
                    break;
                case 5:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F5),PWM_ISR_PRIORITY, 0);
                    break;
                case 6:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F6),PWM_ISR_PRIORITY, 0);
                    break;
                case 7:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F7),PWM_ISR_PRIORITY, 0);
                    break;
                case 16:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F16),PWM_ISR_PRIORITY, 0);
                    break;
                case 17:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F17),PWM_ISR_PRIORITY, 0);
                    break;
                case 18:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F18),PWM_ISR_PRIORITY, 0);
                    break;
                case 19:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F19),PWM_ISR_PRIORITY, 0);
                    break;
                case 20:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F20),PWM_ISR_PRIORITY, 0);
                    break;
                case 21:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F21),PWM_ISR_PRIORITY, 0);
                    break;
                case 22:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F22),PWM_ISR_PRIORITY, 0);
                    break;
                case 23:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_0_GFLAG_F23),PWM_ISR_PRIORITY, 0);
                    break;
                default:
                    break;
            }
        ...
        case 1:
            switch(unitCh) {
                case 0:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F0),PWM_ISR_PRIORITY, 0);
                    break;
                case 1:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F1),PWM_ISR_PRIORITY, 0);
                    break;
                case 2:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F2),PWM_ISR_PRIORITY, 0);
                    break;
                case 3:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F3),PWM_ISR_PRIORITY, 0);
                    break;
                case 4:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F4),PWM_ISR_PRIORITY, 0);
                    break;
                case 5:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F5),PWM_ISR_PRIORITY, 0);
                    break;
                case 6:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F6),PWM_ISR_PRIORITY, 0);
                    break;
                case 7:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F7),PWM_ISR_PRIORITY, 0);
                    break;
                case 16:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F16),PWM_ISR_PRIORITY, 0);
                    break;
                case 17:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F17),PWM_ISR_PRIORITY, 0);
                    break;
                case 18:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F18),PWM_ISR_PRIORITY, 0);
                    break;
                case 19:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F19),PWM_ISR_PRIORITY, 0);
                    break;
                case 20:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F20),PWM_ISR_PRIORITY, 0);
                    break;
                case 21:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F21),PWM_ISR_PRIORITY, 0);
                    break;
                case 22:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F22),PWM_ISR_PRIORITY, 0);
                    break;
                case 23:
                    ISR_INSTALL_ISR2("PwmIsr", Pwm_Isr, (IrqType)(eMIOS_1_GFLAG_F23),PWM_ISR_PRIORITY, 0);
                    break;
                default:
                    break;
            }
...
void Pwm_Init(const Pwm_ConfigType* ConfigPtr) {
    ...
    /* Enable eMIOS clock */
    EMIOS_0.MCR.B.GPREN = 1u; /*lint !e923 Ok, cast in Freescale header file */
    EMIOS_1.MCR.B.GPREN = 1u; /*lint !e923 Ok, cast in Freescale header file */
    ...
    EMIOS_0.MCR.B.GTBE = 1u; /*lint !e923 Ok, cast in Freescale header file */
    EMIOS_1.MCR.B.GTBE = 1u; /*lint !e923 Ok, cast in Freescale header file */
#else
    /* Clock scaler uses system clock (~64MHz) as source, so prescaler 64 => 1MHz. */
    EMIOS.MCR.B.GPRE = PWM_PRESCALER - 1; /*lint !e923 Ok, cast in Freescale header file */

    /* Enable eMIOS clock */
    EMIOS.MCR.B.GPREN = 1u; /*lint !e923 Ok, cast in Freescale header file */

    /* Stop channels when in debug mode */
    EMIOS.MCR.B.FRZ = PWM_FREEZE_ENABLE; /*lint !e923 Ok, cast in Freescale header file */

    /* Use global time base */
    EMIOS.MCR.B.GTBE = 1u; /*lint !e923 Ok, cast in Freescale header file */
#endif
...
#if defined(CFG_MPC560X) || defined(CFG_MPC5645S) || defined (CFG_MPC5746C) || defined(CFG_MPC5748G) || defined(CFG_MPC5747C) || defined(CFG_MPC5646B) || defined(CFG_MPC5777C)
    EMIOS_0.MCR.B.MDIS = 0u; /*lint !e923 Ok, cast in Freescale header file */
    EMIOS_1.MCR.B.MDIS = 0u; /*lint !e923 Ok, cast in Freescale header file */
#if defined(CFG_MPC5748G) || defined(CFG_MPC5747C)
    EMIOS_2.MCR.B.MDIS = 0u; /*lint !e923 Ok, cast in Freescale header file */
#endif
#else
    EMIOS.MCR.B.MDIS = 0u; /*lint !e923 Ok, cast in Freescale header file */
#endif
...
#if !defined(CFG_MPC5567) && !defined(CFG_MPC5777C)
...
void Pwm_DeInit(void) {
    ...
    /* @req SWS_Pwm_00011*/
#if defined(CFG_MPC560X) || defined(CFG_MPC5645S) || defined (CFG_MPC5746C) || defined(CFG_MPC5748G) || defined(CFG_MPC5747C) || defined(CFG_MPC5646B) || defined(CFG_MPC5777C)
    EMIOS_0.MCR.B.MDIS = 1u; /*lint !e923 Ok, cast in Freescale header file */
    EMIOS_1.MCR.B.MDIS = 1u; /*lint !e923 Ok, cast in Freescale header file */
#if defined(CFG_MPC5748G) || defined(CFG_MPC5747C)
    EMIOS_2.MCR.B.MDIS = 1u; /*lint !e923 Ok, cast in Freescale header file */
#endif
#else
    EMIOS.MCR.B.MDIS = 1u; /*lint !e923 Ok, cast in Freescale header file */
#endif
    /* @req SWS_Pwm_00010*/
...
/* @brief  		Function read back the configured polarity for a specific channel.
 * @param[in] 	ChannelNumber 	Channel number.
 * @return		configured Polarity
 * @retval		PWM_LOW			low state.
 * @retval		PWM_HIGH		high state.
 ******************************************************************************/
uint16 Pwm_Hw_getConfiguredChannelValue (Pwm_ChannelType Ch){
	uint8 check = 0;
	uint16 ret;
	Pwm_OutputStateType ChIdleState = PWM_HIGH;
	Pwm_OutputStateType ChPolarity = PWM_HIGH;


	for(check = 0; check < PWM_NUMBER_OF_CHANNELS ;check++){
		if(Ch == (Pwm_ConfigPtr->Channels[check].channel)){
			ChPolarity = Pwm_ConfigPtr->Channels[check].polarity;
			ChIdleState = Pwm_ConfigPtr->IdleState[check];
			break;
		}else{
			/*do nothing*/
		}
    ...
    if(((PWM_HIGH == ChIdleState) && (PWM_HIGH == ChPolarity))||((PWM_LOW == ChIdleState) && (PWM_LOW == ChPolarity))){
    	ret = PWM_100_PERCENT;
    }else{
    	ret = PWM_0_PERCENT;
    }
...
void Pwm_SetOutputToIdle(Pwm_ChannelType Channel)
{
    Pwm_ChannelType unitCh;
    volatile struct EMIOS_tag *emiosHw;
    Pwm_OutputStateType ChIdleState = PWM_LOW;
    Pwm_OutputStateType ChPolarity = PWM_LOW;
    uint16 IdleDutyCycle = PWM_0_PERCENT;
    /* @req SWS_Pwm_00117 */
    /*lint -save -e904 ARGUMENT_CHECK */
...
/* @req    SWS_Pwm_00021 */
    /* Set 0% duty */
    IdleDutyCycle = Pwm_Hw_getConfiguredChannelValue(Channel);

	Pwm_SetDutyCycle(Channel, IdleDutyCycle);
...
{
    volatile struct EMIOS_tag *emiosHw;
    uint32 flagmask_0 = 0uL; // depend on processor architecture
    uint32 flagmask_1 = 0uL; // depend on processor architecture
    uint32 flagmask_2 = 0uL; // depend on processor architecture
    
    uint32 flagmask;   // global for calculation, not necessary to initialize
    
    Pwm_ChannelType emios_ch;
    ...
    flagmask = EMIOS.GFLAG.R;
#elif defined(CFG_MPC5567)
    flagmask = EMIOS.GFR.R;
#endif
    ...
    {
        emios_ch = Pwm_ConfigPtr->Channels[channel_iterator].channel;
        ...
        if (flagmask & (1UL << (uint8)emios_ch))
        {
            ...
            // Clear interrupt
            /* @req SWS_Pwm_00026 */
            EMIOS.CH[emios_ch].CSR.B.FLAG = 1u; /*lint !e923 Ok, cast in Freescale header file  */
        }
    }
     
    
#elif defined(CFG_MPC560X) || defined(CFG_MPC5645S) || defined (CFG_MPC5746C) || defined(CFG_MPC5748G) || defined(CFG_MPC5747C) || defined(CFG_MPC5646B) || defined(CFG_MPC5777C)
    /* Read global flag registers */
    flagmask_0 = EMIOS_0.GFR.R; /*lint !e923 Ok, cast in Freescale header file */
    flagmask_1 = EMIOS_1.GFR.R; /*lint !e923 Ok, cast in Freescale header file */
    
#if defined (CFG_MPC5748G) || defined(CFG_MPC5747C)
    flagmask_2 = EMIOS_2.GFR.R; /*lint !e923 Ok, cast in Freescale header file */
#endif
    ...
    for (Pwm_ChannelType channel_iterator = 0; channel_iterator < PWM_NUMBER_OF_CHANNELS; channel_iterator++)
    {
        ...
        switch((emios_ch / PWM_NUMBER_OF_EACH_EMIOS))
        {
			case 0u:
				flagmask = flagmask_0;
                emiosHw = &EMIOS_0;
            ...
            case 2u:
                flagmask = 0uL;          // just safety, better than else
                emiosHw = &EMIOS_0;      // just safety, better than else
...
#               endif    
            ...
            default:  /*** try to recover from wrong configuration	***/
				flagmask = 0uL;			// just safety, it will NOT be proceed following code as it is 0uL
                emiosHw = &EMIOS_0;		// just safety, there should to be valid address anyway, even not proceeding								                
            break;			
        }
        
        
        if (((flagmask & (1UL << (uint8)chnl)) != 0uL))
        {
            if ((Pwm_ConfigPtr->NotificationHandlers[channel_iterator] != NULL) && ((emiosHw->CH[chnl].CCR.B.FEN != 0u)))
            {
                /* Read Unified channel output pin */
                chnlOutput = emiosHw->CH[chnl].CSR.B.UCOUT; /*lint !e923 !e632 Ok, cast in Freescale header file */
                Pwm_EdgeNotificationType notification = (Pwm_EdgeNotificationType)ChannelRuntimeStruct[emios_ch].NotificationState;
            ...
            // Clear interrupt
            /* @req SWS_Pwm_00026 */
            emiosHw->CH[chnl].CSR.B.FLAG = 1u; /*lint !e923 Ok, cast in Freescale header file */
        } else {
