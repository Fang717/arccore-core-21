...
/** @tagSettings DEFAULT_ARCHITECTURE=PPC|MPC5607B|MPC5645S|MPC5748G|MPC5747C|MPC5744P */
...
{/*lint !e9046 Lin_Init and LIN_INIT are in the AutoSAR specification. */
    ...
    /* @req SWS_Lin_00155 */
    #ifdef LIN_CHANNEL_0_USED
    ISR_INSTALL_ISR2("LinIsrRxA", LinInterruptRxA, (int16_t)(LINFLEX_0_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTxA", LinInterruptTxA, (int16_t)(LINFLEX_0_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErrA", LinInterruptErrA, (int16_t)(LINFLEX_0_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_1_USED
    ISR_INSTALL_ISR2("LinIsrRxB", LinInterruptRxB, (int16_t)(LINFLEX_1_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTxB", LinInterruptTxB, (int16_t)(LINFLEX_1_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErrB", LinInterruptErrB, (int16_t)(LINFLEX_1_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_2_USED
    ISR_INSTALL_ISR2("LinIsrRxC", LinInterruptRxC, (int16_t)(LINFLEX_2_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTxC", LinInterruptTxC, (int16_t)(LINFLEX_2_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErrC", LinInterruptErrC, (int16_t)(LINFLEX_2_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_3_USED
    ISR_INSTALL_ISR2("LinIsrRxD", LinInterruptRxD, (int16_t)(LINFLEX_3_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTxD", LinInterruptTxD, (int16_t)(LINFLEX_3_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErrD", LinInterruptErrD, (int16_t)(LINFLEX_3_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_4_USED
    ISR_INSTALL_ISR2("LinIsrRxE", LinInterruptRxE, (int16_t)(LINFLEX_4_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTxE", LinInterruptTxE, (int16_t)(LINFLEX_4_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErrE", LinInterruptErrE, (int16_t)(LINFLEX_4_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_5_USED
    ISR_INSTALL_ISR2("LinIsrRxF", LinInterruptRxF, (int16_t)(LINFLEX_5_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTxF", LinInterruptTxF, (int16_t)(LINFLEX_5_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErrF", LinInterruptErrF, (int16_t)(LINFLEX_5_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_6_USED
    ISR_INSTALL_ISR2("LinIsrRxG", LinInterruptRxG, (int16_t)(LINFLEX_6_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTxG", LinInterruptTxG, (int16_t)(LINFLEX_6_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErrG", LinInterruptErrG, (int16_t)(LINFLEX_6_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_7_USED
    ISR_INSTALL_ISR2("LinIsrRxH", LinInterruptRxH, (int16_t)(LINFLEX_7_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTxH", LinInterruptTxH, (int16_t)(LINFLEX_7_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErrH", LinInterruptErrH, (int16_t)(LINFLEX_7_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_8_USED
    ISR_INSTALL_ISR2("LinIsrRx8", LinInterruptRx8, (int16_t)(LINFLEX_8_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx8", LinInterruptTx8, (int16_t)(LINFLEX_8_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr8", LinInterruptErr8, (int16_t)(LINFLEX_8_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_9_USED
    ISR_INSTALL_ISR2("LinIsrRx9", LinInterruptRx9, (int16_t)(LINFLEX_9_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx9", LinInterruptTx9, (int16_t)(LINFLEX_9_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr9", LinInterruptErr9, (int16_t)(LINFLEX_9_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_10_USED
    ISR_INSTALL_ISR2("LinIsrRx10", LinInterruptRx10, (int16_t)(LINFLEX_10_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx10", LinInterruptTx10, (int16_t)(LINFLEX_10_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr10", LinInterruptErr10, (int16_t)(LINFLEX_10_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_11_USED
    ISR_INSTALL_ISR2("LinIsrRx11", LinInterruptRx11, (int16_t)(LINFLEX_11_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx11", LinInterruptTx11, (int16_t)(LINFLEX_11_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr11", LinInterruptErr11, (int16_t)(LINFLEX_11_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_12_USED
    ISR_INSTALL_ISR2("LinIsrRx12", LinInterruptRx12, (int16_t)(LINFLEX_12_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx12", LinInterruptTx12, (int16_t)(LINFLEX_12_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr12", LinInterruptErr12, (int16_t)(LINFLEX_12_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_13_USED
    ISR_INSTALL_ISR2("LinIsrRx13", LinInterruptRx13, (int16_t)(LINFLEX_13_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx13", LinInterruptTx13, (int16_t)(LINFLEX_13_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr13", LinInterruptErr13, (int16_t)(LINFLEX_13_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_14_USED
    ISR_INSTALL_ISR2("LinIsrRx14", LinInterruptRx14, (int16_t)(LINFLEX_14_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx14", LinInterruptTx14, (int16_t)(LINFLEX_14_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr14", LinInterruptErr14, (int16_t)(LINFLEX_14_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_15_USED
    ISR_INSTALL_ISR2("LinIsrRx15", LinInterruptRx15, (int16_t)(LINFLEX_15_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx15", LinInterruptTx15, (int16_t)(LINFLEX_15_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr15", LinInterruptErr15, (int16_t)(LINFLEX_15_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_16_USED
    ISR_INSTALL_ISR2("LinIsrRx16", LinInterruptRx16, (int16_t)(LINFLEX_16_RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx16", LinInterruptTx16, (int16_t)(LINFLEX_16_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr16", LinInterruptErr16, (int16_t)(LINFLEX_16_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
    #ifdef LIN_CHANNEL_17_USED
    ISR_INSTALL_ISR2("LinIsrRx17", LinInterruptRx17, (int16_t)(LINFLEX_17RXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrTx17", LinInterruptTx17, (int16_t)(LINFLEX_17_TXI),LIN_PRIO, LIN_ARC_ISR_APP);
    ISR_INSTALL_ISR2("LinIsrErr17", LinInterruptErr17, (int16_t)(LINFLEX_17_ERR),LIN_PRIO, LIN_ARC_ISR_APP);
    #endif
...
Std_ReturnType Lin_SendFrame(  uint8 Channel,  Lin_PduType* PduInfoPtr ) /*lint -e{818} Follows AUTOSAR API spec */
{
    ...
    /* Length */
    LINFLEXHw->BIDR.B.DFL = PduInfoPtr->Dl - 1;
    ...
    if (PduInfoPtr->Drc == LIN_MASTER_RESPONSE)
    {
        ...
        /*@req SWS_Lin_00053 */
        retval = LinFlex_Common_WriteDataBufToHwReg(PduInfoPtr->Dl, PduInfoPtr->SduPtr, LINFLEXHw);
        /*lint -e{904} ARGUMENT_CHECK */
