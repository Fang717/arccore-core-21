...
/** @tagSettings DEFAULT_ARCHITECTURE=PPC|MPC5607B|MPC5645S|MPC5646B|MPC5746C|MPC5747C|MPC5748G */
...
#elif defined(CFG_MPC5604B) || defined(CFG_MPC5777C)
#define GPT_CHANNELS_CNT       5u
#elif defined(CFG_MPC5606B)  || defined(CFG_MPC5645S) || defined(CFG_MPC5646B) || defined(CFG_SPC560B54)
...
#if defined(CFG_MPC560X) || defined(CFG_MPC563XM) || defined(CFG_MPC5744P) || defined(CFG_MPC5748G) || defined(CFG_MPC5645S) || defined(CFG_MPC5646B) || defined(CFG_MPC5643L) || defined(CFG_SPC56XL70) || defined(CFG_MPC5777M) || defined(CFG_MPC5777C) || defined(CFG_MPC5668) || defined (CFG_MPC5746C)
#define ENABLE_INTERRUPTS(_ch)              (PIT.CH[_ch].TCTRL.B.TIE = 1u)
#define DISABLE_INTERRUPT(_ch)              (PIT.CH[_ch].TCTRL.B.TIE = 0u)
#define ENABLE_CHANNEL(_ch)                 (PIT.CH[_ch].TCTRL.B.TEN = 1u)
#define DISABLE_CHANNEL(_ch)                (PIT.CH[_ch].TCTRL.B.TEN = 0u)

#define CLEAR_CHANNEL_INTERRUPT(_ch)        (PIT.CH[_ch].TFLG.B.TIF = 1u)
...
#define ENABLE_INTERRUPTS(_ch)              (PIT.TIMER[_ch].TCTRL.B.TIE = 1u)
#define DISABLE_INTERRUPT(_ch)              (PIT.TIMER[_ch].TCTRL.B.TIE = 0u)
#define ENABLE_CHANNEL(_ch)                 (PIT.TIMER[_ch].TCTRL.B.TEN = 1u)
#define DISABLE_CHANNEL(_ch)                (PIT.TIMER[_ch].TCTRL.B.TEN = 0u)

#define CLEAR_CHANNEL_INTERRUPT(_ch)        (PIT.TIMER[_ch].TFLG.B.TIF = 1u)
...
#endif
#define MAXIMUM_TICK_VALUE 4294967295ul
#if defined(CFG_MPC560X) || defined(CFG_MPC563XM) || defined(CFG_MPC5744P) || defined(CFG_MPC5748G) || defined(CFG_MPC5645S) || defined(CFG_MPC5646B) || defined(CFG_MPC5643L) || defined(CFG_SPC56XL70) || defined(CFG_MPC5777M) || defined(CFG_MPC5777C)|| defined(CFG_MPC5668) || defined (CFG_MPC5746C) || defined(CFG_MPC5747C)
static inline void disableModule( void ) {
    for(uint16 i = 0u; i <= GPT_CHANNEL_PIT_LAST; i++)
    {
        PIT.CH[i].TCTRL.B.TIE = 0u;
    }
    PIT.MCR.B.MDIS = 0u;
    PIT.MCR.B.FRZ = 1u;
#if defined (CFG_MPC5777C)
    PIT.MCR.B.MDIS_RTI = 0u;
#endif
}
#elif defined(CFG_MPC5644A)
static inline void disableModule( void ) {
    for(uint16 i = 0u; i <= GPT_CHANNEL_PIT_LAST; i++)
    {
        PIT.TIMER[i].TCTRL.B.TIE = 0u;
    }
    PIT.PITMCR.B.MDIS = 0u;
    PIT.PITMCR.B.FRZ = 1u;
}
#else
static inline void disableModule( void ) {
    ...
    while (cfg->GptChannelId != GPT_CHANNEL_ILL) {
        ...
        if (ch <= GPT_CHANNEL_PIT_LAST)
        {
            if (cfg->GptNotification != NULL)
            {
                ...
                {
#if defined (CFG_MPC5777C)
                	/*The Gpt_0 channel is configured as RTI channel*/
#endif
                    /*lint -save -e641 Ok, to cast*/
                    case 0: ISR_INSTALL_ISR2( "Gpt_0", Gpt_Isr_Channel0, PIT_INT0, 2, GPT_ARC_ISR_APP ); break;
                    case 1: ISR_INSTALL_ISR2( "Gpt_1", Gpt_Isr_Channel1, PIT_INT1, 2, GPT_ARC_ISR_APP ); break;
                    case 2: ISR_INSTALL_ISR2( "Gpt_2", Gpt_Isr_Channel2, PIT_INT2, 2, GPT_ARC_ISR_APP ); break;
#if (GPT_CHANNELS_CNT > 3)
                    case 3: ISR_INSTALL_ISR2( "Gpt_3", Gpt_Isr_Channel3, PIT_INT3, 2, GPT_ARC_ISR_APP ); break;
#if (GPT_CHANNELS_CNT > 4)
                    case 4: ISR_INSTALL_ISR2( "Gpt_4", Gpt_Isr_Channel4, PIT_INT4, 2, GPT_ARC_ISR_APP ); break;
#if (GPT_CHANNELS_CNT > 5)
                    case 5: ISR_INSTALL_ISR2( "Gpt_5", Gpt_Isr_Channel5, PIT_INT5, 2, GPT_ARC_ISR_APP ); break;
#if (GPT_CHANNELS_CNT > 6)
                    case 6: ISR_INSTALL_ISR2( "Gpt_6", Gpt_Isr_Channel6, PIT_INT6, 2, GPT_ARC_ISR_APP ); break;
                    case 7: ISR_INSTALL_ISR2( "Gpt_7", Gpt_Isr_Channel7, PIT_INT7, 2, GPT_ARC_ISR_APP ); break;
#if defined (CFG_MPC5746C) || defined(CFG_MPC5748G)|| defined(CFG_MPC5747C)
                    case 8: ISR_INSTALL_ISR2( "Gpt_8", Gpt_Isr_Channel8, PIT_INT8, 2, GPT_ARC_ISR_APP ); break;
                    case 9: ISR_INSTALL_ISR2( "Gpt_9", Gpt_Isr_Channel9, PIT_INT9, 2, GPT_ARC_ISR_APP ); break;
                    case 10: ISR_INSTALL_ISR2( "Gpt_10", Gpt_Isr_Channel10, PIT_INT10, 2, GPT_ARC_ISR_APP ); break;
                    case 11: ISR_INSTALL_ISR2( "Gpt_11", Gpt_Isr_Channel11, PIT_INT11, 2, GPT_ARC_ISR_APP ); break;
                    case 12: ISR_INSTALL_ISR2( "Gpt_12", Gpt_Isr_Channel12, PIT_INT12, 2, GPT_ARC_ISR_APP ); break;
                    case 13: ISR_INSTALL_ISR2( "Gpt_13", Gpt_Isr_Channel13, PIT_INT13, 2, GPT_ARC_ISR_APP ); break;
                    case 14: ISR_INSTALL_ISR2( "Gpt_14", Gpt_Isr_Channel14, PIT_INT14, 2, GPT_ARC_ISR_APP ); break;
                    case 15: ISR_INSTALL_ISR2( "Gpt_15", Gpt_Isr_Channel15, PIT_INT15, 2, GPT_ARC_ISR_APP ); break;

#elif defined (CFG_MPC5516)
                    case 8: ISR_INSTALL_ISR2( "Gpt_8", Gpt_Isr_Channel8, PIT_PITFLG_PIT8, 2, GPT_ARC_ISR_APP );break;
#else
#endif
#endif
#endif
...
void Gpt_StartTimer(Gpt_ChannelType Channel, Gpt_ValueType Value) {
    ...
    /*lint -e{685} LINT:Just validation in case of any source of "Value" DataType Gpt_ValueType*/
    VALIDATE( ((Value != 0UL) && (Value <= MAXIMUM_TICK_VALUE )), GPT_STARTTIMER_SERVICE_ID, GPT_E_PARAM_VALUE);
...
Gpt_ValueType Gpt_GetTimeElapsed(Gpt_ChannelType channel)
{
    ...
    if( (Gpt_Unit[channel].state == GPT_STATE_EXPIRED) ||
        ((GPT_STATE_STOPPED == Gpt_Unit[channel].state) && (TRUE == Gpt_Unit[channel].expiredWhenStopped)) ) {
#if defined(CFG_MPC560X) || defined(CFG_MPC563XM) || defined(CFG_MPC5746C) || defined(CFG_MPC5744P) || defined(CFG_MPC5748G) || defined(CFG_MPC5645S) || defined(CFG_MPC5646B) || defined(CFG_MPC5643L) || defined(CFG_SPC56XL70) || defined(CFG_MPC5777M) || defined(CFG_MPC5777C)|| defined(CFG_MPC5668) || defined(CFG_MPC5747C)
...
#if defined(CFG_MPC5668) || defined(CFG_MPC5744P) || defined(CFG_MPC5748G) || defined(CFG_MPC5746C) || defined(CFG_MPC5645S) || defined(CFG_MPC5646B) || defined(CFG_MPC5777M) || defined(CFG_MPC5747C)
...
#if defined(CFG_MPC5668) || defined(CFG_MPC5744P) || defined(CFG_MPC5748G) || defined(CFG_MPC5746C) || defined(CFG_MPC5645S) || defined(CFG_MPC5646B) || defined(CFG_MPC5777M) ||defined(CFG_MPC5643L) || defined(CFG_SPC56XL70) ||defined (CFG_MPC5604P) || defined(CFG_MPC5747C)
/**
