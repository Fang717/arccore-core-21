...
#define Mcu_EXT_REF_66MHZ McuConf_McuClockSettingConfig_EXT_REF_66MHZ
#define McuConf_McuClockSettingConfig_EXT_REF_80MHZ (Mcu_ClockType)1u
#define Mcu_EXT_REF_80MHZ McuConf_McuClockSettingConfig_EXT_REF_80MHZ
#define McuConf_McuClockSettingConfig_XOSC_CAN (Mcu_ClockType)2u
#define Mcu_XOSC_CAN McuConf_McuClockSettingConfig_XOSC_CAN
